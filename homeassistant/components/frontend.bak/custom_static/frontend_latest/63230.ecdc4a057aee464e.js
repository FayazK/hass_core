export const __webpack_ids__=["63230"];export const __webpack_modules__={34749:function(o,r,t){t(9359),t(70104);var a=t(57243);const e=a.iv`
  @font-face {
    font-family: "Roboto";
    src:
      local("Roboto Thin"),
      local("Roboto-Thin"),
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-Thin.woff2)
        format("woff2");
    font-weight: 100;
    font-style: normal;
  }
  @font-face {
    ...
    src:
      ...
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-ThinItalic.woff2)
        format("woff2");
    font-weight: 100;
    font-style: italic;
  }
  @font-face {
    ...
    src:
      local("Roboto Light"),
      local("Roboto-Light"),
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-Light.woff2)
        format("woff2");
    font-weight: 300;
    font-style: normal;
  }
  @font-face {
    ...
    src:
      ...
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-LightItalic.woff2)
        format("woff2");
    font-weight: 300;
    font-style: italic;
  }
  @font-face {
    ...
    src:
      ...
      local("Roboto-Regular"),
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-Regular.woff2)
        format("woff2");
    font-weight: 400;
    font-style: normal;
  }
  @font-face {
    ...
    src:
      local("Roboto Italic"),
      local("Roboto-Italic"),
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-RegularItalic.woff2)
        format("woff2");
    font-weight: 400;
    font-style: italic;
  }
  @font-face {
    ...
    src:
      local("Roboto Medium"),
      local("Roboto-Medium"),
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-Medium.woff2)
        format("woff2");
    font-weight: 500;
    font-style: normal;
  }
  @font-face {
    ...
    src:
      ...
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-MediumItalic.woff2)
        format("woff2");
    font-weight: 500;
    font-style: italic;
  }
  @font-face {
    ...
    src:
      local("Roboto Bold"),
      local("Roboto-Bold"),
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-Bold.woff2)
        format("woff2");
    font-weight: 700;
    font-style: normal;
  }
  @font-face {
    ...
    src:
      ...
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-BoldItalic.woff2)
        format("woff2");
    font-weight: 700;
    font-style: italic;
  }
  @font-face {
    ...
    src:
      local("Roboto Black"),
      local("Roboto-Black"),
      url(${(0,a.$m)(/static/)}fonts/roboto/Roboto-Black.woff2)
        format("woff2");
    font-weight: 900;
    font-style: normal;
  }
