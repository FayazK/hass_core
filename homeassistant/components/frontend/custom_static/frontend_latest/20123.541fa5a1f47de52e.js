export const __webpack_ids__ = ["20123"];
export const __webpack_modules__ = {
          ...
          ${(0, o.r)(
            ...
            (e, i) => n.dy`
              <div class="entity" data-entity-id=${e.entity}>
                ...
                <ha-entity-picker .hass=${this.hass} .value=${e.entity} .index=${i} .entityFilter=${this.entityFilter} @value-changed=${this._valueChanged} allow-custom-entity></ha-entity-picker>
              </div>
            `,
          )}
        </div>
      </ha-sortable>
      <ha-entity-picker class="add-entity" .hass=${this.hass} .entityFilter=${
        this.entityFilter
      } @value-changed=${this._addEntity}></ha-entity-picker>
    `
                      : n.Ld;
                  },
                },
  ...
  7753: function (e, i, t) {
    t.a(e, async function (e, a) {
      try {
        t.r(i), t.d(i, { HuiDialogEditView: () => H });
        var n = t(44249),
          s = (t(56820), t(99619), t(57243)),
          o = t(15093),
          l = t(35359),
          d = t(36522),
          c = t(49976),
          r = t(83523),
          h = t(48045),
          u = (t(99426), t(59826), t(17170)),
          v = (t(73729), t(95198), t(64889), t(10571)),
          g = t(76131),
          f = t(28008),
          p = t(84097),
          m = t(82747),
          ...
          y = t(18461),
          k = t(27353),
          b = (t(68658), t(83849), t(91551), t(7883)),
          x = t(48977),
          w = e([u, p]);
        [u, p] = w.then ? (await w)() : w;
        const $ =
          ...
          M = ["tab-settings", "tab-background", "tab-visibility"];
        let H = (0, n.Z)(
          [(0, o.Mo)("hui-dialog-edit-view")],
          function (e, i) {
            return {
              F: class extends i {
                constructor(...i) {
              ...
              d: [
                ...
                {
                  kind: "field",
                  decorators: [(0, o.IO)("ha-yaml-editor")],
                  key: "_editor",
                  value: void 0,
                },
                {
                ...
                },
                {
                  ...
                  key: "showDialog",
                  value: function (e) {
                    if (((this._params = e), void 0 === this._params.viewIndex))
                      return (
                        (this._config = { type: m.zh }), void (this._dirty = !1)
                      );
                    this._lovelace = this._params.lovelace;
                    const i =
                      this._lovelace.config.views[this._params.viewIndex];
                    if ((0, v.s)(i)) {
                      const { strategy: e, ...t } = i;
                      this._config = t;
                    } else (this._config = i), (this._currentType = this._type);
                  },
                },
                {
                  kind: "method",
      ...
      `;
                      ...
                      switch (this._currTab) {
                        case "tab-settings":
                          e = s.dy`
            <hui-view-editor .isNew=${
              void 0 === this._params.viewIndex
            } .hass=${this.hass} .config=${this._config} @view-config-changed=${
          ...
          `;
                        ...
                        case "tab-background":
                          e = s.dy`
            <hui-view-background-editor .hass=${this.hass} .config=${this._config} @view-config-changed=${this._viewConfigChanged}></hui-view-background-editor>
          `;
                          break;
                        case "tab-visibility":
                          e = s.dy`
            <hui-view-visibility-editor .hass=${this.hass} .config=${this._config} @view-visibility-changed=${this._viewVisibilityChanged}></hui-view-visibility-editor>
          `;
                      }
                    const i =
                        this._type === m.zh &&
                        this._currentType !== m.zh &&
      ...
      <ha-dialog open scrimClickAction escapeKeyAction @closed=${
        this.closeDialog
      } .heading=${this._viewConfigTitle} class=${(0, l.$)({
        ...
        <ha-dialog-header show-border slot="heading">
          ...
          <ha-button-menu slot="actionItems" fixed corner="BOTTOM_END" menu-corner="END" @action=${
            this._handleAction
          } @closed=${c.U}>
            ...
            i
              ? s.dy`
                <ha-alert alert-type="info">
                  ...
                  <ha-button slot="action" .label=${this.hass.localize(
          ...
          ${
            this._yamlMode
              ? s.Ld
              : s.dy`<mwc-tab-bar .activeIndex=${M.indexOf(
                  this._currTab,
        ...
        ${
          void 0 !== this._params.viewIndex
            ? s.dy`
              <ha-button class="warning" slot="secondaryAction" @click=${
                this._deleteConfirm
              }>
                ${this.hass.localize(
        ...
        <ha-button slot="primaryAction" ?disabled=${
          !this._config || this._saving || !this._dirty || i || t
        } @click=${this._save}>
          ${
            this._saving
    ...
    `;
                ...
                },
                {
                  ...
                  value: async function (e) {
                    switch (
                      (e.stopPropagation(), e.preventDefault(), e.detail.index)
                    ) {
                      case 0:
                ...
                },
                {
                  ...
                  value() {
                    return async (e) => {
                      let i, t, a;
                      try {
                        t = await (0, x.Q2)(this.hass.connection, e, !1);
                      } catch (e) {
                      ...
                      if (
                        ...
                        const [n, s] = (0, k.K_)(
                          ...
                          o = this._lovelace.config,
                          l = t;
                        a = async () => {
                          await (0, x.Oh)(this.hass, e, l),
                            await this._lovelace.saveConfig(o);
                        };
                        try {
                          await this._lovelace.saveConfig(n),
                            await (0, x.Oh)(this.hass, e, s);
                        } catch (e) {
                          console.error(e);
                          try {
                            await a(),
                      ...
                      i
                        ? (0, g.showAlertDialog)(this, { text: i })
                ...
                },
                {
                  ...
                  value: async function () {
                    ...
                    const e = { ...this._config };
                    (e.type = m.zh),
                      (e.sections = [(0, _.d)(this.hass.localize)]),
                      (e.path = void 0);
                    const i = this._params.lovelace;
                    try {
                      await i.saveConfig((0, k.Uo)(this.hass, i.config, e)),
                        this._params.saveCallback &&
                          this._params.saveCallback(i.config.views.length, e),
                        this.closeDialog();
                    } catch (e) {
                      (0, g.showAlertDialog)(this, {
                        text: `${this.hass.localize(
                ...
                },
                {
                  ...
                  key: "_deleteConfirm",
                  value: async function () {
                    const e = this._config?.sections?.length
                        ? "sections"
                        : this._config?.cards?.length
                        ? "cards"
                        : "only",
                      i = this._config?.title ? "named" : "unnamed";
                    (await (0, g.showConfirmationDialog)(this, {
                      title: this.hass.localize(
                        "ui.panel.lovelace.views.delete_title",
                      ),
                      text: this.hass.localize(
                        `ui.panel.lovelace.views.delete_${i}_view_${e}`,
                        { name: this._config?.title },
                      ),
                ...
                },
                {
                  ...
                  value: async function () {
                    ...
                    this._saving = !0;
                    const e = { ...this._config };
                    e.type !== m.zh || e.sections?.length
                      ? e.cards?.length || (e.cards = [])
                      : (e.sections = [(0, _.d)(this.hass.localize)]);
                    const i = this._params.lovelace;
                    try {
                      await i.saveConfig(
                        this._creatingView
                          ? (0, k.Uo)(this.hass, i.config, e)
                          : (0, k.YI)(
                              this.hass,
                              i.config,
                              this._params.viewIndex,
                        ...
                        this._params.saveCallback &&
                          this._creatingView &&
                          this._params.saveCallback(
                            this._params.viewIndex || i.config.views.length,
                            e,
                          ),
                        this.closeDialog();
                    } catch (e) {
                ...
                },
                {
                  ...
                  value: function (e) {
                    e.detail &&
                      e.detail.config &&
                      !(0, h.v)(this._config, e.detail.config) &&
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              value: () =>
                (0, n.Z)((e) => [
                  { name: "image", selector: { background: { original: !0 } } },
                  ...(e
                    ? [
                        {
                          name: "settings",
            ...
            },
            {
              ...
              value: function () {
                ...
                let e = this._config?.background;
                if ("string" == typeof e) {
                  const i = e.match(/url\(['"]?([^'"]+)['"]?\)/)?.[1];
                  e = { image: i };
                }
                return (
                  (e = e
                  ...
                  s.dy`
      <ha-form .hass=${this.hass} .data=${e} .schema=${this._schema(
        !0,
      )} .computeLabel=${this._computeLabelCallback} @value-changed=${
        this._valueChanged
      } .localizeValue=${
        this._localizeValueCallback
      } style=${`--picture-opacity: ${(e.opacity ?? 100) / 100};`}></ha-form>
    `
                );
              },
            },
            {
              ...
              key: "_valueChanged",
              value: function (e) {
                const i = { ...this._config, background: e.detail.value };
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                s.iv`:host{display:block;--file-upload-image-border-radius:4px}`,
            },
          ],
        };
      },
      ...
      function (e, i) {
        return {
          ...
          d: [
            ...
            { kind: "field", key: "_suggestedPath", value: () => !1 },
            {
              kind: "field",
              key: "_schema",
              value: () =>
                (0, o.Z)((e, i) => [
                  {
                    ...
                    selector: {
                      select: {
                        options: [c.zh, c.e4, c.rQ, c.Jh].map((i) => ({
                          value: i,
                          label: e(
            ...
            },
            {
              ...
              value: function () {
                ...
                const e = this._schema(this.hass.localize, this._type),
                  i = { ...this._config, type: this._type };
                return (
  ...
  91551: function (e, i, t) {
    var a = t(44249),
      n = t(72621),
      s = (t(92745), t(9359), t(56475), t(70104), t(52924), t(87319), t(57243)),
      o = t(15093),
      l = t(27486),
      d = t(36522),
      c = t(1416),
      r = (t(45801), t(7285), t(1888), t(4242));
    (0, a.Z)(
          ...
          d: [
            ...
            },
            {
              ...
              value() {
                return (0, l.Z)((e) =>
                  e.sort((e, i) =>
                    (0, c.$K)(e.name, i.name, this.hass.locale.language),
                  ),
                );
              },
            },
      ...
      ${this._sortedUsers(this._users).map(
        (e) => s.dy`
          <ha-list-item graphic="avatar" hasMeta>
            ...
            <span>${e.name}</span>
            <ha-switch slot="meta" .userId=${e.id} @change=${
              this._valChange
            } .checked=${this.checkUser(e.id)}></ha-switch>
          </ha-list-item>
        `,
      )}
    `
  ...
  80714: function (e, i, t) {
    ...
    const a = (e) => ({
      ...
      cards: [
        {
          type: "heading",
          heading: e("ui.panel.lovelace.editor.section.default_section_title"),
        },
      ],
    });
  },
};
//# sourceMappingURL=20123.541fa5a1f47de52e.js.map
