/*! For license information please see 5824.7742a1fecdacbe8e.js.LICENSE.txt */
export const __webpack_ids__ = ["5824"];
export const __webpack_modules__ = {
          ...
          finisher(i) {
            if (e.state && e.subscribe) {
              ...
              (i.prototype.connectedCallback = function () {
                e.call(this), (this[`__unbsubLocalStorage${o}`] = s?.(this));
              }),
  ...
  54237: function (e, t, i) {
    i.r(t), i.d(t, { HaIconButtonArrowNext: () => l });
    var a = i(44249),
      n = i(57243),
      d = i(15093),
      o = i(5111);
            ...
            },
            {
              ...
              value: () => [
                ...
                "rtl" === s.E.document.dir
                  ? l.iv`.mdc-floating-label,.mdc-text-field--with-leading-icon,.mdc-text-field--with-leading-icon.mdc-text-field--filled .mdc-floating-label,.mdc-text-field__icon--leading,.mdc-text-field__input[type=number]{direction:rtl;--direction:rtl}`
                  : l.iv``,
              ],
            },
          ],
  ...
  36841: function (e, t, i) {
    ...
    `;
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                n.iv`:host{display:inline-flex}ha-icon-button,ha-svg-icon{color:var(--primary-text-color)}ha-svg-icon{outline:0}.clear-button{--mdc-icon-size:20px}ha-textfield{display:inherit}.trailing{display:flex;align-items:center}`,
            },
          ],
        };
      },
  ...
  53047: function (e, t, i) {
    i.a(e, async function (e, a) {
      try {
        i.r(t), i.d(t, { HuiStackCardEditor: () => V });
        var n = i(44249),
          d = (i(9359), i(70104), i(89373), i(54207), i(12582)),
          o = i(57243),
          l = i(15093),
          r = i(62900),
          s = i(11721),
          ...
          function (e, t) {
            return {
              ...
              d: [
                ...
                { kind: "field", key: "_keys", value: () => new Map() },
                { kind: "field", key: "_schema", value: () => $ },
                {
                  kind: "field",
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return o.dy`
      <ha-form .hass=${this.hass} .data=${this.formData()} .schema=${
        this._schema
      } .computeLabel=${this._computeLabelCallback} @value-changed=${
        this._valueChanged
      }></ha-form>
      <div class="card-config">
        <div class="toolbar">
          <paper-tabs .selected=${e} scrollable @iron-activate=${
            this._handleSelectedCard
          }>
            ${this._config.cards.map(
              (e, t) => o.dy` <paper-tab> ${t + 1} </paper-tab> `,
            )}
          </paper-tabs>
          <paper-tabs id="add-card" .selected=${
            e === t ? "0" : void 0
        ...
        <div id="editor">
          ${
            e < t
              ? o.dy`
                <div id="card-options">
                  <ha-icon-button class="gui-mode-button" @click=${
                    this._toggleMode
                  } .disabled=${!this
                    ._guiModeAvailable} .label=${this.hass.localize(
                    i
                      ? "ui.panel.lovelace.editor.edit_card.show_code_editor"
                      : "ui.panel.lovelace.editor.edit_card.show_visual_editor",
                  )} .path=${i ? _ : y}></ha-icon-button>

                  <ha-icon-button-arrow-prev .disabled=${
                    0 === e
                  } .label=${this.hass.localize(
                    "ui.panel.lovelace.editor.edit_card.move_before",
                  )} @click=${
                    this._handleMove
                  } .move=${-1}></ha-icon-button-arrow-prev>

                  <ha-icon-button-arrow-next .label=${this.hass.localize(
                    "ui.panel.lovelace.editor.edit_card.move_after",
                  )} .disabled=${e === t - 1} @click=${
                    this._handleMove
                  } .move=${1}></ha-icon-button-arrow-next>

                  <ha-icon-button .label=${this.hass.localize(
                    "ui.panel.lovelace.editor.edit_card.copy",
                  )} .path=${k} @click=${this._handleCopyCard}></ha-icon-button>

                  <ha-icon-button .label=${this.hass.localize(
                    "ui.panel.lovelace.editor.edit_card.cut",
                  )} .path=${m} @click=${this._handleCutCard}></ha-icon-button>
                ...
                ${(0, s.U)(
                  ...
                  o.dy`<hui-card-element-editor .hass=${this.hass} .value=${this._config.cards[e]} .lovelace=${this.lovelace} @config-changed=${this._handleConfigChanged} @GUImode-changed=${this._handleGUIModeChanged}></hui-card-element-editor>`,
                )}
              `
              : o.dy`
                <hui-card-picker .hass=${this.hass} .lovelace=${this.lovelace} @config-changed=${this._handleCardPicked}></hui-card-picker>
              `
          }
        </div>
      </div>
    `;
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    (t[this._selectedCard] = i),
                      (this._config = { ...this._config, cards: t }),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    (this._config = { ...this._config, cards: i }),
                      this._keys.clear(),
                      (0, h.B)(this, "config-changed", {
                        config: this._config,
                      });
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    e.splice(this._selectedCard, 1),
                      (this._config = { ...this._config, cards: e }),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    a.splice(i, 0, n),
                      (this._config = { ...this._config, cards: a }),
...
//# sourceMappingURL=5824.7742a1fecdacbe8e.js.map
