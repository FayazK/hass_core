export const __webpack_ids__ = ["84924"];
export const __webpack_modules__ = {
  ...
  93826: function (e, t, i) {
    ...
    const n = (e, t, i = !0, n = !0) => {
      ...
      const s = (...s) => {
        const r = () => {
            (a = !1 === i ? 0 : Date.now()), (o = void 0), e(...s);
          },
          l = Date.now();
        a || !1 !== i || (a = l);
        const d = t - (l - a);
        d <= 0 || d > t
          ? (o && (clearTimeout(o), (o = void 0)), (a = l), e(...s))
          : o || !1 === n || (o = window.setTimeout(r, d));
      };
      return (
        (s.cancel = () => {
  ...
  34273: function (e, t, i) {
    var n = i(44249),
      o = i(72621),
      a = (i(9359), i(31526), i(22997), i(57243)),
      s = i(15093),
      r = i(5111),
      l = i(76525);
    (0, n.Z)(
...
`;
  ...
  25433: function (e, t, i) {
    ...
    const l = "ui.components.logbook.messages",
      ...
      h = (e, t, i, n, o, a) => {
        if ((n || a) && (!n || 0 === n.length) && (!a || 0 === a.length))
          return Promise.resolve([]);
        const s = { type: "logbook/get_events", start_time: t };
        return (
          i && (s.end_time = i),
          n?.length && (s.entity_ids = n),
          a?.length && (s.device_ids = a),
          o && (s.context_id = o),
          e.callWS(s)
        );
      },
      p = (e, t, i, n, o, a) => {
        if ((o || a) && (!o || 0 === o.length) && (!a || 0 === a.length))
          return Promise.reject("No entities or devices");
        const s = { type: "logbook/event_stream", start_time: i, end_time: n };
        return (
      ...
      m = (e, t) => ({
        ...
        attributes: {
          ...
          entity_picture_local: n.iY.has((0, o.M)(e.entity_id))
            ? void 0
            : e?.attributes.entity_picture_local,
          entity_picture: n.iY.has((0, o.M)(e.entity_id))
            ? void 0
      ...
      _ = (e, t) => {
        for (const i of Object.keys(c)) {
          const n = c[i];
          if (t.startsWith(n))
            return t.replace(n, `${e(`ui.components.logbook.${i}`)}`);
        }
        return t;
      },
      v = (e, t, i, o, a) => {
          ...
          case "binary_sensor": {
            ...
            if (d && (a || r))
              return (
                t(
                  `${l}.${
                    a ? "detected_device_classes" : "cleared_device_classes"
                  }.${d}`,
                  {
                    device_class: (0, s.V)(
                ...
                t(
                  `${l}.${
                    a ? "detected_device_class" : "cleared_device_class"
                  }`,
                  {
                    device_class: (0, s.V)(
                      t(`component.binary_sensor.entity_component.${d}.name`) ||
    ...
    i.a(e, async function (e, n) {
      try {
        ...
        const c = ["camera", "configurator"],
          ...
          g = ["camera", "configurator"],
          f = (e, t) => (0, o.p)(e, "history") && !g.includes((0, a.M)(t)),
          y = (e, t, i = []) => {
            ...
            const s = (0, a.M)(t);
            return !(
              (r.jV.includes(s) && (0, l.zP)(s, n, void 0, i)) ||
              g.includes(s)
            );
          },
          b = (e) => {
            const t = (0, a.M)(e.entity_id);
            if ("group" === t) {
              const t = (0, s.W)(e);
    ...
    i.a(e, async function (e, n) {
      try {
        ...
        const r = {
          ...
          d = (e) =>
            a.l.includes(e) ? e : a.tm.includes(e) ? "hidden" : "default",
          c = (e) => {
            e in r && r[e]();
          };
        n();
  ...
  6311: function (e, t, i) {
    i.a(e, async function (e, n) {
      try {
        i.r(t), i.d(t, { DialogStatisticsFix: () => m });
        var o = i(44249),
          a = (i(31622), i(57243)),
          s = i(15093),
          r = i(17170),
          ...
          h = i(12660),
          p = e([r, h]);
        [r, h] = p.then ? (await p)() : p;
        let m = (0, o.Z)(
          [(0, s.Mo)("dialog-statistics-fix")],
          function (e, t) {
            return {
              F: class extends t {
                constructor(...t) {
      ...
      <ha-dialog open scrimClickAction escapeKeyAction @closed=${
        ...
        ${
          "entity_not_recorded" !== e.type
            ? a.dy`<mwc-button slot="primaryAction" @click=${
                this._clearStatistics
              } class="warning" .disabled=${this._clearing}>
                ${
                  this._clearing
                    ? a.dy`<ha-spinner size="small" aria-label="Saving"></ha-spinner>`
                    : a.Ld
                }
            ...
            : a.dy`<mwc-button slot="primaryAction" @click=${this._cancel}>
    ...
    `;
                ...
                },
                {
                  ...
                  key: "_cancel",
                  value: function () {
                    this._params?.cancelCallback(), this._closeDialog();
                  },
                },
                {
                  kind: "method",
                  ...
                  value: async function () {
                    ...
                    try {
                      ...
                      await (0, h.showAlertDialog)(this, {
                        title:
                          "timeout" === e.code
                            ? this.hass.localize(
      ...
      try {
        i.r(t),
          i.d(t, {
            ...
            showAlertDialog: () => a.showAlertDialog,
            showConfirmationDialog: () => a.showConfirmationDialog,
...
//# sourceMappingURL=84924.cd48a3732bff6980.js.map
