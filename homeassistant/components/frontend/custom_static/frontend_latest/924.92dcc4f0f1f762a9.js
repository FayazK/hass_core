export const __webpack_ids__ = ["924"];
export const __webpack_modules__ = {
  ...
  93826: function (e, t, i) {
    ...
    const o = (e, t, i = !0, o = !0) => {
      ...
      const n = (...n) => {
        const s = () => {
            (r = !1 === i ? 0 : Date.now()), (a = void 0), e(...n);
          },
          l = Date.now();
        r || !1 !== i || (r = l);
        const d = t - (l - r);
        d <= 0 || d > t
          ? (a && (clearTimeout(a), (a = void 0)), (r = l), e(...n))
          : a || !1 === o || (a = window.setTimeout(s, d));
      };
      return (
        (n.cancel = () => {
          clearTimeout(a), (a = void 0), (r = 0);
        }),
        n
      );
    };
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              value: function () {
                return a.dy`
      <mwc-icon-button aria-label=${(0, n.o)(this.label)} title=${(0, n.o)(
  ...
  43344: function (e, t, i) {
    ...
    `;
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                r.iv`:host{position:relative}.dot{pointer-events:none;position:absolute;background-color:var(--accent-color);width:12px;height:12px;top:9px;right:7px;inset-inline-end:7px;inset-inline-start:initial;border-radius:50%;border:2px solid var(--app-header-background-color)}`,
            },
          ],
        };
      },
        ...
        return {
          ...
          d: [
            ...
            },
            {
              kind: "field",
              decorators: [
                (0, r.Cb)({ type: Boolean, attribute: "main-page" }),
              ],
              key: "mainPage",
              value: () => !1,
            },
            {
              kind: "field",
              decorators: [(0, r.Cb)({ type: String, attribute: "back-path" })],
              key: "backPath",
              value: void 0,
            },
            {
  ...
  29782: function (e, t, i) {
    i.a(e, async function (e, o) {
      try {
        ...
        var a = i(44249),
          ...
          h = i(83523),
          p = i(58776),
          u = (i(54977), i(48103), i(25482)),
          f = (i(87979), i(6736)),
          b = i(99801),
          v = i(17227),
          m = i(25576),
          g = e([b]);
        b = (g.then ? (await g)() : g)[0];
        const y =
        ...
        (0, a.Z)(
          [(0, s.Mo)("ha-config-repairs-dashboard")],
          function (e, t) {
            class i extends t {
              constructor(...t) {
                super(...t), e(this);
            ...
            return {
              ...
              d: [
                ...
                {
                  kind: "field",
                  key: "_getFilteredIssues",
                  value: () =>
                    (0, l.Z)((e, t) => (e ? t : t.filter((e) => !e.ignored))),
                },
                {
                  kind: "method",
                  key: "connectedCallback",
                  value: function () {
                    ...
                    "system-health" === (0, p.io)("dialog") &&
                      ((0, h.c)("/config/repairs", { replace: !0 }),
                      (0, m.H)(this));
                  },
                },
                {
                  ...
                  value: function () {
                    return [
                      (0, u.$X)(this.hass.connection, (e) => {
                        this._repairsIssues = e.issues.sort(
                          (e, t) => u.wC[e.severity] - u.wC[t.severity],
                        );
                        const t = new Set();
                        for (const e of this._repairsIssues) t.add(e.domain);
                        this.hass.loadBackendTranslation("issues", [...t]);
                      }),
                    ];
                  },
                },
                {
                  ...
                  key: "render",
                  value: function () {
                    const e = this._getFilteredIssues(
                      this._showIgnored,
                      this._repairsIssues,
                    );
                    return n.dy`
      <hass-subpage back-path="/config/system" .hass=${this.hass} .narrow=${
        ...
        <div slot="toolbar-icon">
          <ha-button-menu multi>
            ...
            <ha-check-list-item left @request-selected=${
              this._toggleIgnored
          ...
          <ha-card outlined>
            <div class="card-content">
              ${
                e.length
                  ? n.dy`
                    <ha-config-repairs .hass=${this.hass} .narrow=${this.narrow} .repairsIssues=${e}></ha-config-repairs>
                  `
                  : n.dy`
    ...
    `;
                ...
                {
                  kind: "method",
                  key: "_showSystemInformationDialog",
                  value: function (e) {
                    (0, c.Q)(e) && (0, m.H)(this);
                  },
                },
                {
                  kind: "method",
                  key: "_showIntegrationStartupDialog",
                  value: function (e) {
                    (0, c.Q)(e) && (0, v.b)(this);
                  },
                },
                ...
                },
                {
                  ...
                  key: "styles",
                  value: () =>
                    n.iv`.content{padding:28px 20px 0;max-width:1040px;margin:0 auto}ha-card{max-width:600px;margin:0 auto;height:100%;justify-content:space-between;flex-direction:column;display:flex;margin-bottom:max(24px,env(safe-area-inset-bottom))}.card-content{display:flex;justify-content:space-between;flex-direction:column;padding:0}.no-repairs{padding:16px}li[divider]{border-bottom-color:var(--divider-color)}`,
                },
              ],
            };
          },
  ...
  17227: function (e, t, i) {
    i.d(t, { b: () => r });
    var o = i(36522);
    const a = () =>
        Promise.all([i.e("91552"), i.e("97983"), i.e("85626")]).then(
          i.bind(i, 9954),
        ),
      r = (e) => {
        (0, o.B)(e, "show-dialog", {
  ...
  25576: function (e, t, i) {
    i.d(t, { H: () => r });
    var o = i(36522);
    const a = () =>
        Promise.all([i.e("97983"), i.e("7257"), i.e("34658")]).then(
          i.bind(i, 2048),
        ),
      r = (e) => {
        (0, o.B)(e, "show-dialog", {
...
//# sourceMappingURL=924.92dcc4f0f1f762a9.js.map
