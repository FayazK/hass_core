export const __webpack_ids__ = ["41608"];
export const __webpack_modules__ = {
  ...
  75101: function (e, t, i) {
    ...
    const a = (e, t) =>
      ...
      r = (e, t, i) => {
        const a = { type: "config_entries/subscribe" };
        return (
          i && i.type && (a.type_filter = i.type),
          e.connection.subscribeMessage((e) => t(e), a)
        );
      },
      c = (e, t) => {
        const i = {};
  ...
  15681: function (e, t, i) {
    ...
    const s = [
      ...
      y = (e, t) =>
        e.subscribeEvents(
          (0, n.D)(() => f(e).then((e) => t.setState(e, !0)), 500, !0),
          "config_entry_discovered",
        ),
      v = (e) => (0, a._)(e, "_configFlowProgress", f, y),
    ...
    const r = (e, t) =>
      (0, s.w)(e, t, {
        ...
        renderShowFormStepFieldHelper(e, t, i, n) {
          ...
          return s
            ? a.dy`<ha-markdown breaks .content=${s}></ha-markdown>`
            : "";
        },
  ...
  3409: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        ...
        (0, a.Z)(
          [(0, o.Mo)("ha-energy-battery-settings")],
          function (e, t) {
            return {
              F: class extends t {
                constructor(...t) {
                ...
                },
                {
                  ...
                  value: function () {
                    const e = [],
                      t = [];
                    return (
                      this.preferences.energy_sources.forEach((i, a) => {
                        "battery" === i.type &&
                          (e.push(i),
                          this.validationResult &&
                            t.push(this.validationResult.energy_sources[a]));
                      }),
                      n.dy`
      <ha-card outlined>
        ...
        <div class="card-content">
          <p>
            ...
            <a target="_blank" rel="noopener noreferrer" href=${(0, h.R)(
              this.hass,
              "/docs/energy/battery/",
            )}>${this.hass.localize(
          ...
          ${e.map((e) => {
            const t = this.hass.states[e.stat_energy_to];
            return n.dy`
              <div class="row" .source=${e}>
                ${
                  t?.attributes.icon
                    ? n.dy`<ha-icon .icon=${t.attributes.icon}></ha-icon>`
                    : n.dy`<ha-svg-icon .path=${f}></ha-svg-icon>`
                }
                <div class="content">
                  <span class="label">${(0, c.Kd)(
                    this.hass,
                    e.stat_energy_from,
                    this.statsMetadata?.[e.stat_energy_from],
                  )}</span>
                  <span class="label">${(0, c.Kd)(
                    this.hass,
                    e.stat_energy_to,
                    this.statsMetadata?.[e.stat_energy_to],
                  )}</span>
                </div>
                <ha-icon-button .label=${this.hass.localize(
                  "ui.panel.config.energy.battery.edit_battery_system",
                )} @click=${this._editSource} .path=${v}></ha-icon-button>
                <ha-icon-button .label=${this.hass.localize(
                  "ui.panel.config.energy.battery.delete_battery_system",
                )} @click=${this._deleteSource} .path=${y}></ha-icon-button>
              </div>
            `;
          })}
          <div class="row border-bottom">
            <ha-svg-icon .path=${f}></ha-svg-icon>
            <mwc-button @click=${this._addSource}>${this.hass.localize(
                    ...
                    if (
                      ...
                      try {
                        ...
                        (0, l.showAlertDialog)(this, {
                          title: `Failed to save config: ${e.message}`,
                        });
                      }
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      d.Qx,
                      p.L,
                      n.iv`.row{height:58px}.content{display:flex;flex-direction:column}.label{overflow:hidden;text-overflow:ellipsis}`,
                    ];
                  },
                },
              ],
  ...
  98445: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        var a = i(44249),
          n = (i(9359), i(56475), i(31526), i(70104), i(31622), i(57243)),
          o = i(91583),
          s = i(15093),
          r = i(36522),
        ...
        const y =
          ...
          m =
            "M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";
        (0, a.Z)(
          [(0, s.Mo)("ha-energy-device-settings")],
          function (e, t) {
            return {
              F: class extends t {
                constructor(...t) {
      ...
      <ha-card outlined>
        ...
        <div class="card-content">
          <p>
            ...
            <a target="_blank" rel="noopener noreferrer" href=${(0, u.R)(
              this.hass,
              ...
              ${(0, o.r)(
                ...
                (e) => n.dy`
                  <div class="row" .device=${e}>
                    ...
                    <ha-icon-button .label=${this.hass.localize(
                      "ui.common.edit",
                    )} @click=${this._editDevice} .path=${m}></ha-icon-button>
                    <ha-icon-button .label=${this.hass.localize(
                      "ui.common.delete",
                    )} @click=${
                      this._deleteDevice
                    } .device=${e} .path=${y}></ha-icon-button>
                  </div>
                `,
              )}
            </div>
          ...
          <div class="row">
            <ha-svg-icon .path=${v}></ha-svg-icon>
            <mwc-button @click=${this._addDevice}>${this.hass.localize(
    ...
    `;
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    const { oldIndex: t, newIndex: i } = e.detail,
                      a = this.preferences.device_consumption.concat(),
                      n = a.splice(t, 1)[0];
                    a.splice(i, 0, n);
                    const o = { ...this.preferences, device_consumption: a };
                    (0, r.B)(this, "value-changed", { value: o }),
                      this._savePreferences(o);
                  },
                },
                {
                  kind: "method",
                    ...
                    (0, p.Qh)(this, {
                      ...
                      saveCallback: async (e) => {
                        await this._savePreferences({
                          ...this.preferences,
                          device_consumption:
                            this.preferences.device_consumption.map((i) =>
                              i === t ? e : i,
                            ),
                        });
                      },
                  ...
                  value: async function (e) {
                    ...
                    if (
                      ...
                      try {
                        ...
                        e.device_consumption.forEach((i, a) => {
                          i.included_in_stat === t.stat_consumption &&
                            ((e.device_consumption[a] = {
                              ...e.device_consumption[a],
                            }),
                            delete e.device_consumption[a].included_in_stat);
                        }),
                ...
                },
                {
                  ...
                  key: "styles",
                  value: function () {
                    return [h.Qx, g.L, n.iv`.handle{cursor:move;cursor:grab}`];
                  },
                },
              ],
            };
    ...
    i.a(e, async function (e, t) {
      ...
      <ha-card outlined>
        ...
        <div class="card-content">
          ...
          ${e.map((e) => {
            const t = this.hass.states[e.stat_energy_from];
            return n.dy`
              <div class="row" .source=${e}>
                ${
                  t?.attributes.icon
                    ? n.dy`<ha-icon .icon=${t.attributes.icon}></ha-icon>`
                    : n.dy`<ha-svg-icon .path=${y}></ha-svg-icon>`
                }
                <span class="content">${(0, c.Kd)(
                  this.hass,
                  e.stat_energy_from,
                  this.statsMetadata?.[e.stat_energy_from],
                )}</span>
                ...
                )} @click=${this._deleteSource} .path=${f}></ha-icon-button>
              </div>
            `;
          })}
          <div class="row border-bottom">
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    (0, u.vp)(this, {
                      ...
                      metadata: this.statsMetadata?.[t.stat_energy_from],
                      gas_sources: this.preferences.energy_sources.filter(
                        (e) => "gas" === e.type,
                      ),
                      saveCallback: async (e) => {
  ...
  98237: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        ...
        (0, a.Z)(
          [(0, o.Mo)("ha-energy-grid-settings")],
          function (e, t) {
            return {
              F: class extends t {
                constructor(...t) {
              ...
              d: [
                ...
                },
                {
                  ...
                  key: "render",
                  value: function () {
                    const e = this.preferences.energy_sources.findIndex(
                      (e) => "grid" === e.type,
                    );
                    let t, i;
                    return (
                      -1 === e
                        ? (t = (0, c.iK)())
                        : ((t = this.preferences.energy_sources[e]),
                          this.validationResult &&
                            (i = this.validationResult.energy_sources[e])),
                      n.dy`
      <ha-card outlined>
        <h1 class="card-header">
        ...
        <div class="card-content">
          <p>
            ...
            <a target="_blank" rel="noopener noreferrer" href=${(0, g.R)(
              this.hass,
            ...
            return n.dy`
              <div class="row" .source=${e}>
                ${
                  t?.attributes.icon
                    ? n.dy`<ha-icon .icon=${t?.attributes.icon}></ha-icon>`
                    : n.dy`<ha-svg-icon .path=${b}></ha-svg-icon>`
                }
                <span class="content">${(0, l.Kd)(
                  this.hass,
                  e.stat_energy_from,
                  this.statsMetadata?.[e.stat_energy_from],
                )}</span>
                ...
                )} @click=${this._editFromSource} .path=${k}></ha-icon-button>
                <ha-icon-button .label=${this.hass.localize(
                  "ui.panel.config.energy.grid.delete_consumption",
                )} @click=${this._deleteFromSource} .path=${_}></ha-icon-button>
              </div>
            `;
          })}
          <div class="row border-bottom">
            <ha-svg-icon .path=${b}></ha-svg-icon>
            <mwc-button @click=${this._addFromSource}>${this.hass.localize(
            ...
            return n.dy`
              <div class="row" .source=${e}>
                ${
                  t?.attributes.icon
                    ? n.dy`<ha-icon .icon=${t.attributes.icon}></ha-icon>`
                    : n.dy`<ha-svg-icon .path=${m}></ha-svg-icon>`
                }
                <span class="content">${(0, l.Kd)(
                  this.hass,
                  e.stat_energy_to,
                ...
                )} @click=${this._editToSource} .path=${k}></ha-icon-button>
                <ha-icon-button .label=${this.hass.localize(
                  "ui.panel.config.energy.grid.delete_return",
                )} @click=${this._deleteToSource} .path=${_}></ha-icon-button>
              </div>
            `;
          })}
          <div class="row border-bottom">
            <ha-svg-icon .path=${m}></ha-svg-icon>
            <mwc-button @click=${this._addToSource}>${this.hass.localize(
          ...
          ${
            this._co2ConfigEntry
              ? n.dy`<div class="row" .entry=${this._co2ConfigEntry}>
                ...
                )} @click=${this._removeCO2Sensor} .path=${_}></ha-icon-button>
              </div>`
              : n.dy`
                <div class="row border-bottom">
                  <img alt="" crossorigin="anonymous" referrerpolicy="no-referrer" src=${(0,
    ...
    `
                ...
                },
                {
                  ...
                  value: function (e) {
                    const t = e.currentTarget.closest(".row").source,
                      i = this.preferences.energy_sources.find(
                        (e) => "grid" === e.type,
                      );
                    (0, f.a0)(this, {
                      source: { ...t },
                      ...
                      metadata: this.statsMetadata?.[t.stat_energy_from],
                      saveCallback: async (e) => {
                        const i = (0, c.Jj)(this.preferences).grid[0].flow_from,
                          a = {
                            ...this.preferences,
                            energy_sources: this.preferences.energy_sources.map(
                              (a) =>
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    (0, f.u_)(this, {
                      source: { ...t },
                      grid_source: i,
                      metadata: this.statsMetadata?.[t.stat_energy_to],
                      saveCallback: async (e) => {
                        const i = (0, c.Jj)(this.preferences).grid[0].flow_to,
                          a = {
                            ...this.preferences,
                            energy_sources: this.preferences.energy_sources.map(
                              (a) =>
                  ...
                  value: async function (e) {
                    ...
                    const i = (0, c.Jj)(
                      ...
                      a = {
                        ...
                        energy_sources: this.preferences.energy_sources.map(
                          (e) =>
                            "grid" === e.type ? { ...e, flow_from: i } : e,
                        ),
                      },
                      n = this._removeEmptySources(a);
                    await this._savePreferences(n);
                  },
                },
                {
                  kind: "method",
  ...
  76539: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        ...
        (0, a.Z)(
          [(0, o.Mo)("ha-energy-solar-settings")],
          function (e, t) {
            return {
              F: class extends t {
                constructor(...t) {
            ...
            return n.dy`
              <div class="row" .source=${e}>
                ${
                  t?.attributes.icon
                    ? n.dy`<ha-icon .icon=${t.attributes.icon}></ha-icon>`
                    : n.dy`<ha-svg-icon .path=${v}></ha-svg-icon>`
                }
                <span class="content">${(0, c.Kd)(
                  this.hass,
                  e.stat_energy_from,
                ...
                ${
                  this.info
                    ? n.dy`
                      ...
                      )} @click=${this._editSource} .path=${y}></ha-icon-button>
                    `
                    : ""
                }
                <ha-icon-button .label=${this.hass.localize(
  ...
  34234: function (e, t, i) {
    ...
    i(99426);
    (0, a.Z)(
      [(0, o.Mo)("ha-energy-validation-result")],
      function (e, t) {
        return {
          F: class extends t {
            constructor(...t) {
        ...
        <ha-alert alert-type="warning" .title=${
          this.hass.localize(`component.energy.issues.${e.type}.title`) ||
          e.type
        }>
          ${this.hass.localize(
          ...
          ${
            "recorder_untracked" === e.type
              ? n.dy`(<a href="https://www.home-assistant.io/integrations/recorder#configure-filter" target="_blank" rel="noopener noreferrer">${this.hass.localize(
                  "ui.panel.config.common.learn_more",
                )}</a>)`
              : ""
          }
          <ul>
            ${e.affected_entities.map(
              ([e, t]) => n.dy`<li>${e}${t ? n.dy` (${t})` : ""}</li>`,
            )}
          </ul>
        </ha-alert>
      `,
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                n.iv`ul{padding-left:24px;padding-inline-start:24px padding-inline-end: initial;margin:4px 0}a{color:var(--primary-color)}`,
            },
          ],
        };
      },
      ...
      try {
        ...
        const f =
          ...
          v =
            "M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";
        (0, a.Z)(
          [(0, o.Mo)("ha-energy-water-settings")],
          function (e, t) {
            return {
              F: class extends t {
                constructor(...t) {
