export const __webpack_ids__ = ["99956"];
        ...
        const l = (e, t, i) => c(t, i.time_zone).format(e),
          ...
          u = (e, t, i) => {
            ...
            const a = n.formatToParts(e),
              ...
              s = a.find((e) => "day" === e.type)?.value,
              d = a.find((e) => "month" === e.type)?.value,
              l = a.find((e) => "year" === e.type)?.value,
              c = a.at(a.length - 1);
            let h = "literal" === c?.type ? c?.value : "";
            "bg" === t.language && t.date_format === r.t6.YMD && (h = "");
            return {
              [r.t6.DMY]: `${s}${o}${d}${o}${l}${h}`,
              [r.t6.MDY]: `${d}${o}${s}${o}${l}${h}`,
              [r.t6.YMD]: `${l}${o}${d}${o}${s}${h}`,
            }[t.date_format];
          },
          p = (0, o.Z)((e, t) => {
          ...
          I = (e, t, i) => $(t, i.time_zone).format(e),
          $ = (0, o.Z)(
            (e, t) =>
              new Intl.DateTimeFormat(e.language, {
                weekday: "short",
  ...
  64214: function (e, t, i) {
    i.a(e, async function (e, n) {
      try {
        ...
        const h = (e, t, i) => m(t, i.time_zone).format(e),
          m = (0, o.Z)(
            (e, t) =>
              new Intl.DateTimeFormat(e.language, {
                year: "numeric",
    ...
    i.a(e, async function (e, n) {
      try {
        ...
        const d = 1e3,
          l = 60,
          c = 60 * l;
        function h(e, t = Date.now(), i, n = {}) {
          const h = { ...m, ...(n || {}) },
            u = (+e - +t) / d;
          if (Math.abs(u) < h.second)
          ...
          const y = new Date(e),
            _ = new Date(t);
          y.setHours(0, 0, 0, 0), _.setHours(0, 0, 0, 0);
          const f = (0, a.j)(y, _);
          if (0 === f) return { value: Math.round(g), unit: "hour" };
          if (Math.abs(f) < h.day) return { value: f, unit: "day" };
          const v = (0, s.Bt)(i),
            b = (0, o.z)(y, { weekStartsOn: v }),
            w = (0, o.z)(_, { weekStartsOn: v }),
            k = (0, r.p)(b, w);
          if (0 === k) return { value: f, unit: "day" };
          if (Math.abs(k) < h.week) return { value: k, unit: "week" };
          const x = y.getFullYear() - _.getFullYear(),
            T = 12 * x + y.getMonth() - _.getMonth();
          return 0 === T
            ? { value: k, unit: "week" }
            : Math.abs(T) < h.month || 0 === x
            ? { value: T, unit: "month" }
...
`;
  ...
  99650: function (e, t, i) {
    ...
    const o = [1, 2, 3, 4, 6, 8],
      ...
      h = async (e, t, i, a) => {
        const o = await (0, n.U)("_cameraTmbUrl", 9e3, m, e, t);
        return l(o, i, a);
      },
      m = async (e, t) => {
      ...
      u = async (e, t, i) => {
        const n = { type: "camera/stream", entity_id: t };
        i && (n.format = i);
        const a = await e.callWS(n);
        return (a.url = e.hassUrl(a.url)), a;
      },
      p = (e, t, i, n) =>
        e.connection.subscribeMessage(n, {
      ...
      y = (e, t) => e.callWS({ type: "camera/get_prefs", entity_id: t }),
      _ = (e, t, i) =>
        e.callWS({ type: "camera/update_prefs", entity_id: t, ...i }),
      f = "media-source://camera/",
      v = (e) => e.startsWith(f),
      b = (e) => e.substring(22),
      w = async (e, t) =>
    ...
    i.a(e, async function (e, n) {
      try {
        ...
        var a = i(28113),
          ...
          u = i(50625),
          p = i(40249),
          g = e([a, o, r, s, d, l, c, h, m, u]);
        [a, o, r, s, d, l, c, h, m, u] = g.then ? (await g)() : g;
        const y = new Set([
            "entity",
            "entities",
            "button",
          ...
          _ = {
            "alarm-panel": () =>
              Promise.all([i.e("46379"), i.e("84269")]).then(i.bind(i, 40036)),
            area: () =>
              Promise.all([i.e("69577"), i.e("79931"), i.e("37910")]).then(
                i.bind(i, 82820),
              ),
            calendar: () =>
              Promise.all([
            ...
            error: () => i.e("37269").then(i.bind(i, 53257)),
            ...
            markdown: () =>
              Promise.all([i.e("2981"), i.e("34172")]).then(i.bind(i, 91713)),
            "media-control": () =>
              Promise.all([i.e("24061"), i.e("59105")]).then(i.bind(i, 78793)),
            "picture-elements": () =>
              Promise.all([
                i.e("46379"),
                i.e("24199"),
            ...
            "picture-entity": () =>
              Promise.all([i.e("69577"), i.e("79931"), i.e("14517")]).then(
                i.bind(i, 54529),
              ),
            "picture-glance": () =>
              Promise.all([i.e("69577"), i.e("79931"), i.e("99457")]).then(
                i.bind(i, 57733),
              ),
          ...
          f = (e) => (0, p.Xm)("card", e, y, _, void 0, void 0),
          v = (e) => (0, p.Tw)("card", e, y, _, void 0, void 0),
          b = (e) => (0, p.ED)(e, "card", y, _);
        n();
      } catch (e) {
        n(e);
      }
    ...
    i.a(e, async function (e, n) {
      try {
        ...
        var a = i(44249),
          ...
          y = i(35830),
          _ = i(58776),
          f = (i(59826), i(20130), i(23334), i(7285), i(43344), i(51223)),
          v = (i(37583), i(47593), i(75101)),
          b = i(63318),
          w = i(57816),
          k = i(95276),
          x = i(38572),
          ...
          D = i(4026),
          M = e([f, E]);
        [f, E] = M.then ? (await M)() : M;
        const Z = "M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z",
          z =
          ...
          L = "M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z";
        (0, a.Z)(
          ...
          function (e, t) {
            ...
            return {
              ...
              d: [
                ...
                { kind: "field", key: "_headerHeight", value: () => 56 },
                {
                  kind: "field",
                  key: "_showPaneController",
                  value() {
                    return new r.Z(this, {
                      callback: (e) => e[0]?.contentRect.width > 750,
                    });
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    this._entityId
                      ? (0, g.c)(
                          (0, y.q)((0, _.ou)({ entity_id: this._entityId })),
                          { replace: !0 },
                        )
                ...
                },
                {
                  ...
                  key: "_cardConfig",
                  value: () =>
                    (0, l.Z)((e) => ({ type: "todo-list", entity: e })),
                },
                {
                  kind: "method",
                  key: "render",
                  value: function () {
                    const e = this._entityId
                      ...
                      t = this._entityId
                        ...
                        : void 0,
                      i = this._showPaneController.value ?? !this.narrow,
                      n = (0, k.cA)(this.hass).map(
                        (e) => s.dy`<ha-list-item graphic="icon" @click=${
                          this._handleEntityPicked
                        } .entityId=${e.entity_id} .activated=${
                          e.entity_id === this._entityId
                        }>
          <ha-state-icon .stateObj=${e} .hass=${
            this.hass
          } slot="graphic"></ha-state-icon>${e.name}
        </ha-list-item> `,
                      );
                    return s.dy`
      <ha-two-pane-top-app-bar-fixed .pane=${i} footer>
        ...
        <div slot="title">
          ${
            i
              ...
              : s.dy`<ha-button-menu class="lists" activatable fixed .noAnchor=${
                  this.mobile
                } .y=${
                  this.mobile ? this._headerHeight / 2 : this._headerHeight / 4
                } .x=${this.mobile ? 0 : void 0}>
                <ha-button slot="trigger">
                  <div>
                    ${this._entityId ? (t ? (0, u.C)(t) : this._entityId) : ""}
                  </div>
                  ...
                  this.hass.user?.is_admin
                    ? s.dy`<li divider role="separator"></li>
                      <ha-list-item graphic="icon" @click=${this._addList}>
                        <ha-svg-icon .path=${L} slot="graphic"></ha-svg-icon>
        ...
        <mwc-list slot="pane" activatable>${n}</mwc-list>
        ${
          i && this.hass.user?.is_admin
            ? s.dy`<ha-list-item graphic="icon" slot="pane-footer" @click=${
                this._addList
              }>
              <ha-svg-icon .path=${L} slot="graphic"></ha-svg-icon>
              ${this.hass.localize("ui.panel.todo.create_list")}
        ...
        <ha-button-menu slot="actionItems">
          <ha-icon-button slot="trigger" .label=${""} .path=${C}></ha-icon-button>
          ${
            this._conversation(this.hass.config.components)
              ? s.dy`<ha-list-item graphic="icon" @click=${
                  this._showMoreInfoDialog
                } .disabled=${!this._entityId}>
                <ha-svg-icon .path=${P} slot="graphic">
                </ha-svg-icon>
          ...
          <ha-list-item graphic="icon" @click=${this._showVoiceCommandDialog}>
            <ha-svg-icon .path=${z} slot="graphic">
            </ha-svg-icon>
            ${this.hass.localize("ui.panel.todo.assist")}
          </ha-list-item>
          ${
            "local_todo" === e?.platform
              ? s.dy` <li divider role="separator"></li>
                <ha-list-item graphic="icon" @click=${
                  this._deleteList
                } class="warning" .disabled=${!this._entityId}>
                  <ha-svg-icon .path=${A} slot="graphic" class="warning">
                  </ha-svg-icon>
        ...
        <div id="columns">
          <div class="column">
            ${
              this._entityId
                ? s.dy`
                  <hui-card .hass=${this.hass} .config=${this._cardConfig(
                    this._entityId,
                  )}></hui-card>
                `
                : s.Ld
        ...
        ${
          t && (0, p.e)(t, k.$g.CREATE_TODO_ITEM)
            ? s.dy`<ha-fab .label=${this.hass.localize(
                "ui.panel.todo.add_item",
              )} extended @click=${this._addItem}>
    ...
    `;
                ...
                },
                {
                  ...
                  value: async function () {
                    ...
                    const e = await (0, b.L3)(this.hass, this._entityId);
                    if ("local_todo" !== e.platform) return;
                    const t = e.config_entry_id;
                    if (!t) return;
                    if (
                      !(await (0, T.showConfirmationDialog)(this, {
                        title: this.hass.localize(
                          "ui.panel.todo.delete_confirm_title",
                          {
                            name:
                              this._entityId in this.hass.states
                                ? (0, u.C)(this.hass.states[this._entityId])
                                : this._entityId,
                          },
                        ),
                      ...
                      return;
                    const i = await (0, v.iJ)(this.hass, t);
                    (this._entityId = (0, k.cA)(this.hass)[0]?.entity_id),
                      i.require_restart &&
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      $.Qx,
                      s.iv`:host{display:block}#columns{display:flex;flex-direction:row;justify-content:center;margin:8px;padding-bottom:70px}.column{flex:1 0 0;max-width:500px;min-width:0}:host([mobile]) .lists{--mdc-menu-min-width:100vw}:host(:not([mobile])) .lists ha-list-item{max-width:calc(100vw - 120px)}:host([mobile]) ha-button-menu{--mdc-shape-medium:0 0 var(--mdc-shape-medium) var(--mdc-shape-medium)}ha-button-menu{max-width:100%}ha-button-menu ha-button{--button-slot-container-overflow:hidden;max-width:100%;--mdc-theme-primary:currentColor;--mdc-typography-button-text-transform:none;--mdc-typography-button-font-size:var(
...
//# sourceMappingURL=99956.90458d56069d5dda.js.map
