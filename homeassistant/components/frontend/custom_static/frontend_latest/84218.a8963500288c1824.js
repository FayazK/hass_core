export const __webpack_ids__ = ["84218"];
export const __webpack_modules__ = {
  38034: function (e, s, t) {
    t.d(s, { Fk: () => n, HC: () => d, _v: () => o, fL: () => a, rx: () => i });
    const i = {
      ...
      d = (e) => e.callWS({ type: "homeassistant/expose_entity/list" });
  },
  8878: function (e, s, t) {
    t.r(s), t.d(s, { voiceAssistantTabs: () => h });
    var i = t(44249),
      a = t(72621),
      n = t(60738),
      o = t(15093),
    ...
    (0, i.Z)(
      [(0, o.Mo)("ha-config-voice-assistants")],
      function (e, s) {
        class i extends s {
          constructor(...s) {
            super(...s), e(this);
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              decorators: [
                (0, o.SB)(),
                (0, n.F_)({ context: d.A1, subscribe: !0 }),
              ],
              key: "_entities",
              value: void 0,
            },
            ...
            },
            {
              ...
              value: function (e) {
                (e.hass = this.hass),
                  ...
                  (e.exposedEntities = this._exposedEntities);
              },
            },
            {
              kind: "method",
              key: "willUpdate",
              value: function (e) {
                e.has("_entities") && this._fetchExposedEntities();
              },
            },
            {
              kind: "field",
              key: "_fetchExposedEntities",
              value() {
                return async () => {
                  (this._exposedEntities = (
                    await (0, l.HC)(this.hass)
                  ).exposed_entities),
                    this.lastChild &&
                      (this.lastChild.exposedEntities = this._exposedEntities);
                };
              },
            },
          ],
...
//# sourceMappingURL=84218.a8963500288c1824.js.map
