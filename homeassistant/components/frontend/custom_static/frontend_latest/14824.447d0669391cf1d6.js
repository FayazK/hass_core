export const __webpack_ids__ = ["14824"];
export const __webpack_modules__ = {
  ...
  31146: function (e, t, i) {
    i.d(t, { i: () => o });
    const a = (0, i(93826).P)((e) => {
      ...
      o = (e) => (t) => ({
        ...
        descriptor: {
          set(e) {
            a(e), (this[`__${String(t.key)}`] = e);
          },
          get() {
            return this[`__${String(t.key)}`] || history.state?.scrollPosition;
          },
          enumerable: !0,
          configurable: !0,
        },
        finisher(i) {
          const a = i.prototype.connectedCallback;
    ...
    i.a(e, async function (e, a) {
      try {
        ...
        function h(e, t = Date.now(), i, a = {}) {
          ...
          const g = p / c;
          if (Math.abs(g) < h.hour)
            return { value: Math.round(g), unit: "hour" };
          const v = new Date(e),
            m = new Date(t);
          v.setHours(0, 0, 0, 0), m.setHours(0, 0, 0, 0);
          const y = (0, o.j)(v, m);
          if (0 === y) return { value: Math.round(g), unit: "hour" };
          if (Math.abs(y) < h.day) return { value: y, unit: "day" };
          const k = (0, r.Bt)(i),
            b = (0, n.z)(v, { weekStartsOn: k }),
            _ = (0, n.z)(m, { weekStartsOn: k }),
            w = (0, s.p)(b, _);
          if (0 === w) return { value: y, unit: "day" };
          if (Math.abs(w) < h.week) return { value: w, unit: "week" };
          const x = v.getFullYear() - m.getFullYear(),
            $ = 12 * x + v.getMonth() - m.getMonth();
          return 0 === $
            ? { value: w, unit: "week" }
            : Math.abs($) < h.month || 0 === x
            ? { value: $, unit: "month" }
  ...
  93826: function (e, t, i) {
    ...
    const a = (e, t, i = !0, a = !0) => {
      ...
      const s = (...s) => {
        const r = () => {
            (n = !1 === i ? 0 : Date.now()), (o = void 0), e(...s);
          },
          l = Date.now();
        n || !1 !== i || (n = l);
        const d = t - (l - n);
        d <= 0 || d > t
          ? (o && (clearTimeout(o), (o = void 0)), (n = l), e(...s))
          : o || !1 === a || (o = window.setTimeout(r, d));
      };
      return (
        (s.cancel = () => {
          clearTimeout(o), (o = void 0), (n = 0);
        }),
        s
      );
    };
  },
  29095: function (e, t, i) {
            ...
            <div class="progress">
              ${
                "success" === this._result
                  ? o.dy`<ha-svg-icon .path=${d}></ha-svg-icon>`
                  : "error" === this._result
                  ? o.dy`<ha-svg-icon .path=${l}></ha-svg-icon>`
                  : this.progress
                  ? o.dy`<ha-spinner size="small"></ha-spinner>`
                  : o.Ld
              }
            </div>
          `
  ...
  34273: function (e, t, i) {
    var a = i(44249),
      o = i(72621),
      n = (i(9359), i(31526), i(22997), i(57243)),
      s = i(15093),
      r = i(5111),
      l = i(76525);
    (0, a.Z)(
      [(0, s.Mo)("ha-button-menu")],
      function (e, t) {
        class i extends t {
          constructor(...t) {
            super(...t), e(this);
        ...
        return {
          ...
          d: [
            ...
            {
              kind: "field",
              decorators: [(0, s.Cb)({ attribute: "menu-corner" })],
              key: "menuCorner",
              value: () => "START",
            },
            {
            ...
            },
            {
              kind: "field",
              decorators: [
                (0, s.Cb)({ type: Boolean, attribute: "no-anchor" }),
              ],
              key: "noAnchor",
              value: () => !1,
            },
    ...
    `;
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                n.iv`:host{display:inline-block;position:relative}::slotted([disabled]){color:var(--disabled-text-color)}`,
            },
          ],
        };
      },
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                o.iv`:host{background:var(--custom-background-color,var(--card-background-color,#fff));-webkit-backdrop-filter:var(--ha-card-backdrop-filter,none);backdrop-filter:var(--ha-card-backdrop-filter,none);box-shadow:var(--ha-card-box-shadow,none);box-sizing:border-box;border-radius:var(--ha-card-border-radius,16px);color:var(--primary-text-color);display:block;transition:.3s ease-out;position:relative}:host([raised]){border:none;box-shadow:var(--ha-card-box-shadow,0px 2px 1px -1px rgba(0,0,0,.2),0px 1px 1px 0px rgba(0,0,0,.14),0px 1px 3px 0px rgba(0,0,0,.12))}.card-header,:host ::slotted(.card-header){color:var(--ha-card-header-color,var(--primary-text-color));font-family:var(--ha-card-header-font-family, inherit);font-size:var(--ha-card-header-font-size, 24px);letter-spacing:-.012em;line-height:48px;padding:12px 16px 16px;display:block;margin-block-start:0px;margin-block-end:0px;font-weight:400}:host ::slotted(.card-content:not(:first-child)),slot:not(:first-child)::slotted(.card-content){padding-top:0px;margin-top:-8px}:host ::slotted(.card-content){padding:16px}:host ::slotted(.card-actions){border-top:1px solid var(--divider-color,#e8e8e8);padding:5px 16px}`,
            },
            {
              kind: "method",
              key: "render",
  ...
  75930: function (e, t, i) {
    var a = i(44249),
      o = i(15093),
      n = i(57243),
      s = (i(59826), i(23334), i(37583), i(83166), i(87865)),
      r = i(72473);
    (0, a.Z)(
      [(0, o.Mo)("ha-copy-textfield")],
      function (e, t) {
        return {
          F: class extends t {
            constructor(...t) {
          ...
          d: [
            ...
            {
              kind: "field",
              decorators: [(0, o.Cb)({ attribute: "value" })],
              key: "value",
              value: void 0,
            },
            {
              kind: "field",
              decorators: [(0, o.Cb)({ attribute: "masked-value" })],
              key: "maskedValue",
              value: void 0,
            },
            {
              kind: "field",
              decorators: [(0, o.Cb)({ attribute: "label" })],
              key: "label",
              value: void 0,
            },
            {
      ...
      <div class="container">
        <div class="textfield-container">
          <ha-textfield .value=${
            this._showMasked && this.maskedValue ? this.maskedValue : this.value
          } readonly=readonly .suffix=${
            this.maskedValue ? n.dy`<div style="width:24px"></div>` : n.Ld
          } @click=${this._focusInput}></ha-textfield>
          ${
            this.maskedValue
              ? n.dy`<ha-icon-button class="toggle-unmasked" .label=${this.hass.localize(
                  "ui.common." + (this._showMasked ? "show" : "hide"),
                )} @click=${this._toggleMasked} .path=${
                  this._showMasked
        ...
        <ha-button @click=${this._copy} unelevated>
          <ha-svg-icon slot="icon" .path=${"M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z"}></ha-svg-icon>
    ...
    `;
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                n.iv`.container{display:flex;align-items:center;gap:8px;margin-top:8px}.textfield-container{position:relative;flex:1}.textfield-container ha-textfield{display:block}.toggle-unmasked{position:absolute;top:8px;right:8px;inset-inline-start:initial;inset-inline-end:8px;--mdc-icon-button-size:40px;--mdc-icon-size:20px;color:var(--secondary-text-color);direction:var(--direction)}`,
            },
          ],
        };
      },
...
`;
  ...
  54202: function (e, t, i) {
    ...
    i(23334);
    let r = (0, a.Z)(
      [(0, n.Mo)("ha-icon-button-arrow-prev")],
      function (e, t) {
        return {
          F: class extends t {
            constructor(...t) {
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              value: function () {
                return o.dy`
      <mwc-icon-button aria-label=${(0, s.o)(this.label)} title=${(0, s.o)(
  ...
  2790: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        var a = i(44249),
          ...
          u = i(1416),
          p = i(67862),
          f = (i(7285), i(92824), e([n, h]));
        [n, h] = f.then ? (await f)() : f;
        (0, a.Z)(
            ...
            return {
              ...
              d: [
                ...
                },
                {
                  kind: "field",
                  decorators: [
                    (0, r.Cb)({ attribute: "native-name", type: Boolean }),
                  ],
                  key: "nativeName",
                  value: () => !1,
                },
                {
                  kind: "field",
                  decorators: [
                    (0, r.Cb)({ attribute: "no-sort", type: Boolean }),
                  ],
                  key: "noSort",
                  value: () => !1,
                },
                ...
                },
                {
                  ...
                  value() {
                    return (0, l.Z)((e, t, i) => {
                      let a = [];
                      if (t) {
                        const t = p.o.translations;
                        a = e.map((e) => {
                          let i = t[e]?.nativeName;
                          if (!i)
                            try {
                      ...
                      return (
                        !this.noSort &&
                          i &&
                          a.sort((e, t) =>
                            (0, u.fe)(e.label, t.label, i.language),
                          ),
                        a
                      );
                    });
                ...
                },
                {
                  ...
                  value: function () {
                    this._defaultLanguages = Object.keys(p.o.translations);
                  },
                },
                {
                  kind: "method",
                  ...
                  value: function () {
                    const e = this._getLanguagesOptions(
                      ...
                      t =
                        this.value ??
                        (this.required ? e[0]?.value : this.value);
                    return s.dy`
      <ha-select .label=${
        this.label ??
        ...
        c.U
      } fixedMenuPosition naturalMenuWidth .inlineArrow=${this.inlineArrow}>
        ${
          0 === e.length
    ...
    `;
                ...
                },
                {
                  ...
                  static: !0,
                  key: "styles",
                  value: () => s.iv`ha-select{width:100%}`,
                },
                {
                  kind: "method",
                  key: "_changed",
    ...
    `;
            ...
            },
            {
              ...
              value: function () {
                ...
                this._unsubNotifications = (0, l.r)(
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                n.iv`:host{position:relative}.dot{pointer-events:none;position:absolute;background-color:var(--accent-color);width:12px;height:12px;top:9px;right:7px;inset-inline-end:7px;inset-inline-start:initial;border-radius:50%;border:2px solid var(--app-header-background-color)}`,
            },
          ],
        };
      },
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              key: "render",
              value: function () {
                return o.dy`<ha-textfield .invalid=${
                  this.invalid
                ...
                } .suffix=${o.dy`<div style="width:24px"></div>`} @input=${
        ...
        this._unmaskedPassword
          ...
          : "M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z"
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                o.iv`:host{display:block;position:relative}ha-textfield{width:100%}ha-icon-button{position:absolute;top:8px;right:8px;inset-inline-start:initial;inset-inline-end:8px;--mdc-icon-button-size:40px;--mdc-icon-size:20px;color:var(--secondary-text-color);direction:var(--direction)}`,
            },
          ],
        };
      },
  ...
  92824: function (e, t, i) {
    ...
    `;
            ...
            },
            {
              ...
              value: function (e) {
                if (
                  ((0, o.Z)(i, "updated", this, 3)([e]), e.has("inlineArrow"))
                ) {
  ...
  95076: function (e, t, i) {
    ...
    `
            ...
            },
            {
              ...
              key: "styles",
              value: () =>
                o.iv`:host{display:block;text-align:center}.text{direction:var(--direction);margin-left:2px;margin-inline-start:2px;margin-inline-end:initial;color:var(--secondary-text-color)}.prefix{font-weight:500}`,
            },
          ],
        };
      },
  ...
  38495: function (e, t, i) {
    ...
    const a = (e, t, i) =>
      ...
      g = (e) => e.callWS({ type: "assist_pipeline/device/list" });
  },
  73007: function (e, t, i) {
    i.d(t, { BG: () => n, Nk: () => s, n8: () => o });
    i(92745),
      i(92519),
      i(42179),
      i(89256),
      ...
      i(19814);
    var a = i(1416);
    const o = (e) => e.callWS({ type: "cloud/tts/info" }),
      n = (e) => {
        const t = [];
        if (!e) return t;
        const i = new Set();
        for (const [a] of e.languages) i.has(a) || (i.add(a), t.push(a));
        return t;
      },
      s = (e, t) => {
        const i = [];
        if (!t) return i;
        for (const [a, o] of t.languages) a === e && i.push(o);
        return i.sort((e, t) => (0, a.fe)(e, t));
      };
  },
  25433: function (e, t, i) {
    i.d(t, {
      MY: () => m,
      Yc: () => p,
      hb: () => g,
    ...
    var a = i(73358),
      ...
      s = i(85746),
      r = i(96194);
    const l = "ui.components.logbook.messages",
      d = ["counter", "proximity", "sensor", "zone"],
      c = {
      ...
      h = async (e, t, i) => u(e, t, void 0, void 0, i),
      u = (e, t, i, a, o, n) => {
        if ((a || n) && (!a || 0 === a.length) && (!n || 0 === n.length))
          return Promise.resolve([]);
        const s = { type: "logbook/get_events", start_time: t };
        return (
          i && (s.end_time = i),
          a?.length && (s.entity_ids = a),
          n?.length && (s.device_ids = n),
          o && (s.context_id = o),
          e.callWS(s)
        );
      },
      p = (e, t, i, a, o, n) => {
        if ((o || n) && (!o || 0 === o.length) && (!n || 0 === n.length))
          return Promise.reject("No entities or devices");
        const s = { type: "logbook/event_stream", start_time: i, end_time: a };
        return (
      ...
      f = (e, t) => ({
        ...
        attributes: {
          ...
          entity_picture_local: a.iY.has((0, o.M)(e.entity_id))
            ? void 0
            : e?.attributes.entity_picture_local,
          entity_picture: a.iY.has((0, o.M)(e.entity_id))
            ? void 0
      ...
      g = (e, t) => {
        for (const i of Object.keys(c)) {
          const a = c[i];
          if (t.startsWith(a))
            return t.replace(a, `${e(`ui.components.logbook.${i}`)}`);
        }
        return t;
      },
      v = (e, t, i, o, n) => {
        switch (n) {
          ...
          case "person":
            return "not_home" === i
              ...
              : "home" === i
              ? t(`${l}.was_at_home`)
              : t(`${l}.was_at_state`, { state: i });
          case "sun":
            return t("above_horizon" === i ? `${l}.rose` : `${l}.set`);
          case "binary_sensor": {
            const n = i === a.uo,
              r = i === a.lC,
              d = o.attributes.device_class;
            if (d && (n || r))
              return (
                t(
                  `${l}.${
                    n ? "detected_device_classes" : "cleared_device_classes"
                  }.${d}`,
                  {
                    device_class: (0, s.V)(
                      t(`component.binary_sensor.entity_component.${d}.name`) ||
                        d,
                      e.language,
                    ),
                  },
                ...
                t(
                  `${l}.${
                    n ? "detected_device_class" : "cleared_device_class"
                  }`,
                  {
                    device_class: (0, s.V)(
                      t(`component.binary_sensor.entity_component.${d}.name`) ||
          ...
          case "cover":
            switch (i) {
              case "open":
                return t(`${l}.was_opened`);
              case "opening":
                return t(`${l}.is_opening`);
              case "closing":
                return t(`${l}.is_closing`);
              case "closed":
                return t(`${l}.was_closed`);
            }
            break;
          case "event":
            return t(`${l}.detected_event_no_type`);
          case "lock":
            switch (i) {
              case "unlocked":
                return t(`${l}.was_unlocked`);
              case "locking":
                return t(`${l}.is_locking`);
              case "unlocking":
                return t(`${l}.is_unlocking`);
              case "opening":
                return t(`${l}.is_opening`);
              case "open":
                return t(`${l}.is_opened`);
              case "locked":
                return t(`${l}.was_locked`);
              case "jammed":
                return t(`${l}.is_jammed`);
            }
        }
        return i === a.uo
          ? t(`${l}.turned_on`)
          ...
          ? t(`${l}.became_unknown`)
          : i === r.nZ
          ? t(`${l}.became_unavailable`)
          : e.localize(`${l}.changed_to_state`, {
              state: o ? e.formatEntityState(o, i) : i,
            });
      },
      m = (e) =>
        "sensor" !== (0, n.N)(e) ||
  ...
  96950: function (e, t, i) {
    i.d(t, { H: () => a });
    const a = (e) => e.callWS({ type: "webhook/list" });
  },
  81530: function (e, t, i) {
    i.a(e, async function (e, a) {
      try {
        i.d(t, {
          Fb: () => k,
        ...
        const c = ["camera", "configurator"],
          ...
          m = ["camera", "configurator"],
          y = (e, t) => (0, o.p)(e, "history") && !m.includes((0, n.M)(t)),
          k = (e, t, i = []) => {
            if (!(0, o.p)(e, "logbook")) return !1;
            const a = e.states[t];
            if (!a) return !1;
            const s = (0, n.M)(t);
            return !(
              (r.jV.includes(s) && (0, l.zP)(s, a, void 0, i)) ||
              m.includes(s)
            );
          },
          b = (e) => {
            const t = (0, n.M)(e.entity_id);
            if ("group" === t) {
              const t = (0, s.W)(e);
              return null != t && "group" !== t && p.includes(t);
            }
            return p.includes(t);
          };
        a();
  ...
  88991: function (e, t, i) {
    i.a(e, async function (e, a) {
      try {
        ...
        const r = {
            alarm_control_panel: () => i.e("62410").then(i.bind(i, 80875)),
            automation: () => i.e("98368").then(i.bind(i, 13592)),
            camera: () => i.e("11569").then(i.bind(i, 17712)),
            climate: () =>
              Promise.all([i.e("41258"), i.e("21728")]).then(i.bind(i, 5192)),
            configurator: () =>
              Promise.all([i.e("46379"), i.e("2981"), i.e("16649")]).then(
                i.bind(i, 10080),
              ),
            conversation: () =>
              Promise.all([i.e("46379"), i.e("51229"), i.e("59176")]).then(
                i.bind(i, 93726),
              ),
            counter: () => i.e("25510").then(i.bind(i, 32441)),
            cover: () => i.e("78402").then(i.bind(i, 72869)),
            date: () =>
              Promise.all([
                i.e("46379"),
                i.e("41258"),
            ...
            fan: () => i.e("88973").then(i.bind(i, 54764)),
            group: () =>
              Promise.all([
                i.e("46379"),
                i.e("41258"),
            ...
            humidifier: () => i.e("66881").then(i.bind(i, 9198)),
            image: () => i.e("89870").then(i.bind(i, 37093)),
            input_boolean: () => i.e("64783").then(i.bind(i, 85742)),
            input_datetime: () =>
              Promise.all([
                i.e("46379"),
                i.e("41258"),
            ...
            lawn_mower: () => i.e("49").then(i.bind(i, 31650)),
            light: () => i.e("55815").then(i.bind(i, 59031)),
            lock: () => i.e("51539").then(i.bind(i, 1563)),
            media_player: () =>
              Promise.all([i.e("41258"), i.e("8656")]).then(i.bind(i, 99091)),
            person: () =>
              Promise.all([i.e("35637"), i.e("49554"), i.e("73565")]).then(
                i.bind(i, 86554),
              ),
            remote: () =>
              Promise.all([i.e("41258"), i.e("2600")]).then(i.bind(i, 92081)),
            script: () =>
              Promise.all([
                i.e("46379"),
                i.e("24199"),
            ...
            siren: () => i.e("34404").then(i.bind(i, 86534)),
            sun: () => i.e("8373").then(i.bind(i, 55421)),
            switch: () => i.e("50728").then(i.bind(i, 56985)),
            time: () =>
              Promise.all([
                i.e("46379"),
                i.e("41258"),
            ...
            timer: () => i.e("14597").then(i.bind(i, 42971)),
            update: () =>
              Promise.all([
                i.e("5080"),
                i.e("2981"),
            ...
            vacuum: () =>
              Promise.all([i.e("41258"), i.e("29453")]).then(i.bind(i, 61372)),
            valve: () => i.e("60455").then(i.bind(i, 20973)),
            water_heater: () => i.e("80518").then(i.bind(i, 60054)),
            weather: () =>
              Promise.all([i.e("99287"), i.e("15722"), i.e("85078")]).then(
                i.bind(i, 95818),
              ),
          },
          l = (e) => {
          ...
          d = (e) =>
            n.l.includes(e) ? e : n.tm.includes(e) ? "hidden" : "default",
          c = (e) => {
            e in r && r[e]();
          };
        a();
    ...
    i.a(e, async function (e, t) {
      try {
        var a = i(44249),
          ...
          r = i(36522),
          l = i(22381),
          d = (i(99426), i(34273), i(54977), i(7285), i(95076), i(94616)),
          c = i(76131),
          h = (i(87979), i(6736)),
          u = i(28008),
          p = (i(98241), i(14886), i(77229)),
          f = i(90044),
          g = i(83037),
          v = i(81182),
          m = e([p, f, g, s]);
        [p, f, g, s] = m.then ? (await m)() : m;
        const y =
          ...
          b = "M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z";
        (0, a.Z)(
          [(0, n.Mo)("cloud-account")],
          function (e, t) {
            return {
              F: class extends t {
                constructor(...t) {
              ...
              d: [
                ...
                },
                {
                  kind: "field",
                  decorators: [
                    (0, n.Cb)({ attribute: "is-wide", type: Boolean }),
                  ],
                  key: "isWide",
                  value: () => !1,
                },
      ...
      <hass-subpage .hass=${this.hass} .narrow=${
        ...
        <div class="content">
          <ha-config-section .isWide=${this.isWide}>
            <span slot="header">ASCIA Cloud</span>
            ...
            <ha-card outlined .header=${this.hass.localize(
                      ...
                      this._subscription
                        ? this._subscription.human_description.replace(
                            ...
                            this._subscription.plan_renewal_date
                              ? (0, s.o0)(
                                  new Date(
                                    1e3 * this._subscription.plan_renewal_date,
                                  ),
                                  this.hass.locale,
                                  this.hass.config,
                                )
              ...
              ${
                "connecting" === this.cloudStatus.cloud &&
                this.cloudStatus.cloud_last_disconnect_reason
                  ? o.dy`
                    <ha-alert alert-type="warning" .title=${this.cloudStatus.cloud_last_disconnect_reason.reason}></ha-alert>
                  `
                  : ""
              }
                ...
                <ha-list-item noninteractive>
                  ...
                  ${
                    "connected" === this.cloudStatus.cloud
                      ...
                      : "disconnected" === this.cloudStatus.cloud
                      ? this.hass.localize(
              ...
              <div class="card-actions">
                <a href="https://account.nabucasa.com" target="_blank" rel="noreferrer">
                  <mwc-button>
                    ${this.hass.localize(
          ...
          <ha-config-section .isWide=${this.isWide}>
            ...
            <cloud-remote-pref .hass=${this.hass} .narrow=${
              this.narrow
            } .cloudStatus=${this.cloudStatus}></cloud-remote-pref>

            <cloud-tts-pref .hass=${this.hass} .cloudStatus=${
              this.cloudStatus
            }></cloud-tts-pref>

            <cloud-ice-servers-pref .hass=${this.hass} .cloudStatus=${
              this.cloudStatus
            ...
            <cloud-webhooks .hass=${this.hass} .narrow=${
              this.narrow
            } .cloudStatus=${this.cloudStatus}></cloud-webhooks>
          </ha-config-section>
        </div>
      </hass-subpage>
    `;
                    ...
                    const e = (0, l.D)(
                      () => {
                        this.cloudStatus &&
                          ...
                          (0, r.B)(this, "ha-refresh-cloud-status");
                      },
                      1e4,
                      !0,
                    );
                ...
                },
                {
                  ...
                  value: async function () {
                    (this._subscription = await (0, d.De)(this.hass)),
                ...
                },
                {
                  ...
                  key: "_signOut",
                  value: async function () {
                    (0, c.showConfirmationDialog)(this, {
                    ...
                    if (
                      await (0, c.showConfirmationDialog)(this, {
                        ...
                        confirmText: this.hass.localize(
                          "ui.panel.config.cloud.account.reset",
                        ),
                        destructive: !0,
                      })
                    )
                      try {
                        await (0, d.VU)(this.hass), await (0, d.dV)(this.hass);
                      } catch (e) {
                        return void (0, c.showAlertDialog)(this, {
                          title: this.hass.localize(
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      u.Qx,
                      o.iv`[slot=introduction]{margin:-1em 0}[slot=introduction] a{color:var(--primary-color)}.content{padding-bottom:24px}.account-row{display:flex;padding:0 16px}.card-actions{display:flex;flex-direction:row-reverse;justify-content:space-between}mwc-button{align-self:center}.wrap{white-space:normal}.status{text-transform:capitalize;padding:16px}`,
                    ];
                  },
                },
              ],
  ...
  14886: function (e, t, i) {
    var a = i(44249),
      o = i(57243),
      n = i(15093),
      s = i(36522),
      r = (i(54977), i(23334), i(1888), i(94616)),
      l = i(72473);
    (0, a.Z)(
      [(0, n.Mo)("cloud-ice-servers-pref")],
      function (e, t) {
        return {
          F: class extends t {
            constructor(...t) {
          ...
          d: [
            ...
            },
            {
              ...
              key: "render",
              value: function () {
                if (!this.cloudStatus) return o.Ld;
                const { cloud_ice_servers_enabled: e } = this.cloudStatus.prefs;
                return o.dy`
      <ha-card outlined header=${this.hass.localize(
        "ui.panel.config.cloud.account.ice_servers.title",
      )}>
        <div class="header-actions">
          <a href="https://www.nabucasa.com/config/webrtc/" target="_blank" rel="noreferrer" class="icon-link">
            <ha-icon-button .label=${this.hass.localize(
          ...
          <ha-switch .checked=${e} @change=${
            this._toggleCloudICEServersEnabledChanged
          }></ha-switch>
        </div>
    ...
    `;
            ...
            {
              kind: "method",
              key: "_toggleCloudICEServersEnabledChanged",
              value: async function (e) {
                const t = e.target;
                try {
                  await (0, r.LV)(this.hass, {
                    cloud_ice_servers_enabled: t.checked,
                  }),
                    (0, s.B)(this, "ha-refresh-cloud-status");
                } catch (e) {
                  (0, l.C)(this, { message: e.message }),
                    (t.checked = !t.checked);
                }
              },
            },
              ...
              d: [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    const {
                        remote_enabled: e,
                        remote_allow_remote_enable: t,
                        strict_connection: i,
                      } = this.cloudStatus.prefs,
                      {
                        remote_connected: a,
                        remote_domain: n,
                        remote_certificate: s,
                        remote_certificate_status: l,
                      } = this.cloudStatus;
                    return s && "ready" === l
                      ? o.dy`
      <ha-card outlined header=${this.hass.localize(
        ...
        <div class="header-actions">
          <a href="https://www.nabucasa.com/config/remote/" target="_blank" rel="noreferrer" class="icon-link">
            <ha-icon-button .label=${this.hass.localize(
              "ui.panel.config.cloud.account.remote.link_learn_how_it_works",
            )} .path=${p}></ha-icon-button>
          </a>
          <ha-switch .checked=${e} @change=${this._toggleChanged}></ha-switch>
        </div>
        ...
        <div class="card-content">
          ${
            !a && e
              ? o.dy`
                <ha-alert .title=${this.hass.localize(
                  "ui.panel.config.cloud.account.remote.reconnecting",
                )}></ha-alert>
              `
              : "drop_connection" === i
              ? o.dy`<ha-alert alert-type="warning" .title=${this.hass.localize(
          ...
          <ha-copy-textfield .hass=${
            this.hass
          } .value=${`https://${n}`} .maskedValue=${(0, h.t)(
            `https://${n}`,
          )} .label=${this.hass.localize(
            "ui.panel.config.common.copy_link",
          )}></ha-copy-textfield>

          <ha-expansion-panel outlined .header=${this.hass.localize(
            ...
            <ha-settings-row wrap-heading>
              ...
              <ha-switch .checked=${t} @change=${
                this._toggleAllowRemoteEnabledChanged
              }></ha-switch>
            </ha-settings-row>
            <hr/>
      ...
      `;
                ...
                },
                {
                  ...
                  value: async function (e) {
                    ...
                    try {
                      t.checked
                        ? await (0, l.dn)(this.hass)
                        : await (0, l.H9)(this.hass),
                        (0, s.B)(this, "ha-refresh-cloud-status");
                    } catch (e) {
                      (0, d.C)(this, { message: e.message }),
                        (t.checked = !t.checked);
                    }
                  },
                },
                {
                  kind: "method",
                  key: "_toggleAllowRemoteEnabledChanged",
                  value: async function (e) {
                    const t = e.target;
                    try {
                      await (0, l.LV)(this.hass, {
                        remote_allow_remote_enable: t.checked,
                      }),
                        (0, s.B)(this, "ha-refresh-cloud-status");
                    } catch (e) {
                      (0, d.C)(this, { message: e.message }),
                ...
                },
                {
                  ...
                  key: "styles",
                  value: () =>
                    o.iv`.connection-status,.header-actions{position:absolute;top:24px;inset-inline-start:initial}.preparing{padding:0 16px 16px}a{color:var(--primary-color)}.header-actions{right:16px;inset-inline-end:16px;display:flex;flex-direction:row}.header-actions .icon-link{margin-top:-16px;margin-right:8px;margin-inline-end:8px;margin-inline-start:initial;direction:var(--direction);color:var(--secondary-text-color)}.warning{font-weight:700;margin-bottom:1em}.break-word{overflow-wrap:break-word}.connection-status{right:24px;inset-inline-end:24px}.card-actions{display:flex}.card-actions a{text-decoration:none}ha-expansion-panel{margin-top:16px;--expansion-panel-content-padding:0 16px;--expansion-panel-summary-padding:0 16px}ha-settings-row{padding:0;border-top:none!important}ha-alert{display:block;margin-bottom:16px}hr{border:none;height:1px;background-color:var(--divider-color);margin:8px 0}`,
                },
              ],
            };
          },
  ...
  90044: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        var a = i(44249),
          o = i(72621),
          n = (i(9359), i(1331), i(70104), i(31622), i(87319), i(57243)),
          s = i(15093),
          r = i(27486),
          l = i(36522),
          d = (i(54977), i(92824), i(37583), i(1888), i(2790)),
          c = i(94616),
          h = i(73007),
          u = i(76131),
          p = i(98829),
            ...
            return {
              ...
              d: [
                ...
                },
                {
                  ...
                  key: "render",
                  value: function () {
                    if (!this.cloudStatus || !this.ttsInfo) return n.Ld;
                    const e = this.getLanguages(this.ttsInfo),
                      t = this.cloudStatus.prefs.tts_default_voice,
                      i = this.getSupportedVoices(t[0], this.ttsInfo);
                    return n.dy`
      <ha-card outlined header=${this.hass.localize(
        ...
        <div class="card-content">
          ...
          <br/><br/>
          <div class="row">
            <ha-language-picker .hass=${this.hass} .label=${this.hass.localize(
              "ui.panel.config.cloud.account.tts.default_language",
            )} .disabled=${this.savingPreferences} .value=${
              t[0]
            } .languages=${e} @value-changed=${this._handleLanguageChange}>
            </ha-language-picker>

            <ha-select .label=${this.hass.localize(
              "ui.panel.config.cloud.account.tts.default_voice",
            )} .disabled=${this.savingPreferences} .value=${t[1]} @selected=${
              this._handleVoiceChange
            }>
              ${i.map(
                (e) => n.dy`<mwc-list-item .value=${e}>${e}</mwc-list-item>`,
              )}
            </ha-select>
          </div>
        </div>
    ...
    `;
                  ...
                  value: function (e) {
                    e.has("cloudStatus") &&
                      this.cloudStatus?.prefs.tts_default_voice?.[0] !==
                        e.get("cloudStatus")?.prefs.tts_default_voice?.[0] &&
                      this.renderRoot
                        .querySelector("ha-select")
                        ?.layoutOptions();
                  },
                },
                {
                  ...
                  value: function (e) {
                    (0, o.Z)(i, "willUpdate", this, 3)([e]),
                      this.hasUpdated ||
                        (0, h.n8)(this.hass).then((e) => {
                          this.ttsInfo = e;
                        }),
                      e.has("cloudStatus") && (this.savingPreferences = !1);
                  },
                },
                {
                  kind: "field",
                ...
                },
                {
                  ...
                  value: async function (e) {
                    if (
                      ...
                      return;
                    this.savingPreferences = !0;
                    const t = e.detail.value,
                      i = this.cloudStatus.prefs.tts_default_voice[1],
                      a = this.getSupportedVoices(t, this.ttsInfo),
                      o = a.find((e) => e === i) ? i : a[0];
                    try {
                      await (0, c.LV)(this.hass, { tts_default_voice: [t, o] }),
                        (0, l.B)(this, "ha-refresh-cloud-status");
                    } catch (e) {
                      (this.savingPreferences = !1),
                        console.error(e),
                        (0, u.showAlertDialog)(this, {
                          text: `Unable to save default language. ${e}`,
                          warning: !0,
                        });
                    }
                  },
                ...
                {
                  kind: "method",
                  key: "_handleVoiceChange",
                  value: async function (e) {
                    if (
                      e.target.value ===
                      this.cloudStatus.prefs.tts_default_voice[1]
                    )
                      return;
                    this.savingPreferences = !0;
                    const t = this.cloudStatus.prefs.tts_default_voice[0],
                      i = e.target.value;
                    try {
                      await (0, c.LV)(this.hass, { tts_default_voice: [t, i] }),
                        (0, l.B)(this, "ha-refresh-cloud-status");
                    } catch (e) {
                      (this.savingPreferences = !1),
                        console.error(e),
                        (0, u.showAlertDialog)(this, {
                          text: `Unable to save default voice. ${e}`,
                          warning: !0,
                        });
                    }
                  },
                },
                {
                  ...
                  key: "styles",
                  value: () =>
                    n.iv`a{color:var(--primary-color)}.example{position:absolute;right:16px;inset-inline-end:16px;inset-inline-start:initial;top:16px}.row{display:flex}.row>*{flex:1;width:0}.row>:first-child{margin-right:8px;margin-inline-end:8px;margin-inline-start:initial}.row>:last-child{margin-left:8px;margin-inline-start:8px;margin-inline-end:initial}.card-actions{display:flex;flex-direction:row-reverse}`,
                },
              ],
            };
          },
    ...
    i.a(e, async function (e, t) {
      try {
        var a = i(44249),
          ...
          r = i(72344),
          l = (i(54977), i(17170)),
          d = (i(30509), i(1888), i(94616)),
          c = i(96950),
          h = i(28008),
          u = i(2141),
          p = e([l]);
        l = (p.then ? (await p)() : p)[0];
        (0, a.Z)(
          [(0, s.Mo)("cloud-webhooks")],
          function (e, t) {
            class i extends t {
              constructor(...t) {
                super(...t), e(this);
      ...
      <ha-card outlined header=${this.hass.localize(
        ...
        <div class="card-content">
              ...
              ? 0 === this._localHooks.length
                ? n.dy`
                  <div class="body-text">
                    ...
                    <a href="/config/integrations">${this.hass.localize(
                    ...
                    <a href="/config/automation/edit/new">${this.hass.localize(
                      ...
                      ${
                        this._progress.includes(e.webhook_id)
                          ...
                          ? n.dy`
                            ...
                            `
                          : n.dy`<ha-switch @click=${this._enableWebhook}>
                            </ha-switch>`
                      }
                    </ha-settings-row>
                  `,
          ...
          <div class="footer">
            <a href="https://www.nabucasa.com/config/webhooks" target="_blank" rel="noreferrer">
              ${this.hass.localize(
    ...
    `;
                ...
                },
                {
                  ...
                  value: async function (e) {
                    ...
                    try {
                      i = await (0, d.AV)(this.hass, t.webhook_id);
                    } catch (e) {
                ...
                },
                {
                  ...
                  key: "_fetchData",
                  value: async function () {
                    if (!(0, r.p)(this.hass, "webhook"))
                      return void (this._localHooks = []);
                    const e = await (0, c.H)(this.hass);
                    this._localHooks = e.filter(
                      (e) =>
                        !e.local_only &&
                        ("mobile_app" !== e.domain ||
                          "Deleted Webhook" !== e.name),
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    return [
                      h.Qx,
                      n.iv`.body-text{padding:8px 0}.webhook{display:flex;padding:4px 0}.progress{margin-right:16px;margin-inline-end:16px;margin-inline-start:initial;display:flex;flex-direction:column;justify-content:center}.footer{padding-top:16px}.body-text a,.footer a{color:var(--primary-color)}ha-settings-row{padding:0}`,
                    ];
                  },
                },
              ],
  ...
  81182: function (e, t, i) {
    i.d(t, { k: () => n });
    var a = i(36522);
    const o = () =>
        Promise.all([i.e("7442"), i.e("2981"), i.e("69353")]).then(
          i.bind(i, 64028),
        ),
      n = (e) => {
        (0, a.B)(e, "show-dialog", {
  ...
  98829: function (e, t, i) {
    i.d(t, { k: () => n });
    var a = i(36522);
    const o = () => i.e("44727").then(i.bind(i, 88529)),
      n = (e, t) => {
        (0, a.B)(e, "show-dialog", {
  ...
  30894: function (e, t, i) {
    i.d(t, { G: () => o });
    var a = i(36522);
    const o = (e, t) => {
      (0, a.B)(e, "show-dialog", {
        dialogTag: "dialog-cloud-certificate",
        dialogImport: () => i.e("87050").then(i.bind(i, 51119)),
        dialogParams: t,
      });
    };
  },
  2141: function (e, t, i) {
    ...
    const o = (e, t) => {
      (0, a.B)(e, "show-dialog", {
        ...
        dialogImport: () => i.e("25643").then(i.bind(i, 92213)),
        dialogParams: t,
      });
    };
  },
  34480: function (e, t, i) {
    i.a(e, async function (e, a) {
      try {
        i.r(t);
        var o = i(44249),
          ...
          c = i(19688),
          h = e([d, c]);
        [d, c] = h.then ? (await h)() : h;
        const u = ["account", "google-assistant", "alexa"],
          p = ["login", "register", "forgot-password"];
        (0, o.Z)(
          [(0, s.Mo)("ha-config-cloud")],
          function (e, t) {
            class a extends t {
              constructor(...t) {
                super(...t), e(this);
                    ...
                    return {
                      ...
                      beforeRender: (e) => {
                        if (this.cloudStatus.logged_in) {
                          if (!u.includes(e)) return "account";
                        } else if (!p.includes(e)) return "login";
                      },
                      routes: {
                        login: { tag: "cloud-login-panel" },
                        register: {
                          tag: "cloud-register",
                          load: () => i.e("13027").then(i.bind(i, 81698)),
                        },
                        "forgot-password": {
                          tag: "cloud-forgot-password",
                          load: () => i.e("58705").then(i.bind(i, 10685)),
                        },
                    ...
                    if (
                      ...
                      void 0 === t
                        ...
                        : t.logged_in !== this.cloudStatus.logged_in &&
                          (0, r.c)(this.route.prefix, { replace: !0 });
                    }
                  },
                },
                {
                  ...
                  key: "createElement",
                  value: function (e) {
                    const t = (0, n.Z)(a, "createElement", this, 3)([e]);
                    return (
                      t.addEventListener("cloud-email-changed", (e) => {
  ...
  19688: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        var a = i(44249),
          ...
          s = i(36522),
          r = i(83523),
          l = (i(99426), i(54977), i(13928), i(7285), i(34273), i(94616)),
          d = i(76131),
          c = (i(87979), i(28008)),
          h = (i(98241), i(16798)),
          u = i(81182),
          p = e([h]);
        h = (p.then ? (await p)() : p)[0];
        const f =
            "M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19M8.46,11.88L9.87,10.47L12,12.59L14.12,10.47L15.53,11.88L13.41,14L15.53,16.12L14.12,17.53L12,15.41L9.88,17.53L8.47,16.12L10.59,14L8.46,11.88M15.5,4L14.5,3H9.5L8.5,4H5V6H19V4H15.5Z",
          g =
            "M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z",
          ...
          function (e, t) {
            return {
              ...
              d: [
                ...
                {
                  kind: "field",
                  decorators: [(0, n.IO)("cloud-login")],
                  key: "_cloudLoginElement",
                  value: void 0,
                },
                {
                  kind: "method",
          ...
          <ha-config-section .isWide=${this.isWide}>
            ...
            <div slot="introduction">
              ...
              <p>
                ...
                <a href="https://www.nabucasa.com" target="_blank" rel="noreferrer">
                  Nabu Casa, Inc</a>${this.hass.localize(
            ...
            ${
              this.flashMessage
                ? o.dy`<ha-alert dismissable @alert-dismissed-clicked=${this._dismissFlash}>
                  ${this.flashMessage}
                </ha-alert>`
                : ""
            }

            <cloud-login .hass=${this.hass} .email=${this.email} .localize=${
              this.hass.localize
            } @cloud-forgot-password=${
              this._handleForgotPassword
            } check-connection></cloud-login>
    ...
    `;
                ...
                },
                {
                  ...
                  value: function () {
                    this._dismissFlash(),
                      (0, s.B)(this, "cloud-email-changed", {
                ...
                },
                {
                  ...
                  key: "_dismissFlash",
                  value: function () {
                    (0, s.B)(this, "flash-message-changed", { value: "" });
                  },
                },
                {
                  kind: "method",
                ...
                },
                {
                  ...
                  value: async function () {
                    if (
                      ...
                      try {
                        await (0, l.dV)(this.hass);
                      } catch (e) {
                        return void (0, d.showAlertDialog)(this, {
                          title: this.hass.localize(
                            "ui.panel.config.cloud.account.reset_data_failed",
                          ),
                          text: e?.message,
                ...
                },
                {
                  ...
                  value: function () {
                    return [
                      c.Qx,
                      o.iv`.content{padding-bottom:24px}[slot=introduction]{margin:-1em 0}[slot=introduction] a{color:var(--primary-color)}ha-card{overflow:hidden}ha-card .card-header{margin-bottom:-8px}h1{margin:0}`,
                    ];
                  },
                },
              ],
  ...
  16798: function (e, t, i) {
    i.a(e, async function (e, t) {
      try {
        var a = i(44249),
          ...
          s = i(36522),
          r = i(29095),
          l = (i(99426), i(54977), i(59826), i(34326), i(83166), i(28008)),
          d = i(94616),
          c = i(12660),
          h = i(38495),
          u = i(47873),
            ...
            return {
              ...
              d: [
                ...
                },
                {
                  kind: "field",
                  decorators: [
                    (0, n.Cb)({ type: Boolean, attribute: "check-connection" }),
                  ],
                  key: "checkConnection",
                  value: () => !1,
                },
                ...
                },
                {
                  kind: "field",
                  decorators: [
                    (0, n.Cb)({ attribute: "translation-key-panel" }),
                  ],
                ...
                },
                {
                  kind: "field",
                  decorators: [
                    (0, n.Cb)({ type: Boolean, attribute: "card-less" }),
                  ],
                  key: "cardLess",
                  value: () => !1,
                },
                ...
                },
                {
                  ...
                  value: function () {
                    return this.cardLess
                      ...
                      : o.dy`
      <ha-card outlined .header=${this.localize(
    ...
    `;
      ...
      <div class="card-content login-form">
        ...
        <ha-textfield .label=${this.localize(
          `ui.panel.${this.translationKeyPanel}.login.email`,
        )} id="email" name="username" type="email" autocomplete="username" required .value=${
          this.email ?? ""
        } @keydown=${this._keyDown} .disabled=${
          this._inProgress
        } .validationMessage=${this.localize(
          `ui.panel.${this.translationKeyPanel}.login.email_error_msg`,
        )}></ha-textfield>
        <ha-password-field id="password" name="password" .label=${this.localize(
          `ui.panel.${this.translationKeyPanel}.login.password`,
        )} autocomplete="current-password" required minlength="8" @keydown=${
          this._keyDown
        } .disabled=${this._inProgress} .validationMessage=${this.localize(
          `ui.panel.${this.translationKeyPanel}.login.password_error_msg`,
        )}></ha-password-field>
      </div>
      <div class="card-actions">
        <ha-button .disabled=${this._inProgress} @click=${
          this._handleForgotPassword
        }>
          ${this.localize(
        ...
        <ha-progress-button unelevated @click=${this._handleLogin} .progress=${
          this._inProgress
        }>${this.localize(
          `ui.panel.${this.translationKeyPanel}.login.sign_in`,
        )}</ha-progress-button>
    ...
    `;
                ...
                {
                  kind: "field",
                  key: "_handleCloudLoginError",
                  value() {
                    return async (e, t, i, a) => {
                      const o = e && e.body && e.body.code;
                      if ("mfarequired" === o) {
                        ...
                        if (null !== e && "" !== e)
                          return void this._login(t, i, a, e);
                      }
                      if ("alreadyconnectederror" === o) {
                        const a = await (0, u.F)(this, {
                          details: JSON.parse(e.body.message),
                        });
                        return (
                          a && this._login(t, i, !1), a ? void 0 : "cancel"
                        );
                      }
                      if ("PasswordChangeRequired" === o)
                        return (
                      ...
                      if ("usernotfound" !== o || t === t.toLowerCase())
                        switch (o) {
                      ...
                      else this._login(t.toLowerCase(), i, a);
                    };
                  },
                },
                {
                      ...
                      try {
                        if (this.hass) {
                          ...
                          o.cloud_pipeline &&
                            ...
                            (0, h.GV)(this.hass, o.cloud_pipeline);
                        } else
                          await (0, p.ao)({
                            email: e,
                            ...(a ? { code: a } : { password: t }),
                        ...
                        const o = await this._handleCloudLoginError(a, e, t, i);
                        if ("cancel" === o)
                          return (
                            (this._inProgress = !1),
                            (this.email = ""),
                            void (this._passwordField.value = "")
                          );
                        if ("password-change" === o)
                          return void this._handleForgotPassword();
                        (this._inProgress = !1), (this._error = o);
                      }
                    };
                  },
                },
                  ...
                  value: async function () {
                    if (!this._inProgress) {
                      if (!this.emailField.reportValidity())
                        return void this.emailField.focus();
                      if (!this._passwordField.reportValidity())
                        return void this._passwordField.focus();
                      (this._inProgress = !0),
                        this._login(
                ...
                },
                {
                  ...
                  key: "_handleForgotPassword",
                  value: function () {
                    (0, s.B)(this, "cloud-forgot-password");
                  },
                },
                {
                  kind: "get",
                  ...
                  value: function () {
                    return [
                      l.Qx,
                      o.iv`ha-card{overflow:hidden}ha-card .card-header{margin-bottom:-8px}.card-actions{display:flex;justify-content:space-between;align-items:center}.login-form{display:flex;flex-direction:column}`,
                    ];
                  },
                },
              ],
  ...
  98241: function (e, t, i) {
    var a = i(44249),
      o = i(57243),
      n = i(15093),
      s = i(35359);
    (0, a.Z)(
      [(0, n.Mo)("ha-config-section")],
      function (e, t) {
        return {
          F: class extends t {
            constructor(...t) {
          ...
          d: [
            {
              kind: "field",
              decorators: [(0, n.Cb)({ attribute: "is-wide", type: Boolean })],
              key: "isWide",
              value: () => !1,
            },
            {
            ...
            },
            {
              kind: "field",
              decorators: [
                (0, n.Cb)({ type: Boolean, attribute: "full-width" }),
              ],
              key: "fullWidth",
              value: () => !1,
            },
            {
              ...
              value: function () {
                return o.dy`
      <div class="content ${(0, s.$)({
        narrow: !this.isWide,
        "full-width": this.fullWidth,
      })}">
        <div class="header"><slot name="header"></slot></div>
        <div class="together layout ${(0, s.$)({
          narrow: !this.isWide,
    ...
    i.a(e, async function (e, a) {
      try {
        ...
        const h = new Set([
          ...
          u = (e) => (
            "action-button" === e.type &&
              (e = { ...e, type: "service-button" }),
            (0, d.Tw)("element", e, h)
          );
        a();
      } catch (e) {
      ...
      try {
        i.r(t),
          i.d(t, {
            ...
            createCardElement: () => l.Z6,
            createHeaderFooterElement: () => d.t,
  ...
  28008: function (e, t, i) {
    ...
    const o = a.iv`button.link{background:0 0;color:inherit;border:none;padding:0;font:inherit;text-align:left;text-decoration:underline;cursor:pointer;outline:0}`,
      ...
      r = a.iv`.ha-scrollbar::-webkit-scrollbar{width:.4rem;height:.4rem}.ha-scrollbar::-webkit-scrollbar-thumb{-webkit-border-radius:4px;border-radius:4px;background:var(--scrollbar-thumb-color)}.ha-scrollbar{overflow-y:auto;scrollbar-color:var(--scrollbar-thumb-color) transparent;scrollbar-width:thin}`;
    a.iv`body{background-color:var(--primary-background-color);color:var(--primary-text-color);height:calc(100vh - 32px);width:100vw}`;
  },
  11225: function (e, t, i) {
    function a(e) {
...
//# sourceMappingURL=14824.447d0669391cf1d6.js.map
