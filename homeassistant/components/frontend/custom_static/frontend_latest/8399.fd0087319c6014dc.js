export const __webpack_ids__ = ["8399"];
export const __webpack_modules__ = {
          ...
          constructor() {
            super(),
              ...
              "function" != typeof HTMLDialogElement &&
                ...
                d || (d = i.e("73854").then(i.bind(i, 85893)))),
  ...
  12627: function (e, t, i) {
    ...
    var o = i(44249),
      ...
      r = i(22337),
      l =
        (i(99426), i(51784), i(59826), i(95198), i(36439), i(99254), i(25482)),
      d = i(28008);
    (0, o.Z)(
          ...
          d: [
            ...
            },
            {
              ...
              value: function () {
                ...
                const e =
                    this._issue.learn_more_url?.startsWith(
                      "homeassistant://",
                    ) || !1,
                  t =
                    this.hass.localize(
                ...
                return n.dy`
      <ha-md-dialog open @closed=${
        this._dialogClosed
      } aria-labelledby="dialog-repairs-issue-title" aria-describedby="dialog-repairs-issue-description">
        <ha-dialog-header slot="headline">
          <ha-icon-button slot="navigationIcon" .label=${
          ...
          <span slot="title" id="dialog-repairs-issue-title" .title=${t}>${t}</span>
          <dialog-repairs-issue-subtitle slot="subtitle" .hass=${
            this.hass
          } .issue=${this._issue}></dialog-repairs-issue-subtitle>
        </ha-dialog-header>
        <div slot="content" class="dialog-content">
          ...
          <ha-markdown id="dialog-repairs-issue-description" allow-svg breaks @click=${
            this._clickHandler
          } .content=${
            this.hass.localize(
              `component.${this._issue.domain}.issues.${
            ...
            this._issue.learn_more_url
              ? n.dy`
                <a rel="noopener noreferrer" href=${
                  ...
                  <ha-button @click=${e ? this.closeDialog : void 0}>
                    ${this.hass.localize(
    ...
    `;
            ...
            },
            {
              ...
              value: () => [
                d.yu,
                n.iv`.dialog-content{padding-top:0}ha-alert{margin-bottom:16px;display:block}.dismissed{font-style:italic}`,
              ],
            },
          ],
        };
...
//# sourceMappingURL=8399.fd0087319c6014dc.js.map
