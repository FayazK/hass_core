export const __webpack_ids__ = ["9281"];
export const __webpack_modules__ = {
  23437: function (i, e, a) {
    a.r(e), a.d(e, { HuiDialogEditSection: () => m });
    var t = a(44249),
      o = a(57243),
      n = a(15093),
      s = a(35359),
            ...
            },
            {
              ...
              value: () =>
                (0, r.Z)((i) => [
                  {
                    name: "column_span",
                    selector: { number: { min: 1, max: i, slider_ticks: !0 } },
                  },
                ]),
            },
            {
            ...
            },
            {
              ...
              value: function (i) {
                ...
                const e = i.detail.value,
                  a = { ...this.config, column_span: e.column_span };
    ...
    (0, t.Z)(
        ...
        return {
          ...
          d: [
            ...
            },
            {
              ...
              key: "render",
              value: function () {
                const i = this.config.visibility ?? [];
                return o.dy`
      ...
      <ha-card-conditions-editor .hass=${
        this.hass
      } .conditions=${i} @value-changed=${this._valueChanged}>
    ...
    `;
            ...
            },
            {
              ...
              value: function (i) {
                i.stopPropagation();
                const e = i.detail.value,
                  a = { ...this.config, visibility: e };
                0 === a.visibility?.length && delete a.visibility,
                  (0, l.B)(this, "value-changed", { value: a });
              },
            },
          ],
    ...
    a(56820), a(99619);
    const u = ["tab-settings", "tab-visibility"];
    let m = (0, t.Z)(
      ...
      <ha-dialog open scrimClickAction @keydown=${
        this._ignoreKeydown
      } @closed=${this._cancel} .heading=${i} class=${(0, s.$)({
        ...
        <ha-dialog-header show-border slot="heading">
          ...
          <ha-button-menu slot="actionItems" fixed corner="BOTTOM_END" menu-corner="END" @closed=${
            d.U
          ...
          ${
            this._yamlMode
              ? o.Ld
              : o.dy`
                <mwc-tab-bar .activeIndex=${u.indexOf(
                  this._currTab,
    ...
    `;
            ...
            },
            {
              ...
              value: function () {
                return [
                  c.yu,
                  o.iv`ha-dialog{--vertical-align-dialog:flex-start;--dialog-surface-margin-top:40px}@media all and (max-width:450px),all and (max-height:500px){ha-dialog{--dialog-surface-margin-top:0px}}ha-dialog.yaml-mode{--dialog-content-padding:0}mwc-tab-bar{color:var(--primary-text-color);text-transform:uppercase;padding:0 20px}@media all and (min-width:600px){ha-dialog{--mdc-dialog-min-width:600px}}`,
                ];
              },
            },
          ],
