export const __webpack_ids__ = ["32294"];
export const __webpack_modules__ = {
  ...
  69497: function (e, t, i) {
    ...
    const a = (e) => e.callWS({ type: "person/list" }),
      n = (e, t) => e.callWS({ type: "person/create", ...t }),
      o = (e, t, i) => e.callWS({ type: "person/update", person_id: t, ...i }),
  ...
  4242: function (e, t, i) {
    ...
    const a = "system-admin",
      ...
      d = async (e, t) => e.callWS({ type: "config/auth/delete", user_id: t }),
      l = (e) =>
        e
          ? e
              .trim()
  ...
  75375: function (e, t, i) {
    i.a(e, async function (e, a) {
      ...
      <div class="content">
        ...
        ${
          this.message
            ? o.dy`<div id="loading-text">${this.message}</div>`
            : o.Ld
        }
      </div>
    `;
      ...
      function (e, t) {
        return {
          ...
          d: [
            {
              kind: "field",
              decorators: [(0, o.Cb)({ attribute: "is-wide", type: Boolean })],
              key: "isWide",
              value: () => !1,
            },
            {
  ...
  76429: function (e, t, i) {
    i.a(e, async function (e, a) {
      ...
      <hass-tabs-subpage .hass=${this.hass} .narrow=${this.narrow} .route=${
        this.route
      } back-path="/config" .tabs=${f.configSections.persons}>
        <ha-config-section .isWide=${this.isWide}>
          <span slot="header">${e.localize(
            "ui.panel.config.person.caption",
          )}</span>
          ...
          <ha-card outlined class="storage">
            <mwc-list>
              ${this._storageItems.map(
                (e) => s.dy`
                  <ha-list-item graphic="avatar" @click=${this._openEditEntry} .entry=${e}>
                    <ha-person-badge .hass=${this.hass} .person=${e} slot="graphic"></ha-person-badge>
                    <span>${e.name}</span>
                  </ha-list-item>
                `,
              )}
        ...
        <ha-fab slot="fab" .label=${e.localize(
          "ui.panel.config.person.add_person",
        )} extended @click=${this._createPerson}>
    ...
    `;
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    const i = new Set();
                    for (const e of [this._configItems, this._storageItems])
                      for (const t of e) t.user_id && i.add(t.user_id);
                ...
                },
                {
                  ...
                  key: "styles",
                  value: () =>
                    s.iv`a{color:var(--primary-color)}ha-card{max-width:600px;margin:16px auto;overflow:hidden}.empty{padding:8px;display:flex;align-items:center;justify-content:space-around}mwc-list:has(+ .empty){display:none}`,
                },
              ],
            };
          },
...
//# sourceMappingURL=32294.a2693783fd305c7b.js.map
