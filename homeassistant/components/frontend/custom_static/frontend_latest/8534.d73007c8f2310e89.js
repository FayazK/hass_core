export const __webpack_ids__ = ["8534"];
  ...
  5031: function (e, t, r) {
    r.a(e, async function (e, o) {
      try {
        r.r(t),
          r.d(t, {
            HuiErrorHeadingBadge: () => p,
            createErrorHeadingBadgeConfig: () => h,
            createErrorHeadingBadgeElement: () => u,
          });
        var n = r(44249),
          i = r(76848),
          s = r(57243),
              ...
              d: [
                ...
                },
                {
                  ...
                  value: function () {
                    return this._config
                      ? s.dy`
      <ha-heading-badge class="error" @click=${this._viewDetail} type="button" .title=${this._config.error}>
    ...
    `
                ...
                },
                {
                  ...
                  key: "styles",
                  value: () =>
                    s.iv`ha-heading-badge{--icon-color:var(--error-color);color:var(--error-color)}.content{max-width:70px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}pre{font-family:var(--code-font-family, monospace);white-space:break-spaces;user-select:text}`,
                },
              ],
            };
          },
...
//# sourceMappingURL=8534.d73007c8f2310e89.js.map
