      ...
      <ha-expansion-panel outlined .expanded=${Boolean(this.schema.expanded)}>
        ${this.schema.icon?o.dy`
            ...
            `:this.schema.iconPath?o.dy`
                <ha-svg-icon slot="leading-icon" .path=${this.schema.iconPath}></ha-svg-icon>
              `:o.Ld}
        <div slot="header" role="heading" aria-level=${this.schema.headingLevel?.toString()??"3"}>
          ${this.schema.title||this.computeLabel?.(this.schema)}
        </div>
        <div class="content">
          ${this._renderDescription()}
          <ha-form .hass=${this.hass} .data=${this.data} .schema=${this.schema.schema} .disabled=${this.disabled} .computeLabel=${this._computeLabel} .computeHelper=${this._computeHelper} .localizeValue=${this.localizeValue}></ha-form>
        </div>
      </ha-expansion-panel>
...
//# sourceMappingURL=42653.dd68425839d9c0d9.js.map