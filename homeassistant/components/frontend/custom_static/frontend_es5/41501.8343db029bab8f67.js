/*! For license information please see 41501.8343db029bab8f67.js.LICENSE.txt */
"use strict";
(self.webpackChunkhome_assistant_frontend =
  self.webpackChunkhome_assistant_frontend || []).push([
  ["41501"],
  {
    81282: function (e, i, t) {
    ...
    ${0}
                ...
                (0, s.$)({ "add-new": e.area_id === C }),
                e.icon
                  ? (0, o.dy)(
                      _ ||
                        (_ = k`<ha-icon slot="graphic" .icon=${0}></ha-icon>`),
                      e.icon,
                    )
                  : (0, o.dy)(
                      f ||
                        (f = k`<ha-svg-icon slot="graphic" .path=${0}></ha-svg-icon>`),
                      x,
                    ),
                e.name,
              ),
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    kind: "field",
                    decorators: [
                      (0, r.Cb)({ type: Boolean, attribute: "no-add" }),
                    ],
                    key: "noAdd",
                    value() {
                      return !1;
                  ...
                  },
                  {
                    ...
                    key: "_getAreas",
                    value() {
                      return (0, n.Z)((e, i, t, a, o, r, s, n, l, c) => {
                        let h,
                          v,
                          p = {};
                        (a || o || r || s || n) &&
                              ...
                              return (
                                ...
                                p[e.id].some((e) => {
                                  ...
                                  return (
                                    ...
                                    r.includes(i.attributes.device_class)
                                  );
                                })
                              );
                            })),
    ...
    `),
                    ...
                    value: function (e) {
                      ...
                      const o = (0, c.q)(
                        ...
                        (null === (i = t.items) || void 0 === i
                          ? void 0
                          : i.filter((e) => ![w, C].includes(e.label_id))) ||
                          [],
                      );
                      0 === o.length
                        ? this.noAdd
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (i === w)
                        return (i = ""), void this.comboBox.setInputValue("");
                      [B, C].includes(i)
                        ? ((e.target.value = this._value),
                          this.hass.loadFragmentTranslation("config"),
                          (0, p.E)(this, {
                            suggestedName: i === B ? this._suggestion : "",
                            createEntry: async (e) => {
                              try {
                                const i = await (0, h.Lo)(this.hass, e),
    ...
    94279: function (e, i, t) {
      t.a(e, async function (e, i) {
        try {
          var a = t(61701),
            o = t(72621),
            r = (t(71695), t(9359), t(31526), t(40251), t(47021), t(2394)),
            s = t(28737),
            n = t(43631),
            l = t(57243),
            d = t(50778),
    ...
    `),
                        ...
                        (0, l.dy)(
                          m ||
                            (m = f`<div style="width:28px" role="none presentation"></div>`),
                        ),
                        this.icon,
                        this.invalid,
                        this.helper,
                        this.value
                          ? (0, l.dy)(
                              y ||
                                (y = f`<ha-svg-icon role="button" tabindex="-1" aria-label=${0} class="clear-button" .path=${0} @click=${0}></ha-svg-icon>`),
                              (0, c.o)(
      ...
      ${0}
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (
                        ...
                        var t;
                        null === (t = this._bodyMutationObserver) ||
                          void 0 === t ||
                          t.disconnect(),
                          (this._bodyMutationObserver = void 0);
                      }
                            ...
                            e.forEach((e) => {
                              e.addedNodes.forEach((e) => {
                                ...
                                e.removedNodes.forEach((e) => {
                                  ...
                                  "VAADIN-COMBO-BOX-OVERLAY" === e.nodeName &&
                                    (null ===
                                      (i = this._overlayMutationObserver) ||
                                      void 0 === i ||
                                      i.disconnect(),
                                    (this._overlayMutationObserver = void 0));
                                });
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (e.inert)
                        return (
                          (e.inert = !1),
                          null === (i = this._overlayMutationObserver) ||
                            void 0 === i ||
                            i.disconnect(),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      const i = e.detail.value;
                      i !== this.value &&
                        (0, h.B)(this, "value-changed", { value: i || void 0 });
                    },
                  },
                  {
                    kind: "field",
    ...
    86691: function (e, i, t) {
      t.a(e, async function (e, a) {
        try {
          t.r(i);
          var o = t(61701),
            r = (t(71695), t(40251), t(81804), t(47021), t(31622), t(57243)),
            s = t(50778),
            n = t(36522),
            l = (t(99426), t(81282)),
            d = (t(73729), t(73422)),
          ...
          let v,
            ...
            y = (e) => e;
          (0, o.Z)(
            [(0, s.Mo)("dialog-device-registry-detail")],
            function (e, i) {
              return {
                F: class extends i {
                  constructor(...i) {
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      (this._params = e),
                        (this._error = void 0),
                        (this._nameByUser =
                          this._params.device.name_by_user || ""),
      ...
      <ha-dialog open @closed=${0} .heading=${0}>
        <div>
          ${0}
          <div class="form">
            <ha-textfield .value=${0} @input=${0} .label=${0} .placeholder=${0} .disabled=${0} dialogInitialFocus></ha-textfield>
            <ha-area-picker .hass=${0} .value=${0} @value-changed=${0}></ha-area-picker>
        ...
        <mwc-button slot="secondaryAction" @click=${0} .disabled=${0}>
          ${0}
        </mwc-button>
    ...
    `),
                        ...
                        this._labelsChanged,
                        !this._disabledBy,
                        "config_entry" === this._params.device.disabled_by,
                        ...
                        this._disabledBy && "user" !== this._disabledBy
                          ? this.hass.localize(
                        ...
                        this._submitting,
                        this.hass.localize(
                          "ui.dialogs.device-registry-detail.update",
                        ),
                      );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      (this._error = void 0),
                        (this._nameByUser = e.target.value);
                    },
                  },
                  {
                    kind: "method",
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      this._disabledBy = e.target.checked ? null : "user";
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: async function () {
                      ...
                      try {
                        ...
                        this._error =
                          e.message ||
                          this.hass.localize(
                            "ui.dialogs.device-registry-detail.unknown_error",
                          );
                      } finally {
                        this._submitting = !1;
                      }
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, r.iv)(
                          m ||
                            (m = y`mwc-button.warning{margin-right:auto;margin-inline-end:auto;margin-inline-start:initial}ha-area-picker,ha-labels-picker,ha-textfield{display:block;margin-bottom:16px}ha-switch{margin-right:16px;margin-inline-end:16px;margin-inline-start:initial;direction:var(--direction)}.row{margin-top:8px;color:var(--primary-text-color);display:flex;align-items:center}`),
                        ),
                      ];
                    },
                  },
    ...
    30338: function (e, i, t) {
      ...
      e.exports = function (e, i) {
        ...
        var t = s(e);
        return r(o(void 0 !== t ? a(t, e) : e));
      };
    },
    60933: function (e, i, t) {
      var a = t(40810),
        o = t(57877),
        r = t(63983),
        s = t(12360),
    ...
    32126: function (e, i, t) {
      t(35709)("flatMap");
    },
    25677: function (e, i, t) {
      var a = t(40810),
        o = t(97934),
        r = t(63983),
        s = t(71998),
        ...
        h = t(92288),
        u = d(function () {
          for (var e, i, t = this.iterator, a = this.mapper; ; ) {
            if ((i = this.inner))
              try {
                if (!(e = s(o(i.next, i.iterator))).done) return e.value;
                this.inner = null;
              } catch (r) {
                c(t, "throw", r);
              }
            if (((e = s(o(this.next, t))), (this.done = !!e.done))) return;
            try {
      ...
      a(
        ...
        {
          flatMap: function (e) {
            return s(this), r(e), new u(n(this), { mapper: e, inner: null });
          },
        },
      );
    },
    74514: function (e, i, t) {
      t.d(i, { W: () => _ });
      var a = t(9065),
        o = t(50778),
        r = (t(71695), t(19423), t(47021), t(57243)),
        s = t(49144),
        n = t(17077);
      let l,
        d,
      ...
      `),
            ...
            ? (0, r.dy)(
                d ||
                  (d = h`
        <span class="primary action" aria-label=${0}>
          ${0}
        </span>
      `),
                i || r.Ld,
    ...
    `),
      ...
      (0, a.__decorate)(
        ...
        (0, a.__decorate)([(0, o.Cb)()], u.prototype, "href", void 0),
        (0, a.__decorate)([(0, o.Cb)()], u.prototype, "target", void 0),
        (0, a.__decorate)(
