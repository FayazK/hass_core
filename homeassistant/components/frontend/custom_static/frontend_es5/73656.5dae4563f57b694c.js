...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["73656"],
  {
    56032: function (t, i, e) {
      e.a(t, async function (t, i) {
        try {
          var s = e(61701),
            a = (e(71695), e(47021), e(80519)),
            o = e(1261),
            n = e(57243),
            r = e(50778),
            d = e(85605),
                ...
                d: [
                  {
                    ...
                    value() {
                      return [
                        ...
                        (0, n.iv)(
                          h ||
                            (h = c`:host{--sl-tooltip-background-color:var(--secondary-background-color);--sl-tooltip-color:var(--primary-text-color);--sl-tooltip-font-family:Roboto,sans-serif;--sl-tooltip-font-size:12px;--sl-tooltip-font-weight:normal;--sl-tooltip-line-height:1;--sl-tooltip-padding:8px;--sl-tooltip-border-radius:var(--ha-tooltip-border-radius, 4px);--sl-tooltip-arrow-size:var(--ha-tooltip-arrow-size, 8px);--sl-z-index-tooltip:var(--ha-tooltip-z-index, 1000)}`),
                        ),
                      ];
                    },
                  },
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      (0, o.Z)(e, "connectedCallback", this, 3)([]),
                        this.hasUpdated && this._subscribeForecastEvents();
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: function () {
                      (0, o.Z)(e, "disconnectedCallback", this, 3)([]),
                        this._unsubscribeForecastEvents();
                    },
                  },
                  {
                    ...
                    key: "shouldUpdate",
                    value: function (t) {
                      if (t.has("stateObj")) return !0;
                      const i = t.get("hass");
                      return (
                        !i ||
                        i.locale !== this.hass.locale ||
                        i.config.unit_system !== this.hass.config.unit_system
                      );
                    },
                  },
                  {
                    ...
                    value: function (t) {
                      if (
                        ((0, o.Z)(e, "willUpdate", this, 3)([t]),
                        (!t.has("stateObj") && this._subscribed) ||
                          !this.stateObj)
                      )
                        t.has("_forecastType") &&
                        ...
                        var i;
                        const e = t.get("stateObj");
                        ((null == e ? void 0 : e.entity_id) ===
                          (null === (i = this.stateObj) || void 0 === i
                            ? void 0
                            : i.entity_id) &&
                          this._subscribed) ||
                          ((this._forecastType = (0, p.k5)(this.stateObj)),
                          this._subscribeForecastEvents());
                      }
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      const t = this._supportedForecasts(this.stateObj),
                        i = (0, p.Rt)(
                          this.stateObj.attributes,
                          this._forecastEvent,
                        ),
                        e = null == i ? void 0 : i.forecast,
                        s = "hourly" === (null == i ? void 0 : i.type),
                        a = "twice_daily" === (null == i ? void 0 : i.type),
                        o = (0, p.Cq)(this.stateObj.state, this);
                      return (0, n.dy)(
                        f ||
                          (f = T`
      <div class="content">
    ...
    `),
          ...
          `),
                        ...
                        void 0 !== this.stateObj.attributes.temperature &&
                          null !== this.stateObj.attributes.temperature
                          ? (0, n.dy)(
                              g ||
                                (g = T`
                    ${0} <span>${0}</span>
                  `),
                          ...
                          : n.Ld,
                        (0, p.k2)(this.hass, this.stateObj, e),
          ...
          `),
                              ...
                              t.length > 1
                                ? (0, n.dy)(
                                    k ||
                                      (k = T`<mwc-tab-bar .activeIndex=${0} @MDCTabBar:activated=${0}>
                  ${0}
                </mwc-tab-bar>`),
                                    t.findIndex(
                                      (t) => t === this._forecastType,
                                    ),
                                    this._handleForecastTypeChanged,
                                    t.map((t) =>
                                      (0, n.dy)(
                                        C ||
                                          (C = T`<mwc-tab .label=${0}></mwc-tab>`),
                                        this.hass.localize(
                                          `ui.card.weather.${t}`,
                                        ),
                                      ),
          ...
          `),
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      this._forecastType = this._supportedForecasts(
                        this.stateObj,
                      )[t.detail.index];
                    },
                  },
