  ...
  ["78354"],
  {
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          const c = 1e3,
            u = 60,
            h = 60 * u;
          function p(e, t = Date.now(), i, a = {}) {
            const l = Object.assign(Object.assign({}, f), a || {}),
              d = (+e - +t) / c;
            if (Math.abs(d) < l.second)
              return { value: Math.round(d), unit: "second" };
            const p = d / u;
            if (Math.abs(p) < l.minute)
              return { value: Math.round(p), unit: "minute" };
            const g = d / h;
            if (Math.abs(g) < l.hour)
            ...
            if (Math.abs(m) < l.day) return { value: m, unit: "day" };
            const y = (0, r.Bt)(i),
              b = (0, n.z)(v, { weekStartsOn: y }),
              _ = (0, n.z)(k, { weekStartsOn: y }),
              w = (0, s.p)(b, _);
            if (0 === w) return { value: m, unit: "day" };
            if (Math.abs(w) < l.week) return { value: w, unit: "week" };
            const x = v.getFullYear() - k.getFullYear(),
              C = 12 * x + v.getMonth() - k.getMonth();
            return 0 === C
              ? { value: w, unit: "week" }
              : Math.abs(C) < l.month || 0 === x
              ? { value: C, unit: "month" }
    ...
    75930: function (e, t, i) {
      ...
      <div class="container">
        <div class="textfield-container">
          <ha-textfield .value=${0} readonly=readonly .suffix=${0} @click=${0}></ha-textfield>
          ${0}
        </div>
    ...
    `),
                    this._showMasked && this.maskedValue
                      ...
                      : this.value,
                    this.maskedValue
                      ? (0, n.dy)(d || (d = h`<div style="width:24px"></div>`))
                      : n.Ld,
                    this._focusInput,
                    this.maskedValue
                      ? (0, n.dy)(
                          c ||
                            (c = h`<ha-icon-button class="toggle-unmasked" .label=${0} @click=${0} .path=${0}></ha-icon-button>`),
                          this.hass.localize(
              ...
              },
              {
                ...
                value() {
                  return (0, n.iv)(
                    u ||
                      (u = h`.container{display:flex;align-items:center;gap:8px;margin-top:8px}.textfield-container{position:relative;flex:1}.textfield-container ha-textfield{display:block}.toggle-unmasked{position:absolute;top:8px;right:8px;inset-inline-start:initial;inset-inline-end:8px;--mdc-icon-button-size:40px;--mdc-icon-size:20px;color:var(--secondary-text-color);direction:var(--direction)}`),
                  );
                },
              },
            ],
    ...
    23334: function (e, t, i) {
      ...
      var a = i(61701),
        o = (i(71695), i(47021), i(74269), i(57243)),
        n = i(50778),
        s = i(20552);
      i(37583);
      let r,
    ...
    `),
                      ...
                      this.path
                        ? (0, o.dy)(
                            l ||
                              (l = u`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                            this.path,
                          )
                        : (0, o.dy)(d || (d = u`<slot></slot>`)),
                    );
                  },
                },
                {
    ...
    `),
                    ...
                    this._toggleMenu,
                    e ? (0, n.dy)(c || (c = h`<div class="dot"></div>`)) : "",
                  );
                },
              },
              {
    ...
    34326: function (e, t, i) {
      ...
      <ha-icon-button .label=${0} @click=${0} .path=${0}></ha-icon-button>`),
                    ...
                    (0, o.dy)(r || (r = d`<div style="width:24px"></div>`)),
              ...
              },
              {
                ...
                value() {
                  return (0, o.iv)(
                    l ||
                      (l = d`:host{display:block;position:relative}ha-textfield{width:100%}ha-icon-button{position:absolute;top:8px;right:8px;inset-inline-start:initial;inset-inline-end:8px;--mdc-icon-button-size:40px;--mdc-icon-size:20px;color:var(--secondary-text-color);direction:var(--direction)}`),
                  );
                },
              },
            ],
    ...
    `),
              ...
              },
              {
                ...
                value() {
                  return (0, o.iv)(
                    r ||
                      (r = l`:host{display:block;text-align:center}.text{direction:var(--direction);margin-left:2px;margin-inline-start:2px;margin-inline-end:initial;color:var(--secondary-text-color)}.prefix{font-weight:500}`),
                  );
                },
              },
            ],
      ...
      i.a(e, async function (e, t) {
        try {
          ...
          const w =
            ...
            C = "M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z";
          (0, a.Z)(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (0, o.dy)(
                        m ||
                          (m = _`
      <hass-subpage .hass=${0} .narrow=${0} header="ASCIA Cloud">
        ...
        <div class="content">
          ...
          <ha-config-section .isWide=${0}>
            ...
            <cloud-remote-pref .hass=${0} .narrow=${0} .cloudStatus=${0}></cloud-remote-pref>

            <cloud-tts-pref .hass=${0} .cloudStatus=${0}></cloud-tts-pref>

            <cloud-ice-servers-pref .hass=${0} .cloudStatus=${0}></cloud-ice-servers-pref>
            ...
            <cloud-webhooks .hass=${0} .narrow=${0} .cloudStatus=${0}></cloud-webhooks>
          </ha-config-section>
        </div>
      </hass-subpage>
    `),
                        ...
                        "connecting" === this.cloudStatus.cloud &&
                          ...
                          ? (0, o.dy)(
                              y ||
                                (y = _`
                    <ha-alert alert-type="warning" .title=${0}></ha-alert>
                  `),
                              this.cloudStatus.cloud_last_disconnect_reason
                                .reason,
                            )
            ...
            d: [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  const { cloud_ice_servers_enabled: e } =
    ...
    77229: function (e, t, i) {
      ...
      <ha-card outlined header=${0}>
        ...
        <div class="card-content">
          ...
          <ha-copy-textfield .hass=${0} .value=${0} .maskedValue=${0} .label=${0}></ha-copy-textfield>

          <ha-expansion-panel outlined .header=${0}>
    ...
    `),
              ...
              `),
                              ...
                              ? (0, o.dy)(
                                  v ||
                                    (v = y`<ha-alert alert-type="warning" .title=${0}>${0}</ha-alert>`),
                                  this.hass.localize(
    ...
    90044: function (e, t, i) {
      ...
      <ha-card outlined header=${0}>
        <div class="card-content">
          ...
          <br/><br/>
          <div class="row">
            <ha-language-picker .hass=${0} .label=${0} .disabled=${0} .value=${0} .languages=${0} @value-changed=${0}>
            </ha-language-picker>

            <ha-select .label=${0} .disabled=${0} .value=${0} @selected=${0}>
              ${0}
            </ha-select>
          </div>
        </div>
    ...
    `),
                        ...
                        i.map((e) =>
                          (0, n.dy)(
                            v ||
                              (v = m`<mwc-list-item .value=${0}>${0}</mwc-list-item>`),
                            e,
                            e,
                          ),
                        ),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t, i, a;
                      e.has("cloudStatus") &&
                        (null === (t = this.cloudStatus) ||
                        void 0 === t ||
                        null === (t = t.prefs.tts_default_voice) ||
                        void 0 === t
                          ? void 0
                          : t[0]) !==
                          (null === (i = e.get("cloudStatus")) ||
                          void 0 === i ||
                          null === (i = i.prefs.tts_default_voice) ||
                          void 0 === i
                            ? void 0
                            : i[0]) &&
                        (null ===
                          (a = this.renderRoot.querySelector("ha-select")) ||
                          void 0 === a ||
                          a.layoutOptions());
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      try {
                        await (0, c.LV)(this.hass, {
                          tts_default_voice: [t, o],
                        }),
                        ...
                        (this.savingPreferences = !1),
                          ...
                          (0, h.showAlertDialog)(this, {
                            text: `Unable to save default language. ${n}`,
                            warning: !0,
                          });
                      }
                    },
                    ...
                    value: async function (e) {
                      ...
                      try {
                        ...
                        (this.savingPreferences = !1),
                          console.error(a),
                          (0, h.showAlertDialog)(this, {
                            text: `Unable to save default voice. ${a}`,
                            warning: !0,
                          });
                      }
                    },
    ...
    `),
                  ...
                  <div class="body-text">
                    ${0}
                    <a href="/config/integrations">${0}
                    </a>
                    ${0}
                    <a href="/config/automation/edit/new">${0}</a>.
                  </div>
                `),
                                this.hass.localize(
                            ...
                            : this._localHooks.map((e) =>
                                (0, r.dy)(
                                  y ||
                                    (y = C`
                    <ha-settings-row .narrow=${0} .entry=${0}>
                      <span slot="heading">
                        ${0}
                        ${0}
                      </span>
              ...
              `),
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      try {
                        i = await (0, u.AV)(this.hass, t.webhook_id);
                      } catch (a) {
                        return void alert(a.message);
                      } finally {
                      ...
                      (this._cloudHooks = Object.assign(
                        Object.assign({}, this._cloudHooks),
                        {},
                        { [t.webhook_id]: i },
                      )),
                  ...
                  },
                  {
                    ...
                    key: "_fetchData",
                    value: async function () {
                      if (!(0, d.p)(this.hass, "webhook"))
                        return void (this._localHooks = []);
                      const e = await (0, h.H)(this.hass);
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, r.iv)(
                          x ||
                            (x = C`.body-text{padding:8px 0}.webhook{display:flex;padding:4px 0}.progress{margin-right:16px;margin-inline-end:16px;margin-inline-start:initial;display:flex;flex-direction:column;justify-content:center}.footer{padding-top:16px}.body-text a,.footer a{color:var(--primary-color)}ha-settings-row{padding:0}`),
                        ),
                      ];
                    },
                  },
    ...
    81182: function (e, t, i) {
      ...
      var a = i(36522);
      const o = () =>
          Promise.all([i.e("7442"), i.e("52430"), i.e("69353")]).then(
            i.bind(i, 64028),
          ),
        n = (e) => {
          (0, a.B)(e, "show-dialog", {
    ...
    34480: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          ...
          var o = i(61701),
            n = i(72621),
            s = (i(19083), i(71695), i(40251), i(47021), i(50778)),
            r = i(83523),
            l = i(24312),
            d = i(20312),
            c = i(19688),
          ...
          const h = ["account", "google-assistant", "alexa"],
                      ...
                      return {
                        ...
                        beforeRender: (e) => {
                          if (this.cloudStatus.logged_in) {
                            if (!h.includes(e)) return "account";
    ...
    19688: function (e, t, i) {
      i.a(e, async function (e, t) {
        try {
          var a = i(61701),
            o = (i(71695), i(40251), i(47021), i(2060), i(57243)),
            n = i(50778),
            s = i(36522),
            r = i(83523),
      ...
      <hass-subpage .hass=${0} .narrow=${0} header="ASCIA Cloud">
        ...
        <div class="content">
          <ha-config-section .isWide=${0}>
            ...
            <cloud-login .hass=${0} .email=${0} .localize=${0} @cloud-forgot-password=${0} check-connection></cloud-login>

            <ha-card outlined>
              <mwc-list>
                <ha-list-item @click=${0} twoline hasMeta>
                  ${0}
                  <span slot="secondary">
                    ${0}
                  </span>
    ...
    `),
                        ...
                        this.flashMessage
                          ? (0, o.dy)(
                              g ||
                                (g = k`<ha-alert dismissable @alert-dismissed-clicked=${0}>
                  ${0}
                </ha-alert>`),
                              this._dismissFlash,
                              this.flashMessage,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, o.iv)(
                          v ||
                            (v = k`.content{padding-bottom:24px}[slot=introduction]{margin:-1em 0}[slot=introduction] a{color:var(--primary-color)}ha-card{overflow:hidden}ha-card .card-header{margin-bottom:-8px}h1{margin:0}`),
                        ),
                      ];
                    },
                  },
    ...
    28008: function (e, t, i) {
      ...
      const c = (0, a.iv)(
        ...
        h = (0, a.iv)(
          s ||
            (s = d`ha-dialog{--mdc-dialog-min-width:400px;--mdc-dialog-max-width:600px;--mdc-dialog-max-width:min(600px, 95vw);--justify-action-buttons:space-between}ha-dialog .form{color:var(--primary-text-color)}a{color:var(--primary-color)}@media all and (max-width:450px),all and (max-height:500px){ha-dialog{--mdc-dialog-min-width:calc(
        ...
        p = (0, a.iv)(
          r ||
            (r = d`.ha-scrollbar::-webkit-scrollbar{width:.4rem;height:.4rem}.ha-scrollbar::-webkit-scrollbar-thumb{-webkit-border-radius:4px;border-radius:4px;background:var(--scrollbar-thumb-color)}.ha-scrollbar{overflow-y:auto;scrollbar-color:var(--scrollbar-thumb-color) transparent;scrollbar-width:thin}`),
        );
      (0, a.iv)(
        l ||
...
//# sourceMappingURL=78354.e8ac243020143aa9.js.map
