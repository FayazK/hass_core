...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["90987"],
  {
    ...
    34798: function (t, a, e) {
      e.d(a, { l: () => i });
      e(69235), e(12385), e(19134), e(11740), e(97003);
      const i = (t, a = "_") => {
        const e =
    ...
    6827: function (t, a, e) {
      e.r(a), e.d(a, { DialogLovelaceDashboardDetail: () => b });
      var i = e(61701),
        s =
          (e(19083),
          e(71695),
              ...
              d: [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    const e = this.hass.defaultPanel,
                      i = !this._data.title || !this._data.title.trim();
                    return (0, s.dy)(
                      u ||
                        (u = f`
      <ha-dialog open @closed=${0} scrimClickAction escapeKeyAction .heading=${0}>
        ...
        ${0}
        <mwc-button slot="primaryAction" @click=${0} .disabled=${0} dialogInitialFocus>
          ${0}
        </mwc-button>
      </ha-dialog>
    `),
                      ...
                      this._params.dashboard && !this._params.dashboard.id
                        ...
                        : (0, s.dy)(
                            p ||
                              (p = f`
                  <ha-form .schema=${0} .data=${0} .hass=${0} .error=${0} .computeLabel=${0} @value-changed=${0}></ha-form>
                `),
                            this._schema(this._params, this.hass.userData),
                            this._data,
                            this.hass,
                            this._error,
                            this._computeLabel,
            ...
            `),
                ...
                },
                {
                  ...
                  value() {
                    return (0, r.Z)((t, a) => [
                      ...
                      ...(!t.dashboard && null != a && a.showAdvanced
                        ? [
                            {
                              name: "url_path",
                              required: !0,
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    i.url_path !==
                      ...
                      (i.url_path &&
                        "lovelace" !== i.url_path &&
                        /^[a-zA-Z0-9_-]+-[a-zA-Z0-9_-]+$/.test(i.url_path)) ||
                        (this._error = {
                      ...
                      (null === (e = this._data) || void 0 === e
                        ? void 0
                        : e.title)
                        ? ((this._data = i), this._fillUrlPath(i.title))
                        : (this._data = i);
                  },
                },
                {
                  ...
                  value: function (t) {
                    var a;
                    if (
                      (null !== (a = this.hass.userData) &&
                        void 0 !== a &&
                        a.showAdvanced &&
                        this._urlPathChanged) ||
                      !t
                    )
                      return;
                    const e = (0, l.l)(t, "-");
                    this._data = Object.assign(
                      ...
                      {},
                      { url_path: e.includes("-") ? e : `dashboard-${e}` },
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    const a =
                      null === (t = this._params) || void 0 === t
                        ...
                        : t.urlPath;
                    a &&
                      (0, c.CM)(this, a === this.hass.defaultPanel ? c.te : a);
                  },
                },
                {
                  kind: "method",
                ...
                },
                {
                  ...
                  value: async function () {
                    this._submitting = !0;
                    try {
                      (await this._params.removeDashboard()) &&
                        this.closeDialog();
                    } finally {
                      this._submitting = !1;
                    }
...
//# sourceMappingURL=90987.3896286df675395b.js.map
