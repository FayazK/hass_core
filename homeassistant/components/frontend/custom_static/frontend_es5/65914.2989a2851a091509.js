    ...
    `),
        ...
        `),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      const t = e.currentTarget.curValue,
                        i = e.detail.value;
                      if (i === t || (void 0 !== i && !(0, d.T)(i))) return;
                  ...
                  },
                  {
                    ...
                    key: "styles",
                    value() {
                      return (0, n.iv)(f || (f = p`div{margin-top:8px}`));
                    },
                  },
                ],
              };
...
`),
          ...
          return {
            ...
            d: [
              ...
              },
              {
                ...
                value: function () {
                  return (0, o.dy)(
                    u || (u = f`<slot name="heading"> ${0} </slot>`),
              ...
              },
              {
                ...
                value() {
                  return [
                    ...
                    (0, o.iv)(
                      h ||
                        (h = f`.dialog-actions,.header_button,.header_title{direction:var(--direction)}:host([scrolled]) ::slotted(ha-dialog-header){border-bottom:1px solid var(--mdc-dialog-scroll-divider-color,rgba(0,0,0,.12))}.mdc-dialog{--mdc-dialog-scroll-divider-color:var(
                ...
                value: function () {
                  return this.icon
                    ? this._legacy
                      ? (0, s.dy)(
                          g ||
                            (g = y`<!-- @ts-ignore we don't provide the iron-icon element -->
        <iron-icon .icon=${0}></iron-icon>`),
                          this.icon,
                        )
                      : (0, s.dy)(
                          _ ||
                            (_ = y`<ha-svg-icon .path=${0} .secondaryPath=${0} .viewBox=${0}></ha-svg-icon>`),
                          this._path,
                          this._secondaryPath,
                          this._viewBox,
                        )
              ...
              },
              {
                ...
                key: "styles",
                value() {
                  return (0, s.iv)(b || (b = y`:host{fill:currentcolor}`));
                },
              },
            ],
          };
    ...
    2903: function (e, t, i) {
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          var n = i(61701),
            ...
            d = i(32587),
            l = (i(59826), i(73729)),
            c = (i(55486), i(23334), i(2928)),
            u = (i(30509), i(83166), i(43546)),
            h = i(4242),
            f = i(76131),
            p = i(28008),
            m = i(73192),
          ...
          const D =
            ...
            O = ["device_tracker"],
            S = { round: !0, quality: 0.75, aspectRatio: 1 };
          let P = (0, n.Z)(
            null,
            function (e, t) {
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value() {
                      return (0, o.Z)((e) =>
                        Object.keys(e.states).some(
                          (e) =>
                            "device_tracker" === e.substr(0, e.indexOf(".")),
                        ),
                      );
                    },
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      (this._error = void 0),
                      this._params.entry)
                        ? ((this._personExists = !0),
                          (this._name = this._params.entry.name || ""),
                          (this._userId = this._params.entry.user_id || void 0),
                          (this._deviceTrackers =
                            this._params.entry.device_trackers || []),
                          (this._picture = this._params.entry.picture || null),
                          (this._user = this._userId
                            ? this._params.users.find(
                                (e) => e.id === this._userId,
                              )
                            : void 0),
                          (this._isAdmin =
                            null === (t = this._user) || void 0 === t
                              ? void 0
                              : t.group_ids.includes(h.Pb)),
                          (this._localOnly =
                            null === (i = this._user) || void 0 === i
                              ? void 0
                              : i.local_only))
                        : ((this._personExists = !1),
                          (this._name = ""),
                          (this._userId = void 0),
                          (this._user = void 0),
                          (this._isAdmin = void 0),
                          (this._localOnly = void 0),
                          (this._deviceTrackers = []),
                          (this._picture = null));
                      ...
                      if (!this._personExists && this._userId) {
                        ...
                        const t =
                          null === (e = this._params) || void 0 === e
                            ? void 0
                            : e.refreshUsers;
                        (0, h.h8)(this.hass, this._userId).then(() => {
                          null == t || t();
                        }),
                          (this._userId = void 0);
                      }
      ...
      <ha-dialog open @closed=${0} scrimClickAction escapeKeyAction .heading=${0}>
        <div>
          ${0}
          <div class="form">
            <ha-textfield dialogInitialFocus .value=${0} @input=${0} label=${0} .validationMessage=${0} required></ha-textfield>
            ...
            <ha-settings-row>
              ...
              <ha-switch @change=${0} .disabled=${0} .checked=${0}></ha-switch>
            </ha-settings-row>
    ...
    `),
                        ...
                        (0, l.i)(
                          ...
                          this._params.entry
                            ...
                            : this.hass.localize(
                                "ui.panel.config.person.detail.new_person",
                              ),
                        ),
                        this._error
                          ? (0, s.dy)(
                              k || (k = L` <div class="error">${0}</div> `),
                              this._error,
                            )
                          : "",
                        this._name,
                  ...
                  <ha-entities-picker .hass=${0} .value=${0} .includeDomains=${0} .pickedEntityLabel=${0} .pickEntityLabel=${0} @value-changed=${0}>
                  </ha-entities-picker>
                `),
                              this.hass.localize(
                  ...
                  <ul>
                    ...
                    <li>
                      <a @click=${0} href="/config/integrations">
                        ${0}</a>
                    </li>
                  </ul>
                `),
                        ...
                        this._params.entry
                          ? (0, s.dy)(
                              $ ||
                                ($ = L`
              <ha-button slot="secondaryAction" class="warning" @click=${0} .disabled=${0}>
                ${0}
              </ha-button>
            `),
                              this._deleteEntry,
                              (this._user && this._user.is_owner) ||
                                this._submitting,
                              this.hass.localize(
                        ...
                        this._params.entry
                          ? this.hass.localize(
                              "ui.panel.config.person.detail.update",
                            )
                          : this.hass.localize(
                              "ui.panel.config.person.detail.create",
                            ),
                      );
                    },
                  },
      ...
      <ha-settings-row>
        ...
        <ha-switch .disabled=${0} .checked=${0} @change=${0}>
        </ha-switch>
      </ha-settings-row>
      <ha-settings-row>
        <span slot="heading">
    ...
    `),
          ...
          `),
                                  ...
                                  null !== (e = this.hass.user) &&
                                    ...
                                    ? (0, s.dy)(
                                        A ||
                                          (A = L`
                    <ha-icon-button .path=${0} @click=${0} .label=${0}>
                    </ha-icon-button>
                  `),
                                        D,
          ...
          `),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      this._localOnly = e.target.checked;
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: async function (e) {
                      ...
                      if (t.checked)
                          ...
                          (0, v.G)(this, {
                            userAddedCallback: async (e) => {
                              ...
                              e &&
                                ...
                                (this._user = e),
                                (this._userId = e.id),
                                (this._isAdmin = e.group_ids.includes(h.Pb)),
                                (this._localOnly = e.local_only));
                            },
                            name: this._name,
                          });
                        ...
                        await (0, h.h8)(this.hass, this._userId),
                          null === (i = this._params) ||
                            void 0 === i ||
                            i.refreshUsers(),
                          (this._userId = void 0),
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      ...
                      this._user.credentials.find(
                        (e) => "homeassistant" === e.type,
                      )
                        ? (0, g.o)(this, { userId: this._user.id })
                        : (0, f.showAlertDialog)(this, {
                            title: "No ASCIA credentials found.",
                          });
                    },
                  },
                  {
                    ...
                    value: async function () {
                      ...
                      const e = await (0, f.showPromptDialog)(this, {
                      ...
                      if (e)
                        try {
                          var t;
                          await (0, u.j2)(this.hass, this._user.id, e),
                            null === (t = this._params) ||
                              void 0 === t ||
                              t.refreshUsers(),
                    ...
                    value: async function () {
                      ...
                      try {
                        ...
                        if (
                          (this._userId &&
                            this._name !==
                              (null === (e = this._params.entry) || void 0 === e
                                ? void 0
                                : e.name)) ||
                          this._isAdmin !==
                            (null === (t = this._user) || void 0 === t
                          ...
                          await (0, h.Nq)(this.hass, this._userId, {
                            name: this._name.trim(),
                            group_ids: [this._isAdmin ? h.Pb : h.CE],
                        ...
                        this._params.entry
                          ? await this._params.updateEntry(n)
                          : (await this._params.createEntry(n),
                            (this._personExists = !0)),
                          this.closeDialog();
                      } catch (n) {
                        this._error = n ? n.message : "Unknown error";
                      } finally {
                        this._submitting = !1;
                      }
                    },
                  },
                  {
                    ...
                    value: async function () {
                      this._submitting = !0;
                      try {
                        (await this._params.removeEntry()) &&
                          (this._params.entry.user_id &&
                            (0, h.h8)(this.hass, this._params.entry.user_id),
                          this.closeDialog());
                      } finally {
                        this._submitting = !1;
                      }
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, s.iv)(
                          B ||
                            (B = L`ha-picture-upload,ha-textfield{display:block}ha-picture-upload{margin-bottom:16px;--file-upload-image-border-radius:50%}ha-settings-row{padding:0}a{color:var(--primary-color)}p{color:var(--primary-text-color)}`),
                        ),
                      ];
                    },
                  },
          ...
          customElements.define("dialog-person-detail", P), a();
        } catch (y) {
          a(y);
        }
      });
    },
    77419: function (e, t, i) {
      "use strict";
      i.d(t, { G: () => s });
      i(71695), i(40251), i(47021);
      var a = i(36522);
      const n = () =>
          Promise.all([i.e("5604"), i.e("36265")]).then(i.bind(i, 78845)),
        s = (e, t) => {
          (0, a.B)(e, "show-dialog", {
    ...
    71364: function (e, t, i) {
      "use strict";
      i.d(t, { o: () => s });
      i(71695), i(40251), i(47021);
      var a = i(36522);
      const n = () =>
          Promise.all([i.e("63055"), i.e("64880")]).then(i.bind(i, 45676)),
        s = (e, t) => {
          (0, a.B)(e, "show-dialog", {
...
//# sourceMappingURL=65914.2989a2851a091509.js.map
