...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["99750"],
  {
    ...
    34618: function (e, t, i) {
      i.d(t, { N: () => n });
      const n = (e, t = 2) => Math.round(e * 10 ** t) / 10 ** t;
    },
    ...
    `),
          ...
          `),
                              "success" === this._result
                                ? (0, o.dy)(
                                    c ||
                                      (c = f`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                    y,
                                  )
                                : "error" === this._result
                                ? (0, o.dy)(
                                    h ||
                                      (h = f`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                    m,
                                  )
                                : this.progress
                                ? (0, o.dy)(
                                    p ||
                                      (p = f`<ha-spinner size="small"></ha-spinner>`),
                                  )
                                : o.Ld,
                            )
                          : o.Ld,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (0, a.dy)(
                    ...
                    this.disableHref
                      ? (0, a.dy)(
                          l || (l = p`<a href="#" class="disabled">${0}</a>`),
                          e,
                        )
                      : (0, a.dy)(
                          c || (c = p`<a target=${0} href=${0}>${0}</a>`),
              ...
              },
              {
                ...
                value: function () {
                  return [
                    ...
                    (0, a.iv)(
                      h ||
                        (h = p`a{width:100%;height:100%;display:flex;align-items:center;overflow:hidden}.disabled{pointer-events:none}`),
                    ),
                  ];
                },
              },
        ...
        (0, r.w)(
          ...
          Object.assign({ startFlowHandler: t.entry_id, domain: t.domain }, i),
          {
            ...
            renderShowFormStepFieldLabel(e, i, n, o) {
              ...
              return (
                e.localize(
                  `component.${t.domain}.options.step.${i.step_id}.${r}data.${n.name}`,
                ) || n.name
              );
            },
            ...
            renderShowFormStepFieldLocalizeValue(e, i, n) {
              return e.localize(`component.${t.domain}.selector.${n}`);
            },
        ...
        try {
          ...
          const I =
            ...
            N = {
              type: "line",
              color: _.QF,
              areaStyle: { color: _.QF + "2B" },
              symbolSize: 0,
              lineStyle: { width: 1 },
              smooth: 0.25,
            };
          (0, o.Z)(
            [(0, s.Mo)("ha-config-hardware")],
            function (e, t) {
              class i extends t {
                constructor(...t) {
                  super(...t), e(this);
              ...
              return {
                ...
                d: [
                        ...
                        (0, f.DJ)(
                          ...
                          (e) => {
                            ...
                            const n = [
                              ...
                              o = {};
                            for (const a of n) o[a.entry_id] = a;
                            this._configEntries = o;
                          },
                          { type: ["hardware"] },
                        ),
                      ];
                  ...
                  },
                  {
                    ...
                    key: "firstUpdated",
                    value: function (e) {
                      (0, a.Z)(i, "firstUpdated", this, 3)([e]), this._load();
                      const t = new Date();
                      for (let i = 0; i < U; i++) {
                        const e = new Date(t);
                        e.setSeconds(e.getSeconds() - 5 * (U - i)),
                          this._memoryEntries.push([e.getTime(), null]),
                          this._cpuEntries.push([e.getTime(), null]);
                      }
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      let n,
                        ...
                        d = [];
                      const p =
                          null === (e = this._hardwareInfo) || void 0 === e
                            ? void 0
                            : e.hardware.find((e) => null !== e.board),
                        u =
                          null === (t = this._hardwareInfo) || void 0 === t
                            ? void 0
                            : t.hardware.filter(
                                (e) =>
                                  null !== e.dongle &&
                                  (!e.config_entries.length ||
                                    e.config_entries.some((e) => {
                                      var t;
                                      return (
                                        (null === (t = this._configEntries) ||
                                        void 0 === t
                                          ? void 0
                                          : t[e]) &&
                      ...
                      p
                        ? ((d = p.config_entries
                            .map((e) => {
                              var t;
                              return null === (t = this._configEntries) ||
                                void 0 === t
                                ? void 0
                                : t[e];
                            })
                            .filter(
                              (e) =>
                                (null == e ? void 0 : e.supports_options) &&
                                !e.disabled_by,
                            )),
                          (n = p.board.hassio_board_id),
                          (o = p.name),
                          (s = p.url),
                          (a = (0, $.RU)({
                            category: "boards",
                            manufacturer: p.board.manufacturer,
                            model: p.board.model,
                            darkOptimized:
                              null === (f = this.hass.themes) || void 0 === f
                                ? void 0
                                : f.darkMode,
                          })))
                        : null !== (i = this._OSData) &&
                          void 0 !== i &&
                          i.board &&
                          ((n = this._OSData.board),
                          (o = m.d[this._OSData.board]));
                      return (0, r.dy)(
                        S ||
                          (S = W`
    ...
    `),
                        this.hass,
                        this.narrow,
                        this.hass.localize("ui.panel.config.hardware.caption"),
            ...
            `),
                        ...
                        this._error
                          ? (0, r.dy)(
                              C ||
                                (C = W`<ha-alert alert-type="error">${0}</ha-alert>`),
                              this._error,
                            )
                          : "",
                        o || (0, l.p)(this.hass, "hassio")
                          ? (0, r.dy)(
                              M ||
                                (M = W`
                <ha-card outlined>
              ...
              `),
                              a
                                ? (0, r.dy)(
                                    D ||
                                      (D = W`<img alt="" src=${0} crossorigin="anonymous" referrerpolicy="no-referrer"/>`),
                                    a,
                                  )
                                : "",
                              o ||
                              ...
                              n
                                ? (0, r.dy)(
                                    F ||
                                      (F = W`<p class="secondary-text">${0}</p>`),
                                    n,
                                  )
                                : "",
                              s
                                ? (0, r.dy)(
                                    B ||
                                      (B = W`
                        <mwc-list>
                          <ha-clickable-list-item .href=${0} open-new-tab twoline hasMeta>
                            <span>${0}</span>
                      ...
                      `),
                                ...
                                : "",
                              d.length || (0, l.p)(this.hass, "hassio")
                                ? (0, r.dy)(
                                    H ||
                                      (H = W`<div class="card-actions">
                        ${0}
                        ${0}
                      </div>`),
                                    d.length
                ...
                ${0}
                                ...
                                const t = e.config_entries
                                  ...
                                  .filter(
                                    (e) =>
                                      (null == e
                                        ? void 0
                                        : e.supports_options) && !e.disabled_by,
                                  )[0];
                                return (0, r.dy)(
                                  Z ||
                                    (Z = W`<div class="row">
                    ${0}${0}
                                  ...
                                  t
                                    ? (0, r.dy)(
                                        P ||
                                          (P = W`<mwc-button .entry=${0} @click=${0}>
                          ${0}
                        </mwc-button>`),
                                        t,
                                        this._openOptionsFlow,
                  ...
                  <div class="card-content">
                    <ha-chart-base .hass=${0} .data=${0} .options=${0}></ha-chart-base>
                  </div>
                </ha-card>
                <ha-card outlined>
                  <div class="header">
                  ...
                  <div class="card-content">
                    <ha-chart-base .hass=${0} .data=${0} .options=${0}></ha-chart-base>
                              ...
                              (0, h.K)(this.hass.locale),
                              this.hass,
                              this._getChartData(this._cpuEntries),
                              this._chartOptions,
                              this.hass.localize(
                              ...
                              this.hass,
                              this._getChartData(this._memoryEntries),
                              this._chartOptions,
                            )
                          : (0, l.p)(this.hass, "hardware")
                          ? (0, r.dy)(
                              j ||
                                (j = W`<ha-card outlined>
                  <div class="card-content">
                    <div class="value">
                      ${0}
                    </div>
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      (0, l.p)(this.hass, "usb") && (await (0, v.k)(this.hass));
                      ...
                      try {
                        ...
                        (0, l.p)(this.hass, "hardware") &&
                          ...
                          !e ||
                            (null !== (t = this._hardwareInfo) &&
                              void 0 !== t &&
                              t.hardware.length) ||
                            (this._OSData = await (0, y.AP)(this.hass));
                      } catch (i) {
                        this._error = (0, L.js)(i);
                      }
                    },
                  },
                  {
...
//# sourceMappingURL=99750.a5142a17f20f6f0e.js.map
