...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["87050"],
  {
    51119: function (i, a, e) {
      e.a(i, async function (i, t) {
        try {
          e.r(a);
          var o = e(61701),
            s = (e(71695), e(9359), e(70104), e(47021), e(31622), e(57243)),
            l = e(50778),
            c = e(64214),
            n = e(36522),
            r = e(73729),
    ...
    `),
                        ...
                        i.alternative_names.map((i) =>
                          (0, s.dy)(
                            f || (f = g`<li><code>${0}</code></li>`),
                            i,
                          ),
                        ),
                        this.closeDialog,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, s.iv)(
                          p ||
                            (p = g`ha-dialog{--mdc-dialog-max-width:535px}.break-word{overflow-wrap:break-word}p{margin-top:0;margin-bottom:12px}p:last-child{margin-bottom:0}`),
                        ),
                      ];
                    },
                  },
