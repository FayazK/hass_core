...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["70923"],
  {
    ...
    68958: function (e, t, i) {
      i.d(t, { t: () => n });
      i(92745), i(9359), i(31526), i(77439), i(19423), i(88972);
      class a {
      ...
      const o = {},
        n = (e) => (t) => {
          ...
          let n;
          i && i in o ? (n = o[i]) : ((n = new a(window[i])), (o[i] = n));
            ...
            descriptor: {
              set(i) {
                ((i, a) => {
                  let o;
                  e.state && (o = d()),
                    n.setValue(s, e.serializer ? e.serializer(a) : a),
            ...
            finisher(i) {
              if (e.state && e.subscribe) {
                ...
                (i.prototype.connectedCallback = function () {
                  e.call(this),
                    (this[`__unbsubLocalStorage${r}`] =
                      null == c ? void 0 : c(this));
                }),
                  (i.prototype.disconnectedCallback = function () {
                    var e;
                    t.call(this),
                      null === (e = this[`__unbsubLocalStorage${r}`]) ||
                        void 0 === e ||
                        e.call(this),
                      (this[`__unbsubLocalStorage${r}`] = void 0);
                  });
              }
              e.state &&
                i.createProperty(
    ...
    83523: function (e, t, i) {
      ...
      const r = async (e, t, i = Date.now()) => {
        ...
        const c = (null == t ? void 0 : t.replace) || !1;
        var d, u, f;
        return (
          c
            ? l.replaceState(
                null !== (d = l.state) && void 0 !== d && d.root
                  ? { root: !0 }
          ...
          (0, o.B)(n.E, "location-changed", { replace: c }),
          !0
        );
      };
    },
    41680: function (e, t, i) {
      i.d(t, { p: () => o });
      i(71695), i(92745), i(77439), i(19134), i(97003), i(47021);
      var a = i(62900);
      const o = (e, t) => {
        if (!(t instanceof a.DD))
          return { warnings: [t.message], errors: void 0 };
        const i = [],
          o = [];
        for (const a of t.failures())
          if (void 0 === a.value)
            i.push(
            ...
            if ("union" === a.type) continue;
            "enums" === a.type
              ? o.push(
                  e.localize("ui.errors.config.key_wrong_type", {
                    key: a.path.join("."),
                    type_correct: a.message
                      .replace("Expected ", "")
                      .split(", ")[0],
                    type_wrong: JSON.stringify(a.value),
                  }),
                )
              : o.push(
                  e.localize("ui.errors.config.key_wrong_type", {
                    key: a.path.join("."),
                    type_correct: a.refinement || a.type,
                    type_wrong: JSON.stringify(a.value),
                  }),
                );
          }
        return { warnings: o, errors: i };
      };
    },
      ...
      const a = (e, t) => {
        ...
        if (e && t && "object" == typeof e && "object" == typeof t) {
          ...
          if (Array.isArray(e)) {
            ...
            for (i = o; 0 != i--; ) if (!a(e[i], t[i])) return !1;
            return !0;
          }
          ...
          if (((o = n.length), o !== Object.keys(t).length)) return !1;
          for (i = o; 0 != i--; )
            ...
            d: [
              {
                ...
                value() {
                  return [
                    ...
                    (0, r.iv)(
                      l ||
                        (l = c`:host{--mdc-theme-secondary:var(--primary-color)}`),
                    ),
                  ];
                },
              },
          ...
          `),
                ...
                `),
                  ...
                  `),
                        ...
                        "selector" in e
                          ? (0, n.dy)(
                              p ||
                                (p = b`<ha-selector .schema=${0} .hass=${0} .name=${0} .selector=${0} .value=${0} .label=${0} .disabled=${0} .placeholder=${0} .helper=${0} .localizeValue=${0} .required=${0} .context=${0}></ha-selector>`),
                              e,
                              this.hass,
                              e.name,
                              e.selector,
              ...
              },
              {
                ...
                value: function (e) {
                  if (!e.context) return;
                  const t = {};
                  for (const [i, a] of Object.entries(e.context))
                    t[i] = this.data[a];
                  return t;
                },
              },
        ...
        ${0}
              ...
              },
              {
                ...
                value() {
                  return (0, n.iv)(
                    y ||
                      (y = b`.root>*{display:block}.root>:not([own-margin]):not(:last-child){margin-bottom:24px}ha-alert[own-margin]{margin-bottom:4px}`),
                  );
                },
              },
            ],
      ...
      const h = JSON.parse(
        ...
        p = (0, u.Z)(async () => {
          const e = (0, d.MT)("hass-icon-db", "mdi-icon-store");
          {
            ...
            t
              ? t !== h.version &&
                (await (0, d.ZH)(e), (0, d.t8)("_version", h.version, e))
              : (0, d.t8)("_version", h.version, e);
          }
          return e;
        }),
        ...
        <iron-icon .icon=${0}></iron-icon>`),
              ...
              },
              {
                ...
                value: async function () {
                  ...
                  if (n in A) return void (this._path = A[n]);
                  if ("home-assistant" === n) {
                    const t = (await i.e("48348").then(i.bind(i, 30511)))
                      .mdiHomeAssistant;
                    return this.icon === e && (this._path = t), void (A[n] = t);
                  }
                  try {
                    o = await ((e) =>
                      new Promise((t, i) => {
                  ...
                  if (o)
                    return this.icon === e && (this._path = o), void (A[n] = o);
                  const r = ((e) => {
                    let t;
                    for (const i of h.parts) {
                  ...
                  const l = fetch(`/static/mdi/${r}.json`).then((e) =>
                    e.json(),
                  );
                  (w[r] = l), this._setPath(l, n, e), C();
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                value: async function (e, t, i) {
                  const a = await e;
                  this.icon === i && (this._path = a[t]), (A[t] = a[t]);
                },
              },
              {
                kind: "field",
                ...
                key: "styles",
                value() {
                  return (0, n.iv)(v || (v = _`:host{fill:currentcolor}`));
                },
              },
            ],
          };
      ...
      (0, a.Z)(
        ...
        function (e, t) {
          return {
            ...
            d: [
              { kind: "field", key: r.gA, value: void 0 },
              {
                kind: "field",
              ...
              },
              {
                kind: "field",
                decorators: [
                  (0, n.Cb)({ type: Boolean, attribute: "has-overflow" }),
                ],
                key: "hasOverflow",
                value() {
                  return !1;
    ...
    `),
              ...
              },
              {
                ...
                key: "_handleOpening",
                value: function () {
                  (0, s.B)(this, "opening", void 0, { composed: !1 });
                },
              },
              {
                kind: "method",
                key: "_handleClosing",
                value: function () {
                  (0, s.B)(this, "closing", void 0, { composed: !1 });
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                value() {
                  return (0, o.iv)(
                    c ||
                      (c = d`:host{display:inline-block;position:relative}::slotted([disabled]){color:var(--disabled-text-color)}`),
                  );
                },
              },
            ],
    ...
    51868: function (e, t, i) {
      var a = i(61701),
        o = i(72621),
        n = (i(71695), i(47021), i(1231)),
        r = i(57243),
        s = i(50778);
      let l,
        c = (e) => e;
      (0, a.Z)(
        [(0, s.Mo)("ha-md-divider")],
        function (e, t) {
          class i extends t {
            constructor(...t) {
              super(...t), e(this);
            ...
            d: [
              {
                ...
                value() {
                  return [
                    ...
                    (0, r.iv)(
                      l ||
                        (l = c`:host{--md-divider-color:var(--divider-color)}`),
                    ),
                  ];
                },
              },
    ...
    7843: function (e, t, i) {
      var a = i(61701),
        o = i(72621),
        n = (i(71695), i(47021), i(28674)),
        r = i(57243),
        s = i(50778);
      let l,
        c = (e) => e;
      (0, a.Z)(
        [(0, s.Mo)("ha-md-menu-item")],
        function (e, t) {
          class i extends t {
            constructor(...t) {
              super(...t), e(this);
    ...
    96090: function (e, t, i) {
      var a = i(61701),
        o = i(72621),
        n = (i(71695), i(47021), i(53336)),
        r = i(7162),
        s = i(57243),
        l = i(50778);
      let c,
          ...
          return {
            ...
            d: [
              ...
              },
              {
                ...
                value: function (e) {
                  var t, i;
                  (e.detail.reason.kind === r.GB.KEYDOWN &&
                    e.detail.reason.key === r.KC.ESCAPE) ||
                    null === (t = (i = e.detail.initiator).clickAction) ||
                    void 0 === t ||
                    t.call(i, e.detail.initiator);
                },
              },
              {
                kind: "field",
                ...
                value() {
                  return [
                    ...
                    (0, s.iv)(
                      c ||
                        (c = d`:host{--md-sys-color-surface-container:var(--card-background-color)}`),
                    ),
                  ];
                },
              },
    ...
    32669: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          i.r(t), i.d(t, { HaActionSelector: () => m });
          var o = i(61701),
                      ...
                      value: function () {
                        return (0, n.dy)(
                          u ||
                            (u = p`
      ${0}
      <ha-automation-action .disabled=${0} .actions=${0} .hass=${0}></ha-automation-action>
    `),
                          this.label
                            ? (0, n.dy)(
                                f || (f = p`<label>${0}</label>`),
                    ...
                    },
                    {
                      ...
                      value() {
                        return (0, n.iv)(
                          h ||
                            (h = p`ha-automation-action{display:block;margin-bottom:16px}label{display:block;margin-bottom:4px;font-weight:500}`),
                        );
                      },
                    },
                  ],
          ...
          return {
            ...
            d: [
              ...
              { kind: "field", key: "_personEntityId", value: void 0 },
              {
                ...
                key: "willUpdate",
                value: function (e) {
                  if (((0, o.Z)(i, "willUpdate", this, 3)([e]), e.has("user")))
              ...
              },
              {
                ...
                key: "render",
                value: function () {
                  if (!this.hass || !this.user) return n.Ld;
                  const e = this._personPicture;
                  if (e)
                    return (0, n.dy)(
                      u || (u = p`<div style=${0} class="picture"></div>`),
                      (0, l.V)({
                        backgroundImage: `url(${this.hass.hassUrl(e)})`,
                      }),
                    );
                  const t = (0, d.fm)(this.user.name);
                  return (0, n.dy)(
                    f ||
                      (f = p`<div class="initials ${0}">
      ${0}
    </div>`),
                    (0, s.$)({ long: t.length > 2 }),
                    t,
              ...
              },
              {
                ...
                value() {
                  return (0, n.iv)(
                    h ||
                      (h = p`.initials,.picture{width:40px;border-radius:50%}:host{display:contents}.picture{height:40px;background-size:cover}.initials{display:inline-block;box-sizing:border-box;line-height:40px;text-align:center;background-color:var(--light-primary-color);text-decoration:none;color:var(--text-light-primary-color,var(--primary-text-color));overflow:hidden}.initials.long{font-size:80%}`),
                  );
                },
              },
            ],
    ...
    30635: function (e, t, i) {
      ...
      const o = (0, a.kr)("connection"),
        ...
        u = (0, a.kr)("config"),
        f = (0, a.kr)("themes"),
        h = (0, a.kr)("selectedTheme"),
        p = (0, a.kr)("user"),
        m = (0, a.kr)("userData"),
        g = (0, a.kr)("panels"),
        y = (0, a.kr)("extendedEntities"),
        b = (0, a.kr)("floors"),
        v = (0, a.kr)("labels");
    },
    ...
    63318: function (e, t, i) {
      ...
      i(19083),
        ...
        i(19423),
        i(47021);
      if (66977 != i.j) var a = i(62212);
      var o = i(27486),
        n = i(47194),
        r = i(1416),
        s = i(22381);
      if (66977 != i.j) var l = i(73850);
      const c = 66977 != i.j ? ["sensor", "binary_sensor"] : null,
        d = (e, t) => {
          const i = t
            .filter(
              (t) =>
                ...
                c.includes((0, l.M)(t.entity_id)),
            )
            .sort(
              (e, t) =>
                c.indexOf((0, l.M)(e.entity_id)) -
                c.indexOf((0, l.M)(t.entity_id)),
            );
        ...
        v = (e, t) =>
          e.subscribeEvents(
            (0, s.D)(() => y(e).then((e) => t.setState(e, !0)), 500, !0),
            "entity_registry_updated",
          ),
        _ = (e, t) => (0, a.B)("_entityRegistry", y, v, e, t),
        k = (e, t) =>
          e.sort((e, i) => (0, r.fe)(e.name || "", i.name || "", t)),
        w = (0, o.Z)((e) => {
          const t = {};
    ...
    57816: function (e, t, i) {
      ...
      const s = (e, t) =>
        ...
        d = (e, t) => e.callWS({ type: "manifest/get", integration: t }),
        ...
        p = (e, t) =>
          e.subscribeEvents(
            (0, o.D)(() => f(e).then((e) => t.setState(e, !0)), 200, !0),
            "logging_changed",
          ),
        m = (e, t) => (0, a.B)("_integration_log_info", f, p, e, t);
    },
    89890: function (e, t, i) {
      ...
      const s =
        ...
        l = "M14,19H18V5H14M6,19H10V5H6V19Z",
        c = "M8,5.14V19.14L19,12.14L8,5.14Z",
        d =
      ...
      const p = "browser",
        m = {
          ...
          artist: { icon: s, layout: "grid", show_list_images: !0 },
          channel: {
            icon: f,
        ...
        v = (e, t = !1) => {
          ...
          if ((0, n.rk)(i)) return;
          if (!(0, o.v)(e))
            return (0, a.e)(e, h.TURN_ON)
              ? [{ icon: d, action: "turn_on" }]
              : void 0;
          const r = [];
          (0, a.e)(e, h.TURN_OFF) && r.push({ icon: d, action: "turn_off" });
          const s = !0 === e.attributes.assumed_state,
            f = e.attributes;
          return (
            ("playing" === i || "paused" === i || s) &&
              (0, a.e)(e, h.SHUFFLE_SET) &&
              t &&
              r.push({
                icon:
                  !0 === f.shuffle
            ...
            !s &&
              (("playing" === i &&
                ((0, a.e)(e, h.PAUSE) || (0, a.e)(e, h.STOP))) ||
                (("paused" === i || "idle" === i) && (0, a.e)(e, h.PLAY)) ||
                ("on" === i &&
                  ((0, a.e)(e, h.PLAY) || (0, a.e)(e, h.PAUSE)))) &&
              r.push({
                icon:
                  "on" === i
            ...
            s &&
              (0, a.e)(e, h.PLAY) &&
              r.push({ icon: c, action: "media_play" }),
            s &&
              (0, a.e)(e, h.PAUSE) &&
              r.push({ icon: l, action: "media_pause" }),
            s &&
              (0, a.e)(e, h.STOP) &&
              r.push({ icon: u, action: "media_stop" }),
            ("playing" === i || "paused" === i || s) &&
              (0, a.e)(e, h.NEXT_TRACK) &&
              r.push({
                icon: "M16,18H18V6H16M6,18L14.5,12L6,6V18Z",
                action: "media_next_track",
              }),
            ("playing" === i || "paused" === i || s) &&
              (0, a.e)(e, h.REPEAT_SET) &&
              t &&
              r.push({
                icon:
                  "all" === f.repeat
        ...
        _ = (e) => {
          if (void 0 === e || e === 1 / 0) return "";
          let t = new Date(1e3 * e).toISOString();
          return (
            (t = e > 3600 ? t.substring(11, 16) : t.substring(14, 19)),
            t.replace(/^0+/, "").padStart(4, "0")
          );
        },
        k = (e) => {
          if (!e) return;
        ...
        w = (e, t, i) =>
          e.callService("media_player", "volume_set", {
            entity_id: t,
            volume_level: i,
          }),
        C = (e, t, i) =>
        ...
        A = (e, t, i, a, o = {}) => (
          ...
          e.callService(
            ...
            "play_media",
            Object.assign(
              { entity_id: t, media_content_id: i, media_content_type: a },
              o,
            ),
          )
        );
    },
    86825: function (e, t, i) {
      i.d(t, { n: () => a, o: () => o });
      i(19083);
      const a = (e, t) => e.callWS({ type: "execute_script", sequence: t }),
        o = (e, t, i) =>
          ...
          ("update" === e &&
            ...
            ].includes(null == i ? void 0 : i.entity_id));
    },
    58968: function (e, t, i) {
      ...
      i(88044);
      const a = (e, t) => e.callApi("POST", "tts_get_url", t),
        o = "media-source://tts/",
        n = (e) => e.startsWith(o),
        r = (e) => e.substring(19),
        s = (e, t, i) =>
          e.callWS({ type: "tts/engine/list", language: t, country: i }),
        l = (e, t) => e.callWS({ type: "tts/engine/get", engine_id: t }),
        c = (e, t, i) =>
    ...
    76131: function (e, t, i) {
      ...
      const o = () =>
          ...
          new Promise((n) => {
            ...
            (0, a.B)(e, "show-dialog", {
              ...
              dialogParams: Object.assign(
                ...
                {
                  cancel: () => {
                    n(!(null == i || !i.prompt) && null), r && r();
                  },
                  confirm: (e) => {
                    n(null == i || !i.prompt || e), s && s(e);
                  },
                },
              ),
            });
        ...
        r = (e, t) => n(e, t),
        s = (e, t) => n(e, t, { confirmation: !0 }),
        l = (e, t) => n(e, t, { prompt: !0 });
    },
    76525: function (e, t, i) {
      ...
      var a = i(5111),
        o = i(84200);
      if (66977 != i.j) var n = i(81165);
      var r = i(76320);
      const s = {},
        l = [],
        c = Symbol.for("HA focus target"),
        d = async (e, t, i, r, u, f = !0) => {
          if (!(i in s)) {
            if (!u) return !1;
            s[i] = {
              element: u().then(() => {
          ...
          if (f) {
            var h, m;
            const { history: o } = a.E;
            if (null !== (h = o.state) && void 0 !== h && h.dialog && !l.length)
              return (
                await new Promise((e) => {
                  setTimeout(e);
                }),
            ...
            const n = l.findIndex((e) => e.dialogTag === i);
            -1 !== n && l.splice(n, 1),
              l.push({
                element: e,
                root: t,
            ...
            const s = { dialog: i };
            null !== (m = o.state) && void 0 !== m && m.dialog
              ? o.replaceState(s, "")
              : (o.replaceState(
                  Object.assign(
          ...
          s[i].closedFocusTargets = (0, o.r)((0, n.j)(), c);
          const y = await s[i].element;
          return t.appendChild(y), y.showDialog(r), !0;
        },
        u = async (e) => {
          if (!(e in s)) return !0;
        ...
        p = (e) => {
          ...
          -1 !== i && l.splice(i, 1),
            (null === (t = a.E.history.state) || void 0 === t
              ? void 0
        ...
        g = async (e) => {
          ...
          for (const a of t)
            if (
              ...
              (a.focus(), (i = (0, n.j)()), i && i !== document.body)
            )
              return;
        };
    },
    28008: function (e, t, i) {
      i.d(t, { $c: () => h, Qx: () => u, k1: () => d, yu: () => f });
      var a = i(57243);
      let o,
        n,
        r,
      ...
      const d = (0, a.iv)(
        ...
        h = (0, a.iv)(
          s ||
            (s = c`.ha-scrollbar::-webkit-scrollbar{width:.4rem;height:.4rem}.ha-scrollbar::-webkit-scrollbar-thumb{-webkit-border-radius:4px;border-radius:4px;background:var(--scrollbar-thumb-color)}.ha-scrollbar{overflow-y:auto;scrollbar-color:var(--scrollbar-thumb-color) transparent;scrollbar-width:thin}`),
        );
      (0, a.iv)(
        l ||
          (l = c`body{background-color:var(--primary-background-color);color:var(--primary-text-color);height:calc(100vh - 32px);width:100vw}`),
      );
    },
  },
]);
//# sourceMappingURL=70923.044a07266c1e1203.js.map
