(self.webpackChunkhome_assistant_frontend =
  ...
  ["57828"],
  {
      ...
      i.a(t, async function (t, n) {
        try {
          ...
          var a = i(16485),
            ...
            s = i(16922),
            c = t([a, d, o, l]);
          [a, d, o, l] = c.then ? (await c)() : c;
          const u = (t, e, i) => m(e, i.time_zone).format(t),
            m = (0, r.Z)(
              (t, e) =>
            ...
            g = (t, e, i) => C(e, i.time_zone).format(t),
            C = (0, r.Z)(
              (t, e) =>
                new Intl.DateTimeFormat(t.language, {
                  month: "short",
            ...
            w = (t, e, i) => `${(0, o.WB)(t, e, i)}, ${(0, l.mr)(t, e, i)}`;
          n();
        } catch (u) {
          n(u);
        }
      ...
      i.a(t, async function (t, n) {
        try {
          ...
          const d = (t) => (t < 10 ? `0${t}` : t),
            ...
            C = (t, e, i, n) => {
              const a =
                void 0 !== n ? (0, o.N)(parseFloat(e), n) : parseFloat(e);
              switch (i) {
                case "d": {
                  const e = Math.floor(a),
                    i = { days: e, hours: Math.floor(24 * (a - e)) };
                  return f(t).format(i);
                }
                case "h": {
                  const e = Math.floor(a),
                    i = { hours: e, minutes: Math.floor(60 * (a - e)) };
                  return y(t).format(i);
                }
                case "min": {
                  const e = Math.floor(a),
                    i = { minutes: e, seconds: Math.floor(60 * (a - e)) };
                  return g(t).format(i);
                }
                default:
    ...
    25904: function (t, e, i) {
      ...
      i.a(t, async function (t, n) {
        try {
          i.d(e, {
            computeAttributeNameDisplay: () => C,
            computeAttributeValueDisplay: () => g,
          });
          i(9359), i(70104), i(52924), i(77439), i(19134), i(97003);
          var a = i(59519),
            r = i(49319);
          if (66977 != i.j) var o = i(92091);
          var l = i(46467),
            d = i(64214),
            s = i(50602),
            c = i(87733),
            u = i(28281),
            m = i(41404);
          if (66977 != i.j) var p = i(87974);
          var h = i(73850);
          if (66977 != i.j) var f = i(59847);
          var y = t([s, a, d, l]);
          [s, a, d, l] = y.then ? (await y)() : y;
          const g = (t, e, i, n, c, y, C) => {
              const A = void 0 !== C ? C : e.attributes[y];
              if (null === A) return t("state.default.unknown");
              if ("number" == typeof A) {
                var v, _;
                const t = (0, f.N)(e),
                  o = null === (v = a.Ht[t]) || void 0 === v ? void 0 : v[y],
                  l = o ? o(A, i) : (0, s.uf)(A, i);
                let d = null === (_ = a.F_[t]) || void 0 === _ ? void 0 : _[y];
                return (
                  "weather" === t
                    ? (d = (0, r.pv)(n, e, y))
                    : a.ig.has(y) && (d = n.unit_system.temperature),
                  d ? `${l}${(0, p.L)(d, i)}${d}` : l
                );
              }
              if ("string" == typeof A && (0, u.J)(A, !0)) {
                if ((0, m.W)(A)) {
                  const t = new Date(A);
                  if ((0, o.Z)(t)) return (0, d.E8)(t, i, n);
                }
                const t = new Date(A);
                if ((0, o.Z)(t)) return (0, l.p6)(t, i, n);
              }
              if (
                (Array.isArray(A) && A.some((t) => t instanceof Object)) ||
                (!Array.isArray(A) && A instanceof Object)
              )
                return JSON.stringify(A);
              if (Array.isArray(A))
                return A.map((a) => g(t, e, i, n, c, y, a)).join(", ");
              const w = e.entity_id,
                x = (0, h.M)(w),
                b = e.attributes.device_class,
                L = c[w],
                M = null == L ? void 0 : L.translation_key;
              return (
                (M &&
                  t(
                    `component.${L.platform}.entity.${x}.${M}.state_attributes.${y}.state.${A}`,
                  )) ||
                (b &&
                  t(
                    `component.${x}.entity_component.${b}.state_attributes.${y}.state.${A}`,
                  )) ||
                t(
                  `component.${x}.entity_component._.state_attributes.${y}.state.${A}`,
                ) ||
                A
              );
            },
            C = (t, e, i, n) => {
              const a = e.entity_id,
                ...
                o = (0, h.M)(a),
                l = i[a],
                d = null == l ? void 0 : l.translation_key;
              return (
                (d &&
                  t(
                    `component.${l.platform}.entity.${o}.${d}.state_attributes.${n}.name`,
                  )) ||
                (r &&
                  t(
                    `component.${o}.entity_component.${r}.state_attributes.${n}.name`,
                  )) ||
                t(
                  `component.${o}.entity_component._.state_attributes.${n}.name`,
                ) ||
                (0, c.f)(
                  n
                    .replace(/_/g, " ")
    ...
    28281: function (t, e, i) {
      ...
      const n = "^\\d{4}-(0[1-9]|1[0-2])-([12]\\d|0[1-9]|3[01])",
        a = new RegExp(n + "$"),
        r = new RegExp(n),
        o = (t, e = !1) => (e ? r.test(t) : a.test(t));
    },
                  ...
                  value() {
                    return [
                      ...
                      "rtl" === s.E.document.dir
                        ? (0, l.iv)(
                            m ||
                              (m = h`.mdc-floating-label,.mdc-text-field--with-leading-icon,.mdc-text-field--with-leading-icon.mdc-text-field--filled .mdc-floating-label,.mdc-text-field__icon--leading,.mdc-text-field__input[type=number]{direction:rtl;--direction:rtl}`),
                          )
                        : (0, l.iv)(p || (p = h``)),
                    ];
                  },
    ...
    49319: function (t, e, i) {
      ...
      let E =
        66977 != i.j
          ? (function (t) {
              return (
                (t[(t.FORECAST_DAILY = 1)] = "FORECAST_DAILY"),
                (t[(t.FORECAST_HOURLY = 2)] = "FORECAST_HOURLY"),
                (t[(t.FORECAST_TWICE_DAILY = 4)] = "FORECAST_TWICE_DAILY"),
                t
              );
            })({})
          : null;
      const D = new Set([
        ...
        I = new Set(["hail", "rainy", "pouring"]),
        P = new Set(["windy", "windy-variant"]),
        T = new Set(["snowy", "snowy-rainy"]),
        R = new Set(["lightning", "lightning-rainy"]),
        Y =
          66977 != i.j
            ? [
                "N",
        ...
        N = (t, e, i, n) => {
          const a =
            null != i ? t.formatEntityAttributeValue(e, "wind_speed", i) : "-";
          if (null != n) {
            const e = O(n);
            return `${a} (${
              t.localize(
                `ui.card.weather.cardinal_direction.${e.toLowerCase()}`,
              ) || e
            })`;
          }
          return a;
        ...
        W = (t, e, i) => {
          const n = t.unit_system.length || "";
          switch (i) {
            case "visibility":
              return e.attributes.visibility_unit || n;
            case "precipitation":
              return (
                e.attributes.precipitation_unit || ("km" === n ? "mm" : "in")
              );
            case "pressure":
              return (
                e.attributes.pressure_unit || ("km" === n ? "hPa" : "inHg")
              );
            case "apparent_temperature":
            case "dew_point":
            case "temperature":
            case "templow":
              return e.attributes.temperature_unit || t.unit_system.temperature;
            case "wind_speed":
              return e.attributes.wind_speed_unit || `${n}/h`;
            case "cloud_coverage":
            case "humidity":
            case "precipitation_probability":
              return "%";
            default:
              return t.unit_system[i] || "";
          }
        },
        z = (t, e, i) => {
          const a = j(t, e, i);
          ...
          if (
            null != i &&
            i.length &&
            void 0 !== i[0].precipitation &&
            null !== i[0].precipitation
          )
            (r = i[0].precipitation), (s = "precipitation");
          else {
            if (!("humidity" in e.attributes)) return;
            (r = e.attributes.humidity), (s = "humidity");
          }
          const c = Z[s],
            u = (0, o.N)(r, 1);
          return (0, n.dy)(
  ...
  `),
        ...
        `),
              ...
              : t.localize(`ui.card.weather.attributes.${s}`),
            t.formatEntityAttributeValue(e, s, u),
          );
        },
        j = (t, e, i) => {
          if (null == i || !i.length) return;
          let a, r;
          const o = new Date().getDate();
          for (const n of i) {
            if (new Date(n.datetime).getDate() !== o) break;
            (!r || n.temperature > r) && (r = n.temperature),
              (!a || (n.templow && n.templow < a)) && (a = n.templow),
              n.templow || (a && !(n.temperature < a)) || (a = n.temperature);
          }
          return a || r
            ? (0, n.dy)(
                s ||
    ...
    ${0}
  `),
                r ? t.formatEntityAttributeValue(e, "temperature", r) : "",
                a && r ? " / " : "",
                a ? t.formatEntityAttributeValue(e, "temperature", a) : "",
              )
            : void 0;
        },
        K = (0, n.iv)(
        ...
        U = (t, e, i) => {
          const r = getComputedStyle(e).getPropertyValue(`--weather-icon-${t}`);
          return r
            ? (0, n.dy)(
                w ||
                  (w = L`
      <div style="background-size:cover;${0}"></div>
    `),
                (0, a.V)({ "background-image": r }),
              )
            : D.has(t)
            ? (0, n.dy)(
                x || (x = L`${0}`),
  ...
  ${0}
        ...
        `),
            ...
            ? (0, n.dy)(
                b ||
                  (b = L`
      <ha-svg-icon class="weather-icon" .path=${0}></ha-svg-icon>
    `),
                V[t],
              )
            : void 0;
        },
        B = (t) => t.callWS({ type: "weather/convertible_units" }),
        J = (t) => {
          if (null != t && t.forecast && t.forecast.length > 2)
            return ((t) => {
              if (
                t &&
                null != t &&
                ...
                return new Date(t[2].datetime).getTime() - e.getTime() < 288e5;
              }
            })(t.forecast)
              ? { forecast: t.forecast, type: "hourly" }
              : ((t) => {
                  if (
                    t &&
                    null != t &&
                    ...
                    const e = new Date(t[1].datetime);
                    return (
                      new Date(t[2].datetime).getTime() - e.getTime() < 864e5
                    );
                  }
                })(t.forecast)
              ? { forecast: t.forecast, type: "twice_daily" }
        ...
        G = (t, e, i) => {
          ...
          return void 0 === i
            ? void 0 !== (null == e ? void 0 : e.type) &&
              null != e &&
              e.forecast &&
              (null == e || null === (a = e.forecast) || void 0 === a
                ? void 0
                : a.length) > 2
              ? { forecast: e.forecast, type: null == e ? void 0 : e.type }
              : J(t)
            : "legacy" === i
            ? J(t)
            : i === (null == e ? void 0 : e.type) &&
              null != e &&
              e.forecast &&
              (null == e || null === (n = e.forecast) || void 0 === n
                ? void 0
                : n.length) > 2
            ? { forecast: e.forecast, type: i }
            : void 0;
        },
        q = (t, e, i, n) =>
          t.connection.subscribeMessage(n, {
        ...
        Q = (t) => {
          const e = [];
          return (
            (0, r.e)(t, E.FORECAST_DAILY) && e.push("daily"),
            (0, r.e)(t, E.FORECAST_TWICE_DAILY) && e.push("twice_daily"),
            (0, r.e)(t, E.FORECAST_HOURLY) && e.push("hourly"),
            e
          );
        },
        X = (t) =>
          (0, r.e)(t, E.FORECAST_DAILY)
            ? "daily"
            : (0, r.e)(t, E.FORECAST_TWICE_DAILY)
            ? "twice_daily"
            : (0, r.e)(t, E.FORECAST_HOURLY)
            ? "hourly"
            : void 0;
    },
    22152: function () {
          ...
          try {
            ...
            const t = async () => {
              ...
              (0, r.shouldPolyfill)() &&
                ...
                0 !== e.length &&
                  (await Promise.all(e).then(() => (0, p.n)(t)));
            };
            await t(), e();
          } catch (h) {
            e(h);
...
//# sourceMappingURL=57828.6ea2ee3ba7cf4ea5.js.map
