  ...
  ["7698"],
  {
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          function p(e, t = Date.now(), i, a = {}) {
            ...
            const g = (0, n.j)(v, k);
            if (0 === g) return { value: Math.round(m), unit: "hour" };
            if (Math.abs(g) < l.day) return { value: g, unit: "day" };
            const y = (0, o.Bt)(i),
              _ = (0, s.z)(v, { weekStartsOn: y }),
              x = (0, s.z)(k, { weekStartsOn: y }),
              b = (0, r.p)(_, x);
            if (0 === b) return { value: g, unit: "day" };
            if (Math.abs(b) < l.week) return { value: b, unit: "week" };
            const w = v.getFullYear() - k.getFullYear(),
              C = 12 * w + v.getMonth() - k.getMonth();
            return 0 === C
              ? { value: b, unit: "week" }
              : Math.abs(C) < l.month || 0 === w
              ? { value: C, unit: "month" }
              ...
              },
              {
                ...
                value: function () {
                  return [
                    (0, n.iv)(
                      o ||
                        (o = l`.content>*,span{display:inline-flex}:host{--ha-label-text-color:var(--primary-text-color);--ha-label-icon-color:var(--primary-text-color);--ha-label-background-color:rgba(
    ...
    34326: function (e, t, i) {
          ...
          return {
            ...
            d: [
              ...
              },
              {
                kind: "field",
                decorators: [
                  (0, s.Cb)({ type: String, attribute: "input-mode" }),
                ],
                key: "inputMode",
                value: void 0,
              },
              ...
              {
                kind: "field",
                decorators: [(0, s.Cb)({ attribute: !1, type: String })],
                key: "autocapitalize",
                value() {
                  return "";
                },
      ...
      <ha-icon-button .label=${0} @click=${0} .path=${0}></ha-icon-button>`),
                    ...
                    (0, n.dy)(o || (o = d`<div style="width:24px"></div>`)),
    ...
    23651: function (e, t, i) {
      i.a(e, async function (e, t) {
        try {
          ...
          let u,
            ...
            y = (e) => e;
          (0, a.Z)(
            [(0, r.Mo)("ha-change-password-card")],
            function (e, t) {
              class i extends t {
                constructor(...t) {
                  super(...t), e(this);
      ...
      <ha-card .header=${0}>
        <div class="card-content">
          ...
          <ha-password-field id="currentPassword" name="currentPassword" .label=${0} autocomplete="current-password" .value=${0} @input=${0} @change=${0} required></ha-password-field>
    ...
    `),
                        ...
                        this._errorMsg
                          ? (0, s.dy)(
                              p ||
                                (p = y`<ha-alert alert-type="error">${0}</ha-alert>`),
                              this._errorMsg,
                            )
                          : "",
                        this._statusMsg
                          ? (0, s.dy)(
                              f ||
                                (f = y`<ha-alert alert-type="success">${0}</ha-alert>`),
                              this._statusMsg,
                            )
                          : "",
                        this.hass.localize(
                        ...
                        this._currentPassword
                          ? (0, s.dy)(
                              m ||
                                (m = y`<ha-password-field .label=${0} name="password" autocomplete="new-password" .value=${0} @input=${0} @change=${0} required autoValidate></ha-password-field>
                <ha-password-field .label=${0} name="passwordConfirm" autocomplete="new-password" .value=${0} @input=${0} @change=${0} required autoValidate></ha-password-field>`),
                              this.hass.localize(
                                "ui.panel.profile.change_password.new_password",
                              ),
                              this._password,
                              this._newPasswordChanged,
                              this._newPasswordChanged,
                              this.hass.localize(
                                "ui.panel.profile.change_password.confirm_new_password",
                              ),
                              this._passwordConfirm,
                              this._newPasswordConfirmChanged,
                              this._newPasswordConfirmChanged,
                            )
                          : "",
                        this._loading
                ...
                <ha-spinner></ha-spinner>
                          ...
                          : (0, s.dy)(
                              k ||
                                (k = y`<mwc-button @click=${0} .disabled=${0}>${0}</mwc-button>`),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      this._currentPassword = e.target.value;
                    },
                  },
                  {
                    kind: "method",
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      this._passwordConfirm = e.target.value;
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: function (e) {
                      (0, n.Z)(i, "firstUpdated", this, 3)([e]),
                        this.addEventListener("keypress", (e) => {
                          (this._statusMsg = void 0),
                            "Enter" === e.key && this._changePassword();
                        });
                    },
                  },
                  {
                        ...
                        if (this._password === this._passwordConfirm)
                          if (this._currentPassword !== this._password) {
                            ...
                            try {
                              ...
                              return void (this._errorMsg = e.message);
                            } finally {
                              this._loading = !1;
                            }
                            if (
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, s.iv)(
                          g ||
                            (g = y`ha-textfield{margin-top:8px;display:block}#currentPassword{margin-top:0}`),
                        ),
                      ];
                    },
                  },
      ...
      i.a(e, async function (e, t) {
        try {
          var a = i(61701),
            ...
            o = i(94947),
            l = i(36522),
            d = (i(54977), i(30509), i(23334), i(76131)),
            c = i(28008),
            h = i(21034),
            u = e([o]);
          ...
          (0, a.Z)(
            [(0, s.Mo)("ha-long-lived-access-tokens-card")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                    ...
                    value() {
                      return (0, r.Z)((e) =>
                        null == e
                          ...
                          : e
                              .filter(
                                (e) => "long_lived_access_token" === e.type,
                              )
                              .reverse(),
                      );
                    },
                  },
                  {
                    ...
                    key: "render",
                    value: function () {
                      const e = this._accessTokens(this.refreshTokens);
                      return (0, n.dy)(
                        p ||
                          (p = k`
      <ha-card .header=${0}>
        <div class="card-content">
          ...
          <a href="https://developers.home-assistant.io/docs/auth_api/#making-authenticated-requests" target="_blank" rel="noreferrer">
            ${0}
          </a>
          ${0}
        </div>
    ...
    `),
                        ...
                        null != e && e.length
                          ? e.map((e) =>
                              (0, n.dy)(
                                m ||
                                  (m = k`<ha-settings-row two-line>
                    <span slot="heading">${0}</span>
                    <div slot="description">
                      ${0}
                    </div>
                    <ha-icon-button .token=${0} .disabled=${0} .label=${0} .path=${0} @click=${0}></ha-icon-button>
                  </ha-settings-row>`),
                                e.client_name,
                                this.hass.localize(
                ...
                ${0}
                  ...
                  },
                  {
                    ...
                    key: "_createToken",
                    value: async function () {
                      const e = await (0, d.showPromptDialog)(this, {
                        text: this.hass.localize(
                      ...
                      if (e)
                        try {
                          ...
                          (0, h.b)(this, { token: t, name: e }),
                            (0, l.B)(this, "hass-refresh-tokens");
                        } catch (t) {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, n.iv)(
                          v ||
                            (v = k`ha-settings-row{padding:0}a{color:var(--primary-color)}mwc-button{--mdc-theme-primary:var(--primary-color)}ha-icon-button{color:var(--primary-text-color)}`),
                        ),
                      ];
                    },
                  },
    ...
    67389: function (e, t, i) {
      var a = i(61701),
        n =
          (i(71695), i(9359), i(70104), i(40251), i(47021), i(31622), i(57243)),
        s = i(50778),
        r = i(36522),
        o = (i(54977), i(76131));
      const l = () =>
    ...
    `),
                    this.hass.localize("ui.panel.profile.mfa.header"),
                    this.mfaModules.map((e) =>
                      (0, n.dy)(
                        c ||
                          (c = f`<ha-settings-row two-line>
              <span slot="heading">${0}</span>
              ...
              ${0}
                        ...
                        e.enabled
                          ? (0, n.dy)(
                              h ||
                                (h = f`<mwc-button .module=${0} @click=${0}>${0}</mwc-button>`),
                              e,
                              this._disable,
                              this.hass.localize(
                          ...
                          : (0, n.dy)(
                              u ||
                                (u = f`<mwc-button .module=${0} @click=${0}>${0}</mwc-button>`),
                              e,
                              this._enable,
                              this.hass.localize("ui.panel.profile.mfa.enable"),
                            ),
                      ),
                    ),
                  );
              ...
              },
              {
                ...
                value() {
                  return (0, n.iv)(
                    p ||
                      (p = f`mwc-button{margin-right:-.57em;margin-inline-end:-.57em;margin-inline-start:initial}ha-list-item{--mdc-list-item-meta-size:auto}`),
                  );
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  (t = this),
                    (i = {
                      mfaModuleId: e.currentTarget.module.id,
              ...
              },
              {
                ...
                key: "_disable",
                value: async function (e) {
                  const t = e.currentTarget.module;
                  if (
                    !(await (0, o.showConfirmationDialog)(this, {
                      text: this.hass.localize(
                  ...
                  const i = t.id;
                  this.hass
                    .callWS({ type: "auth/depose_mfa", mfa_module_id: i })
                    .then(() => {
              ...
              },
              {
                ...
                value: function () {
                  (0, r.B)(this, "hass-refresh-current-user");
                },
              },
            ],
          };
    ...
    6393: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          ...
          var n = i(61701),
            s = i(72621),
            r = (i(71695), i(9359), i(52924), i(40251), i(47021), i(57243)),
            o = i(50778),
            l = (i(97546), i(52230)),
            d = i(28008),
            c = i(23651),
            ...
            u = (i(67389), i(45587)),
            p = e([c, h, u]);
          [c, h, u] = p.then ? (await p)() : p;
          let f,
            m,
            v,
            k = (e) => e;
          (0, n.Z)(
            [(0, o.Mo)("ha-profile-section-security")],
            function (e, t) {
              class i extends t {
                constructor(...t) {
                  super(...t), e(this);
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    key: "firstUpdated",
                    value: function () {
                      this._refreshTokens || this._refreshRefreshTokens();
                    },
                  },
                  {
                    kind: "method",
      ...
      <hass-tabs-subpage main-page .hass=${0} .narrow=${0} .tabs=${0} .route=${0}>
        ...
        <div class="content">
          ${0}
          <ha-mfa-modules-card .hass=${0} .mfaModules=${0}></ha-mfa-modules-card>

          <ha-refresh-tokens-card .hass=${0} .refreshTokens=${0} @hass-refresh-tokens=${0}></ha-refresh-tokens-card>

          <ha-long-lived-access-tokens-card .hass=${0} .refreshTokens=${0} @hass-refresh-tokens=${0}></ha-long-lived-access-tokens-card>
        </div>
      </hass-tabs-subpage>
    `),
                        this.hass,
                        ...
                        this.hass.user.credentials.some(
                          (e) => "homeassistant" === e.auth_provider_type,
                        )
                          ? (0, r.dy)(
                              m ||
                                (m = k`
                <ha-change-password-card .refreshTokens=${0} @hass-refresh-tokens=${0} .hass=${0}></ha-change-password-card>
              `),
                              this._refreshTokens,
                              this._refreshRefreshTokens,
                              this.hass,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, r.iv)(
                          v ||
                            (v = k`:host{-ms-user-select:initial;-webkit-user-select:initial;-moz-user-select:initial}.content{display:block;max-width:600px;margin:0 auto;padding-bottom:env(safe-area-inset-bottom)}.content>*{display:block;margin:24px 0}.promo-advanced{text-align:center;color:var(--secondary-text-color)}`),
                        ),
                      ];
                    },
                  },
      ...
      i.a(e, async function (e, t) {
        try {
          ...
          const g =
            ...
            M = "https://home-assistant.io/android",
            z = (e, t) => {
              const i = e.last_used_at ? new Date(e.last_used_at) : 0,
                a = t.last_used_at ? new Date(t.last_used_at) : 0;
              return i < a ? 1 : i > a ? -1 : 0;
            };
          (0, a.Z)(
            [(0, s.Mo)("ha-refresh-tokens-card")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value() {
                      return (0, r.Z)((e) =>
                        e.filter((e) => "normal" === e.type).sort(z),
                      );
                    },
                  },
                  {
                    kind: "field",
                    key: "_formatTokenName",
                    value() {
                      return (e) =>
                        e.client_id === $
                          ? this.hass.localize(
                              "ui.panel.profile.refresh_tokens.ios_app",
                            )
                          : e.client_id === M
                          ? this.hass.localize(
                              "ui.panel.profile.refresh_tokens.android_app",
                            )
    ...
    `),
                        this.hass.localize(
                          "ui.panel.profile.refresh_tokens.header",
                        ),
                        this.hass.localize(
                          "ui.panel.profile.refresh_tokens.description",
                        ),
                        e.length
                          ? e.map((e) =>
                              (0, n.dy)(
                  ...
                  <ha-settings-row three-line>
                    <ha-svg-icon slot="prefix" .path=${0}></ha-svg-icon>
                    ...
                    <div>
                      <ha-button-menu corner="BOTTOM_END" menu-corner="END" @action=${0} .token=${0}>
                        <ha-icon-button slot="trigger" .label=${0} .path=${0}></ha-icon-button>
                        <ha-list-item graphic="icon">
                          <ha-svg-icon slot="graphic" .path=${0}></ha-svg-icon>
                          ${0}
                        </ha-list-item>
                        <ha-list-item graphic="icon" class="warning" .disabled=${0}>
                ...
                `),
                          ...
                          `),
                                  ...
                                  ? this.hass.localize(
                                      ...
                                      {
                                        date: (0, o.G)(
                                          new Date(e.last_used_at),
                                          this.hass.locale,
                                        ),
                                        location: e.last_used_ip,
                                      },
                                    )
                                  : this.hass.localize(
                      ...
                      if (
                        ...
                        try {
                          await this.hass.callWS({
                            ...
                            refresh_token_id: e.id,
                            enable_expiry: t,
                          }),
                            (0, l.B)(this, "hass-refresh-tokens");
                        } catch (i) {
                          const e =
                            "object" == typeof i && null !== i && "message" in i
                              ? i.message
                              : String(i);
                          await (0, c.showAlertDialog)(this, {
                            title: this.hass.localize(
                              `ui.panel.profile.refresh_tokens.${
                                t ? "enable" : "disable"
                              }_expiration_failed`,
                            ),
                            text: e,
                      ...
                      if (
                        await (0, c.showConfirmationDialog)(this, {
                          ...
                          confirmText: this.hass.localize(
                            "ui.common.delete_all",
                          ),
                          destructive: !0,
                        })
                      )
                        try {
                          await (0, d.YY)(this.hass, "normal", !1),
                            (0, l.B)(this, "hass-refresh-tokens");
                        } catch (e) {
                          await (0, c.showAlertDialog)(this, {
                            title: this.hass.localize(
    ...
    21034: function (e, t, i) {
      ...
      const n = (e, t) => {
        (0, a.B)(e, "show-dialog", {
          ...
          dialogImport: () =>
            Promise.all([i.e("97983"), i.e("43401")]).then(i.bind(i, 56531)),
          dialogParams: t,
        });
      };
    },
...
//# sourceMappingURL=7698.0a1f0e2291878173.js.map
