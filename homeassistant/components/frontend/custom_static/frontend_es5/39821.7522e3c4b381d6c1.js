/*! For license information please see 39821.7522e3c4b381d6c1.js.LICENSE.txt */
"use strict";
(self.webpackChunkhome_assistant_frontend =
  ...
  ["39821"],
  {
    51784: function (e, t, i) {
      ...
      var n = i(61701),
        a = i(72621),
        o = (i(52247), i(71695), i(19423), i(40251), i(47021), i(67840)),
        l = i(88854),
        d = i(57243),
        s = i(50778);
      let r,
        c,
        h = (e) => e;
      o.A.addInitializer(async (e) => {
        await e.updateComplete;
        const t = e;
        t.dialog.prepend(t.scrim),
          (t.scrim.style.inset = 0),
          (t.scrim.style.zIndex = 0);
        const { getOpenAnimation: i, getCloseAnimation: n } = t;
        (t.getOpenAnimation = () => {
          var e, t;
                ...
                value: async function (e) {
                  ...
                  return (
                    ...
                    new Promise((i, n) => {
                      ...
                      (t.onload = () => i()),
                        (t.onerror = () =>
                          n(new Error(`Stylesheet failed to load: ${e}`))),
          ...
          return {
            ...
            d: [
              ...
              },
              {
                kind: "field",
                decorators: [
                  (0, s.Cb)({ attribute: "inline-arrow", type: Boolean }),
                ],
                key: "inlineArrow",
                value() {
                  return !1;
              ...
              },
              {
                ...
                value: function () {
                  return this.icon
                    ? (0, d.dy)(
                        f ||
                          (f = m`<span class="mdc-select__icon"><slot name="icon"></slot></span>`),
                      )
                    : d.Ld;
                },
              },
    ...
    94047: function (e, t, i) {
      ...
      let u,
        ...
        x = (e) => e;
      (0, n.Z)(
        [(0, o.Mo)("ha-more-info-siren-advanced-controls")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
            ...
            d: [
              ...
              {
                kind: "field",
                decorators: [(0, o.IO)("ha-md-dialog")],
                key: "_dialog",
                value: void 0,
              },
              {
              ...
              },
              {
                ...
                key: "render",
                value: function () {
                  if (!this._stateObj) return a.Ld;
                  const e =
                      (0, r.e)(this._stateObj, c.T.TONES) &&
                      this._stateObj.attributes.available_tones,
                    t = (0, r.e)(this._stateObj, c.T.VOLUME_SET),
                    i = (0, r.e)(this._stateObj, c.T.DURATION);
                  return (0, a.dy)(
                    u ||
                      (u = x`
      <ha-md-dialog open @closed=${0} aria-labelledby="dialog-light-color-favorite-title" .getOpenAnimation=${0} .getCloseAnimation=${0}>
        <ha-dialog-header slot="headline">
          <ha-icon-button slot="navigationIcon" @click=${0} .label=${0} .path=${0}></ha-icon-button>
          <span slot="title" id="dialog-light-color-favorite-title">${0}</span>
        </ha-dialog-header>
        <div slot="content">
          <div class="options">
            ${0}
    ...
    `),
                    ...
                    e
                      ? (0, a.dy)(
                          f ||
                            (f = x`
                  <ha-select .label=${0} @closed=${0} @change=${0} .value=${0}>
                    ${0}
                  </ha-select>
                `),
                          this.hass.localize("ui.components.siren.tone"),
                          l.U,
                          this._handleToneChange,
                          this._tone,
                          Object.entries(
                            this._stateObj.attributes.available_tones,
                          ).map(([e, t]) =>
                    ...
                    t
                      ? (0, a.dy)(
                          m ||
                            (m = x`
                  <ha-textfield type="number" .label=${0} .suffix=${0} .value=${0} @change=${0} .min=${0} .max=${0} .step=${0}></ha-textfield>
                `),
                          this.hass.localize("ui.components.siren.volume"),
                          "%",
                          this._volume ? 100 * this._volume : void 0,
                    ...
                    i
                      ? (0, a.dy)(
                          v ||
                            (v = x`
                  <ha-textfield type="number" .label=${0} .value=${0} suffix="s" @change=${0}></ha-textfield>
                `),
                          this.hass.localize("ui.components.siren.duration"),
                          this._duration,
              ...
              },
              {
                ...
                value: function (e) {
                  (this._volume = parseFloat(e.target.value) / 100),
                    isNaN(this._volume) && (this._volume = void 0);
                },
              },
              {
                kind: "method",
                ...
                value: function (e) {
                  (this._duration = parseInt(e.target.value)),
                    isNaN(this._duration) && (this._duration = void 0);
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                value: function () {
                  return [
                    ...
                    (0, a.iv)(
                      g ||
                        (g = x`.controls,.options{display:flex;gap:16px}.options{flex-direction:column}.controls{flex-direction:row;justify-content:center;margin-top:16px}ha-control-button{--control-button-border-radius:16px;--mdc-icon-size:24px;width:64px;height:64px}`),
                    ),
                  ];
                },
              },
    ...
    1231: function (e, t, i) {
      ...
      (r.styles = [s]), (r = (0, n.__decorate)([(0, a.Mo)("md-divider")], r));
    },
  },
]);
//# sourceMappingURL=39821.7522e3c4b381d6c1.js.map
