...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["66881"],
  {
    ...
    9198: function (t, e, i) {
      i.a(t, async function (t, a) {
        try {
          ...
          var s = i(61701),
            n = i(72621),
            r = (i(71695), i(9359), i(70104), i(40251), i(47021), i(57243)),
            o = i(50778),
            l = i(49976),
            u = i(75278),
    ...
    `),
            ...
            `),
                              t.localize("ui.card.humidifier.mode"),
                              e.attributes.mode,
                              this.stateObj.state === d.nZ,
                    ...
                    `),
                              ...
                              e.attributes.available_modes.map((t) =>
                                (0, r.dy)(
                                  g ||
                                    (g = C`
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, r.iv)(
                          k ||
                            (k = C`.current,.current div{display:flex;text-align:center}.current,.current div,.current p{text-align:center}:host{color:var(--primary-text-color)}.current{flex-direction:row;align-items:center;justify-content:center;margin-bottom:40px}.current div{flex-direction:column;align-items:center;justify-content:center;flex:1}.current p{margin:0;color:var(--primary-text-color)}.current .label{opacity:.8;font-size:14px;line-height:16px;letter-spacing:.4px;margin-bottom:4px}.current .value{font-size:22px;font-weight:500;line-height:28px;direction:ltr}`),
                        ),
                      ];
                    },
                  },
          ...
          customElements.define("more-info-humidifier", x), a();
        } catch (v) {
          a(v);
        }
      });
    ...
    `),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      if (!this.showSecondary)
                        return (0, n.dy)(k || (k = L`<p class="label"></p>`));
                      const t = this.stateObj.attributes.current_humidity;
                      return null == t || this.showCurrentAsPrimary
                        ? null != this._targetHumidity &&
                          this.showCurrentAsPrimary
      ...
      `),
                            t,
                            b.F_.humidifier.current_humidity,
                            this.hass,
                            i,
                          )
                        : (0, n.dy)(
    ...
    `),
      ...
      `),
                          h,
                          (0, o.V)({ "--state-color": t, "--action-color": a }),
