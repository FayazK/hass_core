...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["31674"],
  {
    15459: function (e, t, i) {
      var a = i(61701),
        o = i(50778),
        n = i(5318),
        s = i(30230);
      (0, a.Z)(
        [(0, o.Mo)("ha-device-action-picker")],
        function (e, t) {
          return {
            F: class extends t {
              constructor() {
    ...
    58381: function (e, t, i) {
      var a = i(61701),
        o = (i(71695), i(19423), i(47021), i(57243)),
        n = i(50778),
        s = i(36522);
      i(97828);
      let d,
          ...
          return {
            ...
            d: [
              ...
              },
              {
                kind: "field",
                decorators: [
                  (0, n.Cb)({ attribute: "enable-millisecond", type: Boolean }),
                ],
              ...
              },
              {
                kind: "field",
                decorators: [
                  (0, n.Cb)({ attribute: "enable-day", type: Boolean }),
                ],
                key: "enableDay",
                value() {
                  return !1;
              ...
              },
              {
                ...
                value: function () {
                  return (0, o.dy)(
                    d ||
                      (d = l`
      <ha-base-time-input .label=${0} .helper=${0} .required=${0} .clearable=${0} .autoValidate=${0} .disabled=${0} errorMessage="Required" enable-second .enableMillisecond=${0} .enableDay=${0} format="24" .days=${0} .hours=${0} .minutes=${0} .seconds=${0} .milliseconds=${0} @value-changed=${0} no-hours-limit dayLabel="dd" hourLabel="hh" minLabel="mm" secLabel="ss" millisecLabel="ms"></ha-base-time-input>
    `),
                    this.label,
                    this.helper,
                    this.required,
                    !this.required && void 0 !== this.data,
                    this.required,
                    this.disabled,
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  t &&
                    ...
                    t.seconds || (t.seconds = 0),
                    "days" in t && (t.days || (t.days = 0)),
                    "milliseconds" in t &&
                      (t.milliseconds || (t.milliseconds = 0)),
    ...
    19326: function (e, t, i) {
      i.r(t), i.d(t, { HaMediaSelector: () => y });
      var a = i(61701),
        o =
          (i(19083),
          i(71695),
          ...
          return {
            ...
            d: [
                  ...
                  if (e.has("value")) {
                    ...
                    if (o && o.startsWith("/"))
                      (this._thumbnailUrl = void 0),
                        (0, c.iI)(this.hass, o).then((e) => {
                          this._thumbnailUrl = e.path;
                        });
                    else if (
                      o &&
              ...
              },
              {
                ...
                key: "render",
                value: function () {
                  var e, t, i, a, n, d, c, h, u, k;
                  const y =
                      null !== (e = this.value) && void 0 !== e && e.entity_id
                    ...
                    $ =
                      ...
                      (y && (0, l.e)(y, r.yZ.BROWSE_MEDIA));
                  return (0, o.dy)(
                    v ||
                      (v = _`<ha-entity-picker .hass=${0} .value=${0} .label=${0} .disabled=${0} .helper=${0} .required=${0} include-domains='["media_player"]' allow-custom-entity @value-changed=${0}></ha-entity-picker>
      ${0}`),
                    this.hass,
                    ...
                    $
                      ? (0, o.dy)(
                          m ||
                            (m = _`<ha-card outlined @click=${0} class=${0}>
              ...
              ${0}
                  ...
                  `),
                    ...
                    <div class="icon-holder image">
                      <ha-svg-icon class="folder" .path=${0}></ha-svg-icon>
                    </div>
                  `),
                                null !== (c = this.value) &&
                                  void 0 !== c &&
                          ...
                          null !== (u = this.value) &&
                            void 0 !== u &&
                            u.media_content_id
                            ? (null === (k = this.value.metadata) ||
                              void 0 === k
                                ? void 0
                                : k.title) || this.value.media_content_id
                            : this.hass.localize(
            ...
            <ha-form .hass=${0} .data=${0} .schema=${0} .computeLabel=${0}></ha-form>`),
                          this.hass.localize(
              ...
              },
              {
                ...
                value() {
                  return (e) =>
                    this.hass.localize(
                      `ui.components.selectors.media.${e.name}`,
                    );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (0, u.B)(this, {
                    ...
                    navigateIds:
                      null === (e = this.value.metadata) || void 0 === e
                        ? void 0
                        : e.navigateIds,
                    mediaPickedCallback: (e) => {
                      var t;
                      (0, d.B)(this, "value-changed", {
                        value: Object.assign(
                          ...
                          {},
                          {
                            media_content_id: e.item.media_content_id,
                            media_content_type: e.item.media_content_type,
                            metadata: {
                              title: e.item.title,
                              thumbnail: e.item.thumbnail,
                              media_class: e.item.media_class,
                              children_media_class: e.item.children_media_class,
                              navigateIds:
                                null === (t = e.navigateIds) || void 0 === t
                                  ? void 0
                                  : t.map((e) => ({
              ...
              },
              {
                ...
                value() {
                  return [
                    ...
                    (0, d.iv)(
                      r ||
                        (r = h`:host{--mdc-theme-secondary:var(--switch-checked-color)}.mdc-switch.mdc-switch--checked .mdc-switch__thumb{background-color:var(--switch-checked-button-color);border-color:var(--switch-checked-button-color)}.mdc-switch.mdc-switch--checked .mdc-switch__track{background-color:var(--switch-checked-track-color);border-color:var(--switch-checked-track-color)}.mdc-switch:not(.mdc-switch--checked) .mdc-switch__thumb{background-color:var(--switch-unchecked-button-color);border-color:var(--switch-unchecked-button-color)}.mdc-switch:not(.mdc-switch--checked) .mdc-switch__track{background-color:var(--switch-unchecked-track-color);border-color:var(--switch-unchecked-track-color)}`),
                    ),
                  ];
                },
              },
      ...
      const a = {
        ...
        n = {
          ...
          other: {
            ...
            members: { event: {}, service: {}, set_conversation_response: {} },
          },
        },
        s = "__SERVICE__",
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          var o = i(95262),
            ...
            m = i(68418),
            g = e([n, l, r]);
          [n, l, r] = g.then ? (await g)() : g;
          const f = "ui.panel.config.automation.editor.actions.type",
            k = (e, t, i, a, o, n, s = !1) => {
              try {
                const d = _(e, t, i, a, o, n, s);
                if ("string" != typeof d) throw new Error(String(d));
                return d;
              } catch (d) {
                console.error(d);
                let e = "Error in describing action";
                return d.message && (e += ": " + d.message), e;
              }
            },
            _ = (e, t, i, a, g, k, _ = !1) => {
              if (g.alias && !_) return g.alias;
              if ((k || (k = (0, m.Pw)(g)), "service" === k)) {
                const n = g,
                  s = [],
                  r = n.target || n.data;
                if (r)
                  for (const [l, h] of Object.entries({
                    ...
                    for (const o of n) {
                      if ((0, c.J)(o)) {
                        s.push(
                          e.localize(
                            `${f}.service.description.target_template`,
                            { name: h },
                          ),
                        );
                        break;
                      ...
                      if ("entity_id" === l)
                        if (o.includes(".")) {
                          ...
                          i
                            ...
                            ? s.push(
                                e.localize(
                                  `${f}.service.description.target_every_entity`,
                                ),
                              )
                            : s.push(
                                e.localize(
                                  `${f}.service.description.target_unknown_entity`,
                                ),
                              );
                        }
                      else if ("device_id" === l) {
                        ...
                        t
                          ...
                          : s.push(
                              e.localize(
                                `${f}.service.description.target_unknown_device`,
                              ),
                            );
                      } else if ("area_id" === l) {
                        const t = e.areas[o];
                        null != t && t.name
                          ...
                          : s.push(
                              e.localize(
                                `${f}.service.description.target_unknown_area`,
                              ),
                            );
                      } else if ("floor_id" === l) {
                        var b;
                        const t =
                          null !== (b = a[o]) && void 0 !== b ? b : void 0;
                        null != t && t.name
                          ? s.push(t.name)
                          : s.push(
                              e.localize(
                                `${f}.service.description.target_unknown_floor`,
                              ),
                            );
                      } else if ("label_id" === l) {
                        const t = i.find((e) => e.label_id === o);
                        null != t && t.name
                          ? s.push(t.name)
                          : s.push(
                              e.localize(
                                `${f}.service.description.target_unknown_label`,
                              ),
                            );
                      } else s.push(o);
                    }
                  }
                if (n.service_template || (n.action && (0, c.J)(n.action)))
                  return e.localize(
                    s.length
                      ? `${f}.service.description.service_based_on_template`
                      : `${f}.service.description.service_based_on_template_no_targets`,
                    { targets: (0, l.z)(e.locale, s) },
                  );
                if (n.action) {
                  var y;
                  const [t, i] = n.action.split(".", 2),
                    a =
                      e.localize(`component.${t}.services.${i}.name`) ||
                      (null === (y = e.services[t][i]) || void 0 === y
                        ? void 0
                        : y.name);
                  return n.metadata
                    ? e.localize(
                        s.length
                          ? `${f}.service.description.service_name`
                          : `${f}.service.description.service_name_no_targets`,
                        {
                    ...
                    : e.localize(
                        s.length
                          ? `${f}.service.description.service_based_on_name`
                          : `${f}.service.description.service_based_on_name_no_targets`,
                        {
                          name: a
                            ? `${(0, p.Lh)(e.localize, t)}: ${a}`
                            : n.action,
                          targets: (0, l.z)(e.locale, s),
                        },
                      );
                }
                return e.localize(`${f}.service.description.service`);
              }
              if ("delay" === k) {
                const t = g;
                let i;
                return (
                  (i =
                    "number" == typeof t.delay
                      ? e.localize(`${f}.delay.description.duration_string`, {
                          string: (0, s.Z)(t.delay),
                        })
                      : "string" == typeof t.delay
                      ? (0, c.J)(t.delay)
                        ? e.localize(`${f}.delay.description.duration_template`)
                        : e.localize(`${f}.delay.description.duration_string`, {
                            string:
                              t.delay ||
                              e.localize(
                                `${f}.delay.description.duration_unknown`,
                              ),
                          })
                      : t.delay
                      ? e.localize(`${f}.delay.description.duration_string`, {
                          string: (0, n.$k)(e.locale, t.delay),
                        })
                      : e.localize(`${f}.delay.description.duration_string`, {
                          string: e.localize(
                            `${f}.delay.description.duration_unknown`,
                  ...
                  e.localize(`${f}.delay.description.full`, { duration: i })
                );
              }
              if ("play_media" === k) {
                var $;
                const t = g,
                  i =
                    (null === ($ = t.target) || void 0 === $
                      ? void 0
                      : $.entity_id) || t.entity_id,
                  a = i ? e.states[i] : void 0;
                return e.localize(`${f}.play_media.description.full`, {
                  hasMedia:
                    t.metadata.title || t.data.media_content_id
                      ? "true"
                      : "false",
                  media: t.metadata.title || t.data.media_content_id,
                  hasMediaPlayer: a || void 0 !== i ? "true" : "false",
                  mediaPlayer: a ? (0, d.C)(a) : i,
                });
              }
              if ("wait_for_trigger" === k) {
                const t = g,
                  i = (0, o.r)(t.wait_for_trigger);
                return i && 0 !== i.length
                  ? e.localize(
                      `${f}.wait_for_trigger.description.wait_for_triggers`,
                      { count: i.length },
                    )
                  : e.localize(
                      `${f}.wait_for_trigger.description.wait_for_a_trigger`,
                    );
              }
              if ("variables" === k) {
                const t = g;
                return e.localize(`${f}.variables.description.full`, {
              ...
              if ("fire_event" === k) {
                ...
                return (0, c.J)(t.event)
                  ? e.localize(`${f}.event.description.full`, {
                      name: e.localize(`${f}.event.description.template`),
                    })
                  : e.localize(`${f}.event.description.full`, {
                      name: t.event,
                    });
              ...
              if ("wait_template" === k)
                return e.localize(`${f}.wait_template.description.full`);
              if ("stop" === k) {
                const t = g;
                return e.localize(`${f}.stop.description.full`, {
                  hasReason: void 0 !== t.stop ? "true" : "false",
                  reason: t.stop,
                });
              }
              if ("if" === k) {
                return void 0 !== g.else
                  ? e.localize(`${f}.if.description.if_else`)
                  : e.localize(`${f}.if.description.if`);
              }
              if ("choose" === k) {
                const t = g;
                if (t.choose) {
                  const i = (0, o.r)(t.choose).length + (t.default ? 1 : 0);
                  return e.localize(`${f}.choose.description.full`, {
                    number: i,
                  });
                }
                return e.localize(`${f}.choose.description.no_action`);
              }
              if ("repeat" === k) {
                const t = g;
                let i = "";
                if ("count" in t.repeat) {
                  const a = t.repeat.count;
                  i = e.localize(`${f}.repeat.description.count`, { count: a });
                } else if ("while" in t.repeat) {
                  const a = (0, o.r)(t.repeat.while);
                  i = e.localize(`${f}.repeat.description.while_count`, {
                    count: a.length,
                  });
                } else if ("until" in t.repeat) {
                  const a = (0, o.r)(t.repeat.until);
                  i = e.localize(`${f}.repeat.description.until_count`, {
                    count: a.length,
                  });
                } else if ("for_each" in t.repeat) {
                  const a = (0, o.r)(t.repeat.for_each).map((e) =>
                    JSON.stringify(e),
                  );
                  i = e.localize(`${f}.repeat.description.for_each`, {
                    items: (0, l.z)(e.locale, a),
                  });
                }
                return e.localize(`${f}.repeat.description.full`, {
                  chosenAction: i,
                });
              }
              if ("check_condition" === k)
                return e.localize(`${f}.check_condition.description.full`, {
                  condition: (0, r.m)(g, e, t),
                });
              if ("device_action" === k) {
                const i = g;
                if (!i.device_id)
                  return e.localize(`${f}.device_id.description.no_device`);
                const a = (0, h._2)(e, t, i);
                if (a) return a;
                const o = e.states[i.entity_id];
                return `${i.type || "Perform action with"} ${
                  o ? (0, d.C)(o) : i.entity_id
                }`;
              }
              if ("sequence" === k) {
                const t = g,
                  i = (0, o.r)(t.sequence).length;
                return e.localize(`${f}.sequence.description.full`, {
                  number: i,
                });
              }
              if ("parallel" === k) {
                const t = g,
                  i = (0, o.r)(t.parallel).length;
                return e.localize(`${f}.parallel.description.full`, {
                  number: i,
                });
              }
              if ("set_conversation_response" === k) {
                const t = g;
                return (0, c.J)(t.set_conversation_response)
                  ? e.localize(
                      `${f}.set_conversation_response.description.template`,
                    )
                  : e.localize(
                      `${f}.set_conversation_response.description.full`,
                      { response: t.set_conversation_response },
                    );
              }
              return k;
            };
    ...
    9572: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          ...
          var o = i(61701),
            ...
            Z = i(93672),
            j = i(23685),
            P = (i(64384), i(89829), i(26839)),
            q = (i(11519), e([g, f, M, x, A, L, z, B, O, Z, j, P, $]));
          [g, f, M, x, A, L, z, B, O, Z, j, P, $] = q.then ? (await q)() : q;
          let S,
            D,
            R,
            F,
          ...
          const Y =
            ...
            ne = "M8,5.14V19.14L19,12.14L8,5.14Z",
            se =
            ...
            re = (e) => {
              if (e)
                return "action" in e
                  ...
                  ? "condition"
                  : Object.keys(k.du).find((t) => t in e);
            },
            he = (e, t) => {
              var i, a;
              t.stopPropagation();
              const o =
                null === (i = t.target) || void 0 === i ? void 0 : i.name;
              if (!o) return;
              const n =
              ...
              n
                ...
                : ((s = Object.assign({}, e.action)), delete s[o]),
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    decorators: [
                      (0, l.SB)(),
                      (0, n.F_)({ context: b.TD, subscribe: !0 }),
                    ],
                    key: "_labelReg",
                    value: void 0,
                  },
                  {
                    ...
                    decorators: [
                      (0, l.SB)(),
                      (0, n.F_)({ context: b.WC, subscribe: !0 }),
                    ],
                    key: "_floorReg",
                    value: void 0,
                  },
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      const t = re(this.action);
                      (this._uiModeAvailable = void 0 !== t && !k.lL.has(t)),
      ...
      <ha-card outlined>
        ...
        <ha-expansion-panel left-chevron>
          ...
          <ha-md-button-menu slot="icons" @click=${0} @keydown=${0} @closed=${0} positioning="fixed">
            ...
            <ha-md-menu-item .clickAction=${0} .disabled=${0}>
              ${0}
              <ha-svg-icon slot="start" .path=${0}></ha-svg-icon></ha-md-menu-item>
            ...
            <ha-md-menu-item class="warning" .clickAction=${0} .disabled=${0}>
              ${0}
              <ha-svg-icon class="warning" slot="start" .path=${0}></ha-svg-icon>
            </ha-md-menu-item>
          </ha-md-button-menu>
            ...
            `),
                        ...
                        "service" === e &&
                          ...
                          ? (0, d.dy)(
                              R ||
                                (R = J`
                <ha-service-icon slot="leading-icon" class="action-icon" .hass=${0} .service=${0}></ha-service-icon>
              `),
                              this.hass,
                              this.action.action,
                            )
                          : (0, d.dy)(
                              F ||
                                (F = J`
                <ha-svg-icon slot="leading-icon" class="action-icon" .path=${0}></ha-svg-icon>
              `),
                              k.du[e],
                            ),
                        (0, p.f)(
                        ...
                        "condition" !== e &&
                          ...
                          ? (0, d.dy)(
                              U ||
                                (U = J`<ha-tooltip slot="icons" .content=${0}>
                <ha-svg-icon .path=${0}></ha-svg-icon>
                        ...
                        te,
                        this._moveUp,
                        this.disabled || this.first,
                        this.hass.localize(
                          "ui.panel.config.automation.editor.move_up",
                        ),
                        G,
                        this._moveDown,
                        this.disabled || this.last,
                        this.hass.localize(
                        ...
                        this._warnings
                          ? (0, d.dy)(
                              E ||
                                (E = J`<ha-alert alert-type="warning" .title=${0}>
                  ${0}
                  ${0}
                </ha-alert>`),
                              this.hass.localize(
                        ...
                        ${0}
                                    ...
                                    this._warnings.map((e) =>
                                      (0, d.dy)(N || (N = J`<li>${0}</li>`), e),
                                    ),
                                  )
                                : "",
                              this.hass.localize(
                        ...
                        t
                          ? (0, d.dy)(
                              K ||
                                (K = J`
                  ${0}
                  <ha-yaml-editor .hass=${0} .defaultValue=${0} .readOnly=${0} @value-changed=${0}></ha-yaml-editor>
                `),
                              void 0 === e
                                ? (0, d.dy)(
                                    T ||
                      ...
                      `),
                          ...
                          : (0, d.dy)(
                              W ||
                                (W = J`
                  <div @ui-mode-not-available=${0} @value-changed=${0}>
                    ${0}
                  </div>
                `),
                              this._handleUiModeNotAvailable,
                              this._onUiChanged,
                              (0, h.h)(`ha-automation-action-${e}`, {
                                hass: this.hass,
                                action: this.action,
                                narrow: this.narrow,
                  ...
                  },
                  {
                    ...
                    value() {
                      return async () => {
                        const e = await (0, _.w)(this.hass, {
                          actions: this.action,
                        });
                        if (e.actions.valid) {
                          try {
                            await (0, C.n)(this.hass, this.action);
                          } catch (t) {
                            return void (0, V.showAlertDialog)(this, {
                  ...
                  },
                  {
                    ...
                    value() {
                      return () => {
                        (0, V.showConfirmationDialog)(this, {
                          title: this.hass.localize(
                  ...
                  },
                  {
                    ...
                    value() {
                      return async () => {
                        const e = await (0, V.showPromptDialog)(this, {
                          title: this.hass.localize(
                        ...
                        if (null !== e) {
                          const i = Object.assign({}, this.action);
                          var t;
                          if (
      ...
      i.a(e, async function (e, t) {
        try {
          var a = i(61701),
            ...
            h = i(62201),
            u = i(76320),
            v = (i(59826), i(62801), i(37583), i(41422)),
            p = i(40159),
            m = i(9572),
            g = e([m]);
          ...
          const $ =
            ...
            C = "M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z";
          (0, a.Z)(
            [(0, d.Mo)("ha-automation-action")],
            function (e, t) {
              class i extends t {
                constructor(...t) {
                  super(...t), e(this);
              ...
              return {
                ...
                d: [
                  ...
                  { kind: "field", key: "_unsubMql", value: void 0 },
                  {
                    kind: "method",
                    key: "connectedCallback",
                    value: function () {
                      (0, o.Z)(i, "connectedCallback", this, 3)([]),
                        (this._unsubMql = (0, h.K)(
                          "(min-width: 600px)",
                          (e) => {
                            this._showReorder = e;
                          },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      (0, o.Z)(i, "disconnectedCallback", this, 3)([]),
                        null === (e = this._unsubMql) ||
                          void 0 === e ||
                          e.call(this),
                        (this._unsubMql = void 0);
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: function () {
                      return (0, s.dy)(
                        f ||
                          (f = y`
      <ha-sortable handle-selector=".handle" draggable-selector="ha-automation-action-row" .disabled=${0} group="actions" invert-swap @item-moved=${0} @item-added=${0} @item-removed=${0}>
        <div class="actions">
          ${0}
          <div class="buttons">
            <ha-button outlined .disabled=${0} .label=${0} @click=${0}>
              <ha-svg-icon .path=${0} slot="icon"></ha-svg-icon>
            </ha-button>
            <ha-button .disabled=${0} .label=${0} @click=${0}>
              <ha-svg-icon .path=${0} slot="icon"></ha-svg-icon>
            </ha-button>
          </div>
        </div>
    ...
    `),
                        ...
                        (0, l.r)(
                          ...
                          (e, t) =>
                            (0, s.dy)(
                              k ||
                                (k = y`
              <ha-automation-action-row .sortableData=${0} .index=${0} .first=${0} .last=${0} .action=${0} .narrow=${0} .disabled=${0} @duplicate=${0} @move-down=${0} @move-up=${0} @value-changed=${0} .hass=${0}>
                ${0}
            ...
            `),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      this.shadowRoot
                        .querySelectorAll("ha-automation-action-row")
                        .forEach((e) => {
                          e.expand();
                        });
                    },
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      e.stopPropagation();
                      const { index: t, data: i } = e.detail,
                        a = [
                          ...this.actions.slice(0, t),
                          i,
                          ...this.actions.slice(t),
                        ];
                      (this.actions = a),
                        await (0, u.y)(),
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      const { index: t } = e.detail,
                        i = this.actions[t];
                      (this.actions = this.actions.filter((e) => e !== i)),
                        await (0, u.y)();
                      const a = this.actions.filter((e) => e !== i);
                      (0, r.B)(this, "value-changed", { value: a });
                    },
                  },
                  {
                    kind: "method",
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      const t = e.target.index;
                      (0, r.B)(this, "value-changed", {
                        value: this.actions.concat((0, n.Z)(this.actions[t])),
                      });
                    },
                  },
                  {
                    ...
                    value() {
                      return (0, s.iv)(
                        b ||
                          (b = y`.actions{padding:16px;margin:-16px;display:flex;flex-direction:column;gap:16px}.sortable-ghost{background:0 0;border-radius:var(--ha-card-border-radius,12px)}.sortable-drag{background:0 0}ha-automation-action-row{display:block;scroll-margin-top:48px}ha-svg-icon{height:20px}.handle{padding:12px;cursor:move;cursor:grab}.handle ha-svg-icon{pointer-events:none;height:24px}.buttons{display:flex;flex-wrap:wrap;gap:8px;order:1}`),
                      );
                    },
                  },
                ],
      ...
      i.a(e, async function (e, t) {
        try {
          ...
          let u,
            ...
            g = (e) => e;
          (0, a.Z)(
            [(0, n.Mo)("ha-automation-action-choose")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      const e = this.action,
                        t = e.choose ? (0, s.r)(e.choose) : [];
                      return (0, o.dy)(
                        u ||
                          (u = g`
      <ha-automation-option .options=${0} .disabled=${0} @value-changed=${0} .hass=${0}></ha-automation-option>
    ...
    `),
            ...
            <ha-automation-action .actions=${0} .disabled=${0} @value-changed=${0} .hass=${0}></ha-automation-action>
          `),
                              this.hass.localize(
            ...
            <div class="link-button-row">
              <button class="link" @click=${0} .disabled=${0}>
                ${0}
              </button>
            </div>
          `),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        l.Qx,
                        (0, o.iv)(
                          m || (m = g`.link-button-row{padding:14px 14px 0}`),
                        ),
                      ];
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (0, o.dy)(
                        u ||
                          (u = m`
      <ha-select fixedMenuPosition .label=${0} .disabled=${0} .value=${0} naturalMenuWidth @selected=${0}>
        ${0}
      </ha-select>
      <ha-automation-condition-editor .condition=${0} .disabled=${0} .hass=${0} @value-changed=${0}></ha-automation-condition-editor>
    `),
                        this.hass.localize(
            ...
            <mwc-list-item .value=${0} graphic="icon">
              ${0}<ha-svg-icon slot="graphic" .path=${0}></ha-svg-icon></mwc-list-item>
          `),
                              e,
                              t,
                              i,
                    ...
                    value() {
                      return (0, s.Z)((e) =>
                        Object.entries(c.L)
                          ...
                          .sort((e, t) =>
                            (0, l.$K)(e[1], t[1], this.hass.locale.language),
                          ),
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      t !== this.action.condition &&
                        (0, d.B)(this, "value-changed", {
                          value: Object.assign({}, i.defaultConfig),
                        });
                    },
                  },
                  {
                    ...
                    value() {
                      return (0, o.iv)(
                        p || (p = m`ha-select{margin-bottom:24px}`),
                      );
                    },
                  },
                ],
    ...
    16356: function (e, t, i) {
      var a = i(61701),
        o = (i(52247), i(71695), i(19423), i(47021), i(57243)),
        n = i(50778),
        s = i(36522),
        d = i(54e3),
        l = (i(58381), i(35392));
            ...
            d: [
              ...
              },
              {
                ...
                value: function () {
                  return (0, o.dy)(
                    c ||
                      (c = r`<ha-duration-input .label=${0} .disabled=${0} .data=${0} enable-millisecond required @value-changed=${0}></ha-duration-input>`),
                    this.hass.localize(
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    decorators: [
                      (0, s.SB)(),
                      (0, o.F_)({ context: r.we, subscribe: !0 }),
                    ],
                    key: "_entityReg",
                    value: void 0,
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (0, n.dy)(
                        v ||
                          (v = g`
      <ha-device-picker .value=${0} .disabled=${0} @value-changed=${0} .hass=${0} label=${0}></ha-device-picker>
      <ha-device-action-picker .value=${0} .deviceId=${0} .disabled=${0} @value-changed=${0} .hass=${0} label=${0}></ha-device-action-picker>
      ${0}
    `),
                        t,
                        this.disabled,
                        ...
                        null !== (e = this._capabilities) &&
                          ...
                          ? (0, n.dy)(
                              p ||
                                (p = g`
            <ha-form .hass=${0} .data=${0} .schema=${0} .disabled=${0} .computeLabel=${0} .computeHelper=${0} @value-changed=${0}></ha-form>
          `),
                              this.hass,
                              ...
                              this.disabled,
                              (0, h.kJ)(this.hass, this.action),
                              (0, h.Md)(this.hass, this.action),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      t &&
                        !(0, h.hH)(this._entityReg, t, this.action) &&
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      this._capabilities = this.action.domain
                        ? await (0, h._K)(this.hass, this.action)
                        : void 0;
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      this._origAction &&
                        (0, h.hH)(this._entityReg, this._origAction, t) &&
                        (t = this._origAction),
                  ...
                  },
                  {
                    ...
                    value() {
                      return (0, n.iv)(
                        m ||
                          (m = g`ha-device-action-picker,ha-form{display:block}ha-device-picker{display:block;margin-bottom:24px}ha-form{margin-top:24px}`),
                      );
                    },
                  },
                ],
      ...
      i.a(e, async function (e, t) {
        try {
          var a = i(61701),
            ...
            d = i(58725),
            l = i(46179),
            c = (i(83166), i(64889), i(9572)),
            r = e([d, l, c]);
          [d, l, c] = r.then ? (await r)() : r;
          let h,
            u,
            v = (e) => e;
          (0, a.Z)(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (0, o.dy)(
                        h ||
                          (h = v`
      <ha-textfield .label=${0} .value=${0} .disabled=${0} @change=${0}></ha-textfield>
      <ha-yaml-editor .hass=${0} .label=${0} .name=${0} .readOnly=${0} .defaultValue=${0} @value-changed=${0}></ha-yaml-editor>
    `),
                        this.hass.localize(
                  ...
                  },
                  {
                    ...
                    value() {
                      return (0, o.iv)(
                        u || (u = v`ha-textfield{display:block}`),
                      );
                    },
                  },
                ],
    ...
    15661: function (e, t, i) {
      ...
      <ha-automation-condition .conditions=${0} .disabled=${0} @value-changed=${0} .hass=${0}></ha-automation-condition>
              ...
              ${0}
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        d.Qx,
                        (0, o.iv)(v || (v = p`.link-button-row{padding:14px}`)),
                      ];
                    },
                  },
                ],
              ...
              },
              {
                ...
                value: function () {
                  return (0, o.dy)(
                    l ||
                      (l = c`
      <ha-selector-media .hass=${0} .disabled=${0} .value=${0} @value-changed=${0}></ha-selector-media>
    `),
                    this.hass,
                    this.disabled,
                      ...
                      value: Object.assign(
                        ...
                        {},
                        {
                          ...
                          data: {
                            ...
                            media_content_type:
                              e.detail.value.media_content_type,
                          },
      ...
      i.a(e, async function (e, t) {
        try {
          ...
          let u,
            v,
            p = (e) => e;
          const m = ["count", "while", "until", "for_each"],
            g = (e) => m.find((t) => t in e);
          (0, a.Z)(
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (0, o.dy)(
                        u ||
                          (u = p`<ha-form .hass=${0} .data=${0} .schema=${0} .disabled=${0} @value-changed=${0} .computeLabel=${0}></ha-form>`),
                        this.hass,
                        a,
                        i,
                        this.disabled,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        l.Qx,
                        (0, o.iv)(v || (v = p`ha-textfield{margin-top:16px}`)),
                      ];
                    },
                  },
                  {
      ...
      i.a(e, async function (e, t) {
        try {
          ...
          let r,
            h = (e) => e;
          (0, a.Z)(
            [(0, n.Mo)("ha-automation-action-sequence")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (!e.has("action")) return;
                      try {
                        (0, d.hu)(this.action, v.TL);
                      } catch (a) {
                        return void (0, l.B)(this, "ui-mode-not-available", a);
                      }
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      const [i, a] = this._action.action
                        ? this._action.action.split(".", 2)
                        : [void 0, void 0];
                      return (0, o.dy)(
                        m ||
                          (m = b`
      <ha-service-control .narrow=${0} .hass=${0} .value=${0} .disabled=${0} .showAdvanced=${0} .hidePicker=${0} @value-changed=${0}></ha-service-control>
      ${0}
    `),
                        this.narrow,
                        this.hass,
                        ...
                        i &&
                          ...
                          ? (0, o.dy)(
                              g ||
                                (g = b`<ha-settings-row .narrow=${0}>
            ${0}
            <span slot="heading">${0}</span>
            <span slot="description">
              ${0}
            </span>
            <ha-textfield .value=${0} .required=${0} .disabled=${0} @change=${0}></ha-textfield>
          </ha-settings-row>`),
                              this.narrow,
                              this.hass.services[i][a].response.optional
                                ? (0, o.dy)(
                                    f ||
                                      (f = b`<ha-checkbox .checked=${0} .disabled=${0} @change=${0} slot="prefix"></ha-checkbox>`),
                                ...
                                : (0, o.dy)(
                                    k ||
                                      (k = b`<div slot="prefix" class="checkbox-spacer"></div>`),
                                  ),
                              this.hass.localize(
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        ...
                        const e = Object.assign({}, this.action);
    ...
    64384: function (e, t, i) {
      ...
      let s,
        d = (e) => e;
      const l = [
        { name: "set_conversation_response", selector: { template: {} } },
      ];
      (0, a.Z)(
        [(0, n.Mo)("ha-automation-action-set_conversation_response")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
              ...
              },
              {
                ...
                value: function () {
                  return (0, o.dy)(
                    s ||
                      (s = d`
      <ha-form .hass=${0} .data=${0} .schema=${0} .disabled=${0} .computeLabel=${0}></ha-form>
    `),
                    this.hass,
                    this.action,
                    l,
    ...
    89829: function (e, t, i) {
      var a = i(61701),
        o = (i(71695), i(19423), i(47021), i(57243)),
        n = i(50778),
        s = i(36522);
      i(83166), i(55486), i(1888);
      let d,
        l,
        c = (e) => e;
      (0, a.Z)(
      ...
      <ha-textfield .label=${0} .value=${0} .disabled=${0} @change=${0}></ha-textfield>
      <ha-textfield .label=${0} .value=${0} .disabled=${0} @change=${0}></ha-textfield>
      <ha-formfield .disabled=${0} .label=${0}>
    ...
    `),
              ...
              },
              {
                ...
                value() {
                  return (0, o.iv)(
                    l ||
                      (l = c`ha-textfield{display:block;margin-bottom:24px}`),
                  );
                },
              },
            ],
      ...
      i.a(e, async function (e, t) {
        try {
          var a = i(61701),
            ...
            d = i(35392),
            l = i(36522),
            c = (i(58381), i(55486), i(83166), i(79805)),
            r = i(9572),
            h = e([c, r]);
          [c, r] = h.then ? (await h)() : h;
          let u,
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e;
                      const t = (0, d.c)(this.action.timeout);
                      return (0, o.dy)(
                        u ||
                          (u = p`
      <ha-duration-input .label=${0} .data=${0} .disabled=${0} enable-millisecond @value-changed=${0}></ha-duration-input>
      <ha-formfield .disabled=${0} .label=${0}>
        <ha-switch .checked=${0} .disabled=${0} @change=${0}></ha-switch>
      </ha-formfield>
      <ha-automation-trigger .triggers=${0} .hass=${0} .disabled=${0} .name=${0} @value-changed=${0}></ha-automation-trigger>
    `),
                        this.hass.localize(
                        ...
                        (0, s.r)(this.action.wait_for_trigger),
                        this.hass,
                        this.disabled,
                        "wait_for_trigger",
                        this._valueChanged,
                  ...
                  },
                  {
                    ...
                    value() {
                      return (0, o.iv)(
                        v ||
                          (v = p`ha-duration-input{display:block;margin-bottom:24px}ha-automation-trigger{display:block;margin-top:24px}`),
                      );
                    },
                  },
                ],
    ...
    11690: function (e, t, i) {
      i.a(e, async function (e, t) {
        try {
          var a = i(61701),
            o = (i(71695), i(19423), i(40251), i(47021), i(60738)),
            n = (i(87319), i(57243)),
            s = i(50778),
            d = i(95262),
            l = i(36522),
            ...
            r = i(49976),
            h = i(87733),
            u = (i(34273), i(54977), i(41307), i(23334), i(93831)),
            v = i(40928),
            p = i(17551),
            m = i(30635),
            g = i(76131),
          ...
          const $ =
            ...
            M =
              "M18,17H10.5L12.5,15H18M6,17V14.5L13.88,6.65C14.07,6.45 14.39,6.45 14.59,6.65L16.35,8.41C16.55,8.61 16.55,8.92 16.35,9.12L8.47,17M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z";
          (0, a.Z)(
            [(0, s.Mo)("ha-automation-option-row")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    decorators: [
                      (0, s.SB)(),
                      (0, o.F_)({ context: m.we, subscribe: !0 }),
                    ],
                    key: "_entityReg",
                    value: void 0,
                  },
                  ...
                  },
                  {
                    ...
                    key: "_getDescription",
                    value: function () {
                      const e = (0, d.r)(this.option.conditions);
                      if (!e || 0 === e.length)
                        return this.hass.localize(
                      ...
                      return this.option
                        ? (0, n.dy)(
                            _ ||
                              (_ = y`
      <ha-card outlined>
        <ha-expansion-panel left-chevron @expanded-changed=${0} id="option">
          <h3 slot="header">
            ${0}:
            ${0}
          </h3>
          ...
          <ha-button-menu slot="icons" @action=${0} @click=${0} @closed=${0} fixed>
            <ha-icon-button slot="trigger" .label=${0} .path=${0}></ha-icon-button>
            ...
            <mwc-list-item class="warning" graphic="icon" .disabled=${0}>
              ${0}
          ...
          <div class="card-content">
            ...
            <ha-automation-condition .conditions=${0} .disabled=${0} .hass=${0} @value-changed=${0}></ha-automation-condition>
            <h4>
              ${0}:
            </h4>
            <ha-automation-action .actions=${0} .disabled=${0} .hass=${0} @value-changed=${0}></ha-automation-action>
          </div>
        </ha-expansion-panel>
      </ha-card>
    `),
                    ...
                    value: async function (e) {
                      switch (e.detail.index) {
                        case 0:
                          ...
                          break;
                        case 1:
                          (0, l.B)(this, "duplicate");
                          break;
                        case 2:
                          (0, l.B)(this, "move-up");
                          break;
                        case 3:
                          (0, l.B)(this, "move-down");
                          break;
                        case 4:
                          this._removeOption();
                      }
                  ...
                  },
                  {
                    ...
                    key: "_removeOption",
                    value: function () {
                      (0, g.showConfirmationDialog)(this, {
                        title: this.hass.localize(
                        ...
                        destructive: !0,
                        confirm: () =>
                          (0, l.B)(this, "value-changed", { value: null }),
                      });
                    },
                  },
                  {
                    ...
                    key: "_renameOption",
                    value: async function () {
                      const e = await (0, g.showPromptDialog)(this, {
                        title: this.hass.localize(
                        ...
                        inputType: "string",
                        placeholder: (0, h.f)(this._getDescription()),
                        defaultValue: this.option.alias,
                        confirmText: this.hass.localize("ui.common.submit"),
                      });
                      if (null !== e) {
                        const t = Object.assign({}, this.option);
                        "" === e ? delete t.alias : (t.alias = e),
                          (0, l.B)(this, "value-changed", { value: t });
                      }
                    },
                  },
      ...
      i.a(e, async function (e, t) {
        try {
          var a = i(61701),
            ...
            h = i(62201),
            u = i(76320),
            v = (i(59826), i(62801), i(37583), i(11690)),
            p = e([v]);
          ...
          const b =
              "M7,19V17H9V19H7M11,19V17H13V19H11M15,19V17H17V19H15M7,15V13H9V15H7M11,15V13H13V15H11M15,15V13H17V15H15M7,11V9H9V11H7M11,11V9H13V11H11M15,11V9H17V11H15M7,7V5H9V7H7M11,7V5H13V7H11M15,7V5H17V7H15Z",
            y = "M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z";
          (0, a.Z)(
            [(0, d.Mo)("ha-automation-option")],
            function (e, t) {
              class i extends t {
                constructor(...t) {
                  super(...t), e(this);
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (0, s.dy)(
                        m ||
                          (m = _`
      <ha-sortable handle-selector=".handle" draggable-selector="ha-automation-option-row" .disabled=${0} group="options" invert-swap @item-moved=${0} @item-added=${0} @item-removed=${0}>
        <div class="options">
          ${0}
          <div class="buttons">
            <ha-button outlined .disabled=${0} .label=${0} @click=${0}>
                        ...
                        (0, l.r)(
                          ...
                          (e, t) =>
                            (0, s.dy)(
                              g ||
                                (g = _`
              <ha-automation-option-row .sortableData=${0} .index=${0} .first=${0} .last=${0} .option=${0} .narrow=${0} .disabled=${0} @duplicate=${0} @move-down=${0} @move-up=${0} @value-changed=${0} .hass=${0}>
                ${0}
            ...
            `),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (
                        ((0, o.Z)(i, "updated", this, 3)([e]),
                        e.has("options") && this._focusLastOptionOnChange)
                      ) {
                        this._focusLastOptionOnChange = !1;
                        const e = this.shadowRoot.querySelector(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      this.shadowRoot
                        .querySelectorAll("ha-automation-option-row")
                        .forEach((e) => {
                          e.expand();
                        });
                    },
                  },
                  {
                    ...
                    value() {
                      return () => {
                        const e = this.options.concat({
                          conditions: [],
                          sequence: [],
                        });
                        (this._focusLastOptionOnChange = !0),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      return (
                        this._optionsKeys.has(e) ||
                          this._optionsKeys.set(e, Math.random().toString()),
                        this._optionsKeys.get(e)
                      );
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      const { index: t, data: i } = e.detail,
                        a = [
                          ...this.options.slice(0, t),
                          i,
                          ...this.options.slice(t),
                        ];
                      (this.options = a),
                        await (0, u.y)(),
                        (0, r.B)(this, "value-changed", {
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      const { index: t } = e.detail,
                        i = this.options[t];
                      (this.options = this.options.filter((e) => e !== i)),
                        await (0, u.y)();
                      const a = this.options.filter((e) => e !== i);
                      (0, r.B)(this, "value-changed", { value: a });
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (null === i) t.splice(a, 1);
                        ...
                        const e = this._getKey(t[a]);
                        this._optionsKeys.set(i, e), (t[a] = i);
                      }
                      (0, r.B)(this, "value-changed", { value: t });
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      const t = e.target.index;
                      (0, r.B)(this, "value-changed", {
                        value: this.options.concat((0, n.Z)(this.options[t])),
                      });
                    },
                  },
                  {
                    ...
                    value() {
                      return (0, s.iv)(
                        k ||
                          (k = _`.options{padding:16px;margin:-16px;display:flex;flex-direction:column;gap:16px}.sortable-ghost{background:0 0;border-radius:var(--ha-card-border-radius,12px)}.sortable-drag{background:0 0}ha-automation-option-row{display:block;scroll-margin-top:48px}ha-svg-icon{height:20px}.handle{padding:12px;cursor:move;cursor:grab}.handle ha-svg-icon{pointer-events:none;height:24px}.buttons{display:flex;flex-wrap:wrap;gap:8px;order:1}`),
                      );
                    },
                  },
                ],
...
//# sourceMappingURL=31674.60ef98b09fed8589.js.map
