...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["74347"],
  {
    ...
    68325: function (e, t, i) {
      ...
      const h = {
          key: "Mod-s",
          run: (e) => ((0, s.B)(e.dom, "editor-save"), !0),
        },
        u = (e) => {
          ...
          return {
            ...
            d: [
              ...
              },
              {
                kind: "field",
                decorators: [
                  (0, d.Cb)({ attribute: "read-only", type: Boolean }),
                ],
                key: "readOnly",
                value() {
                  return !1;
              ...
              },
              {
                kind: "field",
                decorators: [
                  (0, d.Cb)({ type: Boolean, attribute: "autocomplete-icons" }),
                ],
                ...
                value() {
                  return (e) => {
                    e.docChanged &&
                      ...
                      (0, s.B)(this, "value-changed", { value: this._value }));
                  };
                },
              },
              {
              ...
              },
              {
                ...
                value() {
                  return (0, r.iv)(
                    l ||
                      (l = f`:host(.error-state) .cm-gutters{border-color:var(--error-state-color,red)}`),
                  );
                },
              },
            ],
      ...
      const u = JSON.parse(
        ...
        b = (0, f.Z)(async () => {
          const e = (0, l.MT)("hass-icon-db", "mdi-icon-store");
          {
            ...
            t
              ? t !== u.version &&
                (await (0, l.ZH)(e), (0, l.t8)("_version", u.version, e))
              : (0, l.t8)("_version", u.version, e);
          }
          return e;
        }),
                ...
                value: function () {
                  return this.icon
                    ? this._legacy
                      ? (0, r.dy)(
                          p ||
                            (p = _`<!-- @ts-ignore we don't provide the iron-icon element -->
        <iron-icon .icon=${0}></iron-icon>`),
              ...
              },
              {
                ...
                value: async function () {
                  ...
                  if (r in M) return void (this._path = M[r]);
                  if ("home-assistant" === r) {
                    const t = (await i.e("48348").then(i.bind(i, 30511)))
                      .mdiHomeAssistant;
                    return this.icon === e && (this._path = t), void (M[r] = t);
                  }
                  try {
                    a = await ((e) =>
                      new Promise((t, i) => {
                  ...
                  if (a)
                    return this.icon === e && (this._path = a), void (M[r] = a);
                  const d = ((e) => {
                    let t;
                  ...
                  if (d in C) return void this._setPath(C[d], r, e);
                  const s = fetch(`/static/mdi/${d}.json`).then((e) =>
                    e.json(),
                  );
                  (C[d] = s), this._setPath(s, r, e), w();
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                value: async function (e, t, i) {
                  const o = await e;
                  this.icon === i && (this._path = o[t]), (M[t] = o[t]);
                },
              },
              {
                kind: "field",
                ...
                key: "styles",
                value() {
                  return (0, r.iv)(k || (k = _`:host{fill:currentcolor}`));
                },
              },
            ],
          };
            ...
            d: [
              ...
              },
              {
                ...
                value() {
                  return (0, a.iv)(
                    n ||
                      (n = s`:host{display:block;color:var(--mdc-text-field-label-ink-color,rgba(0,0,0,.6));font-size:.75rem;padding-left:16px;padding-right:16px;padding-inline-start:16px;padding-inline-end:16px}`),
                  );
                },
              },
            ],
    ...
    12234: function (e, t, i) {
      i.r(t), i.d(t, { HaTemplateSelector: () => m });
      var o = i(61701),
        a = (i(19083), i(71695), i(61006), i(47021), i(57243)),
        r = i(50778),
        d = i(36522),
        n = i(73192);
      i(68325), i(34363), i(99426);
      let s,
        c,
        l,
        f,
        h,
        u = (e) => e;
      const b = ["template:", "sensor:", "state:", "trigger: template"];
      let m = (0, o.Z)(
        [(0, r.Mo)("ha-selector-template")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
      ...
      ${0}
      ${0}
      <ha-code-editor mode="jinja2" .hass=${0} .value=${0} .readOnly=${0} autofocus autocomplete-entities autocomplete-icons @value-changed=${0} dir="ltr" linewrap></ha-code-editor>
      ${0}
    `),
                    this.warn
                      ? (0, a.dy)(
                          c ||
                            (c = u`<ha-alert alert-type="warning">${0}
            <br/>
            <a target="_blank" rel="noopener noreferrer" href=${0}>${0}</a></ha-alert>`),
                          this.hass.localize(
                    ...
                    this.helper
                      ? (0, a.dy)(
                          f ||
                            (f = u`<ha-input-helper-text>${0}</ha-input-helper-text>`),
                          this.helper,
                        )
                      : a.Ld,
                  );
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  this.value !== t &&
                    ((this.warn = b.find((e) => t.includes(e))),
              ...
              },
              {
                ...
                key: "styles",
                value() {
                  return (0, a.iv)(h || (h = u`p{margin-top:0}`));
                },
              },
            ],
          };
    ...
    80654: function (e, t, i) {
      ...
      const d = new Proxy(r.customIcons, {
        get: (e, t) => {
          var i;
    ...
    27608: function (e, t, i) {
      ...
      function a(e, t) {
        ...
        const a = o(i);
        return (e, i) => a.then((o) => i(o.transaction(t, e).objectStore(t)));
      }
      let r;
      function d() {
      ...
      function s(e, t, i = d()) {
        return i("readwrite", (i) => (i.put(t, e), o(i.transaction)));
      }
      function c(e = d()) {
        return e("readwrite", (e) => (e.clear(), o(e.transaction)));
      }
    },
  },
]);
//# sourceMappingURL=74347.043b46597186f938.js.map
