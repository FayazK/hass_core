...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["32294"],
  {
          ...
          return {
            ...
            d: [
              ...
              },
              {
                ...
                key: "render",
                value: function () {
                  if (!this.person) return n.Ld;
                  const e = this.person.picture;
                  if (e)
                    return (0, n.dy)(
                      l || (l = p`<div style=${0} class="picture"></div>`),
                      (0, r.V)({
                        backgroundImage: `url(${this.hass.hassUrl(e)})`,
                      }),
                    );
                  const t = (0, d.fm)(this.person.name);
                  return (0, n.dy)(
                    c ||
                      (c = p`<div class="initials ${0}">
      ${0}
    </div>`),
                    (0, s.$)({ long: t.length > 2 }),
                    t,
              ...
              },
              {
                ...
                value() {
                  return (0, n.iv)(
                    h ||
                      (h = p`:host{width:40px;height:40px;display:block}.initials,.picture{width:100%;height:100%;border-radius:50%}.picture{background-size:cover}.initials{display:inline-flex;justify-content:center;align-items:center;box-sizing:border-box;background-color:var(--light-primary-color);text-decoration:none;color:var(--text-light-primary-color,var(--primary-text-color));overflow:hidden;font-size:var(--person-badge-font-size, 1em)}.initials.long{font-size:80%}`),
                  );
                },
              },
            ],
    ...
    69497: function (e, t, i) {
      i.d(t, { HD: () => a, jt: () => s, oO: () => n, p6: () => o });
      i(19423);
      const a = (e) => e.callWS({ type: "person/list" }),
        n = (e, t) => e.callWS(Object.assign({ type: "person/create" }, t)),
        o = (e, t, i) =>
          e.callWS(Object.assign({ type: "person/update", person_id: t }, i)),
        s = (e, t) => e.callWS({ type: "person/delete", person_id: t });
    },
    4242: function (e, t, i) {
      i.d(t, {
        CE: () => n,
    ...
    `),
            ...
            ${0}
                ...
                `),
                        ...
                        this.message
                          ? (0, o.dy)(
                              f || (f = g`<div id="loading-text">${0}</div>`),
                              this.message,
                            )
                          : o.Ld,
                      );
    ...
    76429: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          i.r(t), i.d(t, { HaConfigPerson: () => P });
          var n = i(61701),
            o = i(72621),
            s =
              (i(19083),
            ...
            r = i(50778),
            d = i(1416),
            l = (i(54977), i(20130), i(37583), i(7285), i(93678), i(69497)),
            c = i(4242),
            h = i(76131),
            p = i(75375),
            u = (i(97546), i(73192)),
          ...
          let v,
            ...
            $,
            C = (e) => e;
          const z = "M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z";
          let P = (0, n.Z)(
            [(0, r.Mo)("ha-config-person")],
            function (e, t) {
              class i extends t {
                constructor(...t) {
                  super(...t), e(this);
              ...
              return {
                ...
                d: [
                  ...
                  { kind: "field", key: "_usersLoad", value: void 0 },
                  {
                    kind: "method",
                    key: "render",
                    value: function () {
                      if (
                        ...
                        return (0, s.dy)(
                          v ||
                            (v = C` <hass-loading-screen></hass-loading-screen> `),
                        );
                      const e = this.hass;
                      return (0, s.dy)(
                        y ||
                          (y = C`
      <hass-tabs-subpage .hass=${0} .narrow=${0} .route=${0} back-path="/config" .tabs=${0}>
    ...
    `),
                        ...
                        this.narrow,
                        this.route,
                        f.configSections.persons,
                        this.isWide,
                        e.localize("ui.panel.config.person.caption"),
                ...
                `),
                          ...
                          : "",
                        (0, u.R)(this.hass, "/integrations/person/"),
                        this.hass.localize("ui.panel.config.person.learn_more"),
                        this._storageItems.map((e) =>
                          (0, s.dy)(
                            k ||
                              (k = C`
                  <ha-list-item graphic="avatar" @click=${0} .entry=${0}>
                    <ha-person-badge .hass=${0} .person=${0} slot="graphic"></ha-person-badge>
                    <span>${0}</span>
                  </ha-list-item>
                `),
                            this._openEditEntry,
              ...
              `),
                      ...
                      `),
                          ...
                          : s.Ld,
                        e.localize("ui.panel.config.person.add_person"),
                        this._createPerson,
                        z,
                      );
                    },
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      this._usersLoad = (0, c.uh)(this.hass);
                      const e = await (0, l.HD)(this.hass);
                      (this._storageItems = e.storage.sort((e, t) =>
                        (0, d.$K)(e.name, t.name, this.hass.locale.language),
                      )),
                        (this._configItems = e.config.sort((e, t) =>
                          (0, d.$K)(e.name, t.name, this.hass.locale.language),
                        )),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      const e = this.route.path.split("/edit/"),
                        t = e.length > 1 ? e[1] : null;
                      if (!t) return;
                      const i = this._storageItems.find((e) => e.id === t);
                      var a, n;
                      i
                        ? this._openDialog(i)
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      const i = new Set();
                      for (const n of [this._configItems, this._storageItems])
                        for (const e of n) e.user_id && i.add(e.user_id);
                      const a = t ? t.user_id : void 0;
                      return e.filter((e) => e.id === a || !i.has(e.id));
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: async function (e) {
                      const t = await this._usersLoad;
                      (0, m.D)(this, {
                        entry: e,
                        users: this._allowedUsers(t, e),
                        createEntry: async (e) => {
                          const t = await (0, l.oO)(this.hass, e);
                        ...
                        updateEntry: async (t) => {
                          const i = await (0, l.p6)(this.hass, e.id, t);
                          this._storageItems = this._storageItems.map((t) =>
                            t === e ? i : t,
                          );
                        },
                        removeEntry: async () => {
                  ...
                  },
                  {
                    ...
                    value() {
                      return (0, s.iv)(
                        $ ||
                          ($ = C`a{color:var(--primary-color)}ha-card{max-width:600px;margin:16px auto;overflow:hidden}.empty{padding:8px;display:flex;align-items:center;justify-content:space-around}mwc-list:has(+ .empty){display:none}`),
                      );
                    },
                  },
                ],
...
//# sourceMappingURL=32294.03bf026db763ff27.js.map
