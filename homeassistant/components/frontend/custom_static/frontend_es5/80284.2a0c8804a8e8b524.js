/*! For license information please see 80284.2a0c8804a8e8b524.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend =
  ...
  ["80284"],
  {
    ...
    93958: function (e, t, i) {
      ...
      (s.styles = [r.W]),
        (s = (0, o.__decorate)([(0, a.Mo)("mwc-checkbox")], s));
      var l = i(57243),
        d = i(35359),
        c = i(65703);
      let h,
    ...
    `),
              ...
              },
              {
                ...
                value() {
                  return (0, a.iv)(
                    l ||
                      (l = d`rect{height:100%}rect:first-child{width:100%;fill:var(--ha-bar-background-color,var(--secondary-background-color))}rect:last-child{fill:var(--ha-bar-primary-color,var(--primary-color))}svg{border-radius:var(--ha-bar-border-radius,4px);height:12px;width:100%}`),
                  );
                },
              },
            ],
            ...
            d: [
              {
                ...
                value: async function (e) {
                  (0, a.Z)(i, "onChange", this, 3)([e]), (0, c.B)(this, e.type);
                },
              },
              {
                kind: "field",
...
`),
    ...
    `),
              ...
              },
              {
                ...
                value() {
                  return (0, a.iv)(
                    d ||
                      (d = c`ha-settings-row{padding:0;height:54px;width:100%}ha-settings-row>div[slot=description]{white-space:normal;color:var(--secondary-text-color);display:flex;justify-content:space-between}ha-bar{--ha-bar-primary-color:var(--metric-bar-ok-color, var(--success-color))}.target-warning{--ha-bar-primary-color:var(
      ...
      const n = async (e) => {
        ...
        r = async (e) =>
          (0, o.I)(e.config.version, 2021, 2, 4)
            ...
            : (0, a.rY)(await e.callApi("GET", "hassio/supervisor/info")),
        s = async (e) =>
          (0, o.I)(e.config.version, 2021, 2, 4)
            ? e.callWS({
                type: "supervisor/api",
            ...
            : (0, a.rY)(await e.callApi("GET", "hassio/info")),
        l = async (e) => e.callApi("GET", "hassio/host/logs/boots"),
        d = async (e, t) =>
          e.callApi(
            "GET",
        ...
        p = (e) => `/api/hassio/${e.includes("_") ? `addons/${e}` : e}/logs`,
        v = (e, t, i = 0) =>
          `/api/hassio/${e.includes("_") ? `addons/${e}` : e}/logs${
            0 !== i ? `/boots/${i}` : ""
          }?lines=${t}`,
        f = async (e, t) => {
          (0, o.I)(e.config.version, 2021, 2, 4)
    ...
    3761: function (e, t, i) {
      ...
      i.a(e, async function (e, o) {
        try {
          ...
          var a = i(61701),
            n = i(72621),
            r = (i(71695), i(40251), i(47021), i(87319), i(57243)),
            s = i(50778),
            l = i(27486),
            d = i(72344),
            c = i(87707),
          ...
          (0, a.Z)(
            [(0, s.Mo)("ha-config-section-updates")],
            function (e, t) {
              class i extends t {
                constructor(...t) {
                  super(...t), e(this);
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    key: "render",
                    value: function () {
                      const e = this._filterUpdateEntitiesWithInstall(
                        this.hass.states,
                        this._showSkipped,
                      );
                      return (0, r.dy)(
      ...
      <hass-subpage back-path="/config/system" .hass=${0} .narrow=${0} .header=${0}>
        <div slot="toolbar-icon">
          ...
          <ha-button-menu multi>
            ...
            <ha-check-list-item left @request-selected=${0} .selected=${0}>
              ${0}
            </ha-check-list-item>
            ${0}
          </ha-button-menu>
    ...
    `),
                        this.hass,
                        this.narrow,
                        this.hass.localize("ui.panel.config.updates.caption"),
                        this.hass.localize(
                        ...
                        this._showSkipped,
                        this.hass.localize(
                          "ui.panel.config.updates.show_skipped",
                        ),
                  ...
                  <mwc-list-item @request-selected=${0} .disabled=${0}>
                    ${0}
                  </mwc-list-item>
                `),
                              this._toggleBeta,
                              "dev" === this._supervisorInfo.channel,
                              "stable" === this._supervisorInfo.channel
                                ? this.hass.localize(
                                    "ui.panel.config.updates.join_beta",
                                  )
                                : this.hass.localize(
                        ...
                        e.length
                          ? (0, r.dy)(
                              k ||
                                (k = x`
                    <ha-config-updates .hass=${0} .narrow=${0} .updateEntities=${0} showAll></ha-config-updates>
                  `),
                              this.hass,
                              this.narrow,
                              e,
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      this._supervisorInfo = await (0, u.CP)(this.hass);
                    },
                  },
                  {
                    kind: "method",
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      try {
                        await (0, u.jP)(this.hass, { channel: e }),
                          await (0, u.lC)(this.hass),
                          await this._refreshSupervisorInfo();
                      } catch (t) {
                        (0, v.showAlertDialog)(this, { text: (0, h.js)(t) });
                      }
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value() {
                      return (0, r.iv)(
                        _ ||
                          (_ = x`.content{padding:28px 20px 0;max-width:1040px;margin:0 auto}ha-card{max-width:600px;margin:0 auto;height:100%;justify-content:space-between;flex-direction:column;display:flex;margin-bottom:max(24px,env(safe-area-inset-bottom))}.card-content{display:flex;justify-content:space-between;flex-direction:column;padding:0}.no-updates{padding:16px}li[divider]{border-bottom-color:var(--divider-color)}`),
                      );
                    },
                  },
                ],
    ...
    33590: function (e, t, i) {
      "use strict";
      i.r(t), i.d(t, { DialogJoinBeta: () => p });
      var o = i(61701),
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    (0, r.B)(this, "dialog-closed", { dialog: this.localName }),
                    !0
                  );
                },
              },
      ...
      <ha-dialog open @closed=${0} .heading=${0}>
        ...
        <ul>
          <li>ASCIA Core</li>
          <li>ASCIA Supervisor</li>
          <li>ASCIA Operating System</li>
        </ul>
    ...
    `),
                        ...
                        (0, s.i)(
                          this.hass,
                          this.hass.localize(
                            "ui.dialogs.join_beta_channel.title",
                          ),
                        ),
                        this.hass.localize(
              ...
              },
              {
                ...
                value: function () {
                  return [
                    ...
                    (0, a.iv)(
                      h ||
                        (h = u`a{text-decoration:none}a ha-svg-icon{--mdc-icon-size:16px}`),
                    ),
                  ];
                },
              },
    ...
    27199: function (e, t, i) {
      ...
      const a = (e, t) => {
        (0, o.B)(e, "show-dialog", {
          ...
          dialogImport: () => Promise.resolve().then(i.bind(i, 33590)),
          dialogParams: t,
        });
      };
    },
    ...
    10916: function (e, t, i) {
      "use strict";
      i.d(t, { Ff: () => a, Fv: () => o, IU: () => n });
      const o = (e, t, i) =>
          isNaN(e) || isNaN(t) || isNaN(i) ? 0 : e > i ? i : e < t ? t : e,
        a = (e, t, i) => (100 * (e - t)) / (i - t),
        n = (e) => Math.round(10 * e) / 10;
    },
  },
]);
//# sourceMappingURL=80284.2a0c8804a8e8b524.js.map
