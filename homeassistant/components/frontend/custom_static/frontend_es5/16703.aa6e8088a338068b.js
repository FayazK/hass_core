(self.webpackChunkhome_assistant_frontend =
  ...
  ["16703"],
  {
    ...
    `),
                        ...
                        (0, l.dy)(
                          m ||
                            (m = b`<div style="width:28px" role="none presentation"></div>`),
                        ),
                        this.icon,
                        this.invalid,
                        this.helper,
                        this.value
                          ? (0, l.dy)(
                              k ||
                                (k = b`<ha-svg-icon role="button" tabindex="-1" aria-label=${0} class="clear-button" .path=${0} @click=${0}></ha-svg-icon>`),
                              (0, c.o)(
                  ...
                  for (; e.nextNode(); ) {
                    ...
                    if (
                      ...
                      if (i) {
                        ...
                        (o.alertType = v.typeToHaAlert[t.toLowerCase()]),
                          o.append(
    ...
    34326: function (e, t, i) {
      ...
      <ha-icon-button .label=${0} @click=${0} .path=${0}></ha-icon-button>`),
                    ...
                    (0, o.dy)(s || (s = d`<div style="width:24px"></div>`)),
    ...
    58670: function (e, t, i) {
      ...
      i.a(e, async function (e, a) {
        try {
          i.r(t), i.d(t, { DialogAddApplicationCredential: () => A });
          var o = i(61701),
            n =
              (i(71695),
              i(9359),
            ...
            d = i(94279),
            c = i(73729),
            h = (i(99254), i(34326), i(83166), i(11498)),
            u = i(57816),
            p = i(28008),
            v = i(73192),
            m = e([l, d]);
          [l, d] = m.then ? (await m)() : m;
          let k,
            y,
            f,
            b,
    ...
    <span>${0}</span>
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    key: "_fetchConfig",
                    value: async function () {
                      (this._config = await (0, h.A8)(this.hass)),
                        (this._domains = Object.keys(
                          this._config.integrations,
                        ).map((e) => ({
                          id: e,
                          name: (0, u.Lh)(this.hass.localize, e),
                        }))),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      const i = this._params.selectedDomain
                        ? (0, u.Lh)(this.hass.localize, this._domain)
                        : "";
                      return (0, n.dy)(
                        y ||
                          (y = L`
      <ha-dialog open @closed=${0} scrimClickAction escapeKeyAction .heading=${0}>
        <div>
          ...
          ${0}
          ${0}
          <ha-textfield class="name" name="name" .label=${0} .value=${0} required @input=${0} .validationMessage=${0} dialogInitialFocus></ha-textfield>
          <ha-textfield class="clientId" name="clientId" .label=${0} .value=${0} required @input=${0} .validationMessage=${0} dialogInitialFocus .helper=${0} helperPersistent></ha-textfield>
          <ha-password-field .label=${0} name="clientSecret" .value=${0} required @input=${0} .validationMessage=${0} .helper=${0} helperPersistent></ha-password-field>
        </div>
        ${0}
      </ha-dialog>
    `),
                        ...
                        this._error
                          ? (0, n.dy)(
                              f ||
                                (f = L`<ha-alert alert-type="error">${0}</ha-alert> `),
                              this._error,
                            )
                          : "",
                ...
                ${0}
                              ...
                              (null !== (e = this._manifest) &&
                                void 0 !== e &&
                                e.is_built_in) ||
                                (null !== (t = this._manifest) &&
                                  void 0 !== t &&
                                  t.documentation)
                                ? (0, n.dy)(
                                    g ||
                                      (g = L`<a href=${0} target="_blank" rel="noreferrer">
                      ${0}
                      <ha-svg-icon .path=${0}></ha-svg-icon>
                    </a>`),
                ...
                <a href=${0} target="_blank" rel="noreferrer">
                  ...
                  <ha-svg-icon .path=${0}></ha-svg-icon>
                        ...
                        this._params.selectedDomain
                          ...
                          : (0, n.dy)(
                              C ||
                                (C = L`<ha-combo-box name="domain" .hass=${0} .label=${0} .value=${0} .renderer=${0} .items=${0} item-id-path="id" item-value-path="id" item-label-path="name" required @value-changed=${0}></ha-combo-box>`),
                              this.hass,
                              this.hass.localize(
                        ...
                        this._description
                          ? (0, n.dy)(
                              x ||
                                (x = L`<ha-markdown breaks .content=${0}></ha-markdown>`),
                              this._description,
                            )
                          : "",
                        this.hass.localize(
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      try {
                        ...
                        return (
                          (this._loading = !1), void (this._error = i.message)
                        );
                      }
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, n.iv)(
                          M ||
                            (M = L`ha-dialog{--mdc-dialog-max-width:500px;--dialog-z-index:10}.row{display:flex;padding:8px 0}ha-combo-box,ha-textfield{display:block;margin-bottom:24px}a{text-decoration:none}a ha-svg-icon{--mdc-icon-size:16px}ha-markdown{margin-bottom:16px}`),
                        ),
                      ];
                    },
                  },
...
//# sourceMappingURL=16703.aa6e8088a338068b.js.map
