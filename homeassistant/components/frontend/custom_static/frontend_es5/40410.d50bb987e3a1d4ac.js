            ...
            d: [
              {
                ...
                value() {
                  return [
                    ...
                    (0, o.iv)(
                      l ||
                        (l = r`::slotted([slot=icon]){margin-inline-start:0px;margin-inline-end:8px;direction:var(--direction);display:block}.mdc-button{height:var(--button-height,36px)}.trailing-icon{display:flex}.slot-container{overflow:var(--button-slot-container-overflow,visible)}:host([destructive]){--mdc-theme-primary:var(--error-color)}`),
                    ),
                  ];
                },
              },
...
`),
              ...
              },
              {
                ...
                value() {
                  return [
                    ...
                    (0, d.iv)(
                      p ||
                        (p = m`.dialog-actions,.header_button,.header_title{direction:var(--direction)}:host([scrolled]) ::slotted(ha-dialog-header){border-bottom:1px solid var(--mdc-dialog-scroll-divider-color,rgba(0,0,0,.12))}.mdc-dialog{--mdc-dialog-scroll-divider-color:var(
    ...
    74633: function (e, t, i) {
      var a = i(61701),
        s = i(72621),
        o = (i(71695), i(47021), i(78755)),
        n = i(57243),
        d = i(50778);
      let l,
        r = (e) => e;
      (0, a.Z)(
        [(0, d.Mo)("ha-md-list-item")],
        function (e, t) {
          class i extends t {
            constructor(...t) {
              super(...t), e(this);
            ...
            d: [
              {
                ...
                value() {
                  return [
                    ...
                    (0, n.iv)(
                      l ||
                        (l = r`:host{--md-sys-color-surface:var(--card-background-color)}`),
                    ),
                  ];
                },
              },
    ...
    88935: function (e, t, i) {
      ...
      const l = (e) => {
          var t;
          return null === (t = e.auth.external) || void 0 === t
            ? void 0
            : t.config.canCommissionMatter;
        },
        r = async (e) => {
          if ((0, o.p)(e, "thread")) {
            const t = (await (0, n.r9)(e)).datasets.find((e) => e.preferred);
            if (t)
              return e.auth.external.fireMessage({
                type: "matter/commission",
                payload: {
                  active_operational_dataset: (await (0, n.EM)(e, t.dataset_id))
                    .tlv,
          ...
          return e.auth.external.fireMessage({ type: "matter/commission" });
        },
        c = (e, t) => {
          let i;
          const o = (0, s.q4)(e.connection, (e) => {
            if (!i)
              return void (i = new Set(
                Object.values(e)
                  .filter((e) => e.identifiers.find((e) => "matter" === e[0]))
                  .map((e) => e.id),
              ));
            const s = Object.values(e).filter(
              (e) =>
                e.identifiers.find((e) => "matter" === e[0]) && !i.has(e.id),
            );
            s.length &&
              (o(),
              (i = void 0),
              null == t || t(),
              (0, a.c)(`/config/devices/device/${s[0].id}`));
          });
          return () => {
            o(), (i = void 0);
          };
        },
        h = (e, t) => e.callWS({ type: "matter/commission", code: t }),
        p = (e, t) =>
          e.callWS({ type: "matter/commission_on_network", pin: t }),
        m = (e, t, i) =>
          e.callWS({
        ...
        u = (e, t) =>
          e.callWS({ type: "matter/set_thread", thread_operation_dataset: t }),
        g = (e, t) =>
          e.callWS({ type: "matter/node_diagnostics", device_id: t }),
        v = (e, t) => e.callWS({ type: "matter/ping_node", device_id: t }),
        f = (e, t) =>
          e.callWS({ type: "matter/open_commissioning_window", device_id: t }),
        y = (e, t, i) =>
          e.callWS({
        ...
        _ = (e, t) => e.callWS({ type: "matter/interview_node", device_id: t });
    },
    22274: function (e, t, i) {
      i.d(t, {
        EM: () => n,
        NO: () => c,
        Xt: () => l,
      ...
      const s = (e, t) => {
          const i = new a();
          return e.connection.subscribeMessage((e) => t(i.processEvent(e)), {
            type: "thread/discover_routers",
          });
        },
        o = (e) => e.callWS({ type: "thread/list_datasets" }),
        n = (e, t) =>
          e.callWS({ type: "thread/get_dataset_tlv", dataset_id: t }),
        d = (e, t, i) =>
          e.callWS({ type: "thread/add_dataset_tlv", source: t, tlv: i }),
        l = (e, t) =>
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          var s = i(61701),
            ...
            d = i(29567),
            l = i(36522),
            r = (i(95198), i(23334), i(54202), i(59826), i(73729), i(88935)),
            c = i(28008),
            h =
              (i(65468),
              i(92252),
          ...
          const $ =
            ...
            w = {
              ...
              apple_home: "existing",
              generic: "existing",
              commissioning: void 0,
            };
          (0, s.Z)(
            [(0, n.Mo)("dialog-matter-add-device")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                  ...
                  {
                    kind: "method",
                    key: "_handleStepSelected",
                    value: function (e) {
                      (this._step = e.detail.step), (this._pairingCode = "");
                    },
                  },
                  {
                    kind: "method",
                    key: "_handlePairingCodeChanged",
                    value: function (e) {
                      this._pairingCode = e.detail.code;
                    },
                  },
                  {
                    kind: "method",
    ...
    `),
                        this._handlePairingCodeChanged,
                        this._handleStepSelected,
                        this.hass,
                        (0, d.h)(
                          `matter-add-device-${this._step.replaceAll(
                            "_",
                            "-",
                          )}`,
                          { hass: this.hass },
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      const e = this._pairingCode,
                        t = this._step;
                      try {
                        (this._step = "commissioning"),
                          await (0, r._T)(this.hass, e);
                      } catch (i) {
                        (0, m.C)(this, {
                  ...
                  },
                  {
                    ...
                    key: "_renderActions",
                    value: function () {
                      return "apple_home" === this._step ||
                        "google_home_fallback" === this._step ||
                        "generic" === this._step
                        ? (0, o.dy)(
                            v ||
                              (v = x`
      ...
      `),
                            ...
                            !this._pairingCode,
                            this.hass.localize(
                              "ui.dialogs.matter-add-device.add_device",
                            ),
                          )
                        : "new" === this._step
                        ? (0, o.dy)(
                  ...
                  },
                  {
                    ...
                    value() {
                      return [
                        ...
                        (0, o.iv)(
                          k ||
                            (k = x`:host{--horizontal-padding:24px}ha-dialog{--dialog-content-padding:0;--mdc-dialog-min-width:450px;--mdc-dialog-max-width:450px}@media all and (max-width:450px),all and (max-height:500px){:host{--horizontal-padding:16px}ha-dialog{--mdc-dialog-min-width:calc(
            100vw - env(safe-area-inset-right) - env(safe-area-inset-left)
          );--mdc-dialog-max-width:calc(
            100vw - env(safe-area-inset-right) - env(safe-area-inset-left)
          )}}.loading{padding:24px;display:flex;align-items:center;justify-content:center}`),
                        ),
                      ];
                    },
                  },
    ...
    65468: function (e, t, i) {
      var a = i(61701),
        s = (i(71695), i(47021), i(57243)),
        o = i(50778),
        n = i(36522),
        d = (i(13928), i(74633), i(19993), i(83166), i(74826));
      let l,
        r,
        c,
        h = (e) => e;
      (0, a.Z)(
        [(0, o.Mo)("matter-add-device-apple-home")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    `),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (this._code = t),
                    (0, n.B)(this, "pairing-code-changed", { code: t });
                },
              },
              {
                kind: "field",
      ...
      i.a(e, async function (e, t) {
        try {
          ...
          let r,
            ...
            h = (e) => e;
          (0, a.Z)(
            [(0, o.Mo)("matter-add-device-commissioning")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                  ...
                  },
                  {
                    ...
                    value() {
                      return [
                        ...
                        (0, s.iv)(
                          c ||
                            (c = h`.content{display:flex;align-items:center;flex-direction:column;text-align:center}ha-spinner{margin-bottom:24px}`),
                        ),
                      ];
                    },
                  },
    ...
    92252: function (e, t, i) {
      var a = i(61701),
        s = (i(71695), i(47021), i(57243)),
        o = i(50778),
        n = i(36522),
        d = (i(13928), i(74633), i(19993), i(74826));
      let l,
        r,
        c = (e) => e;
      (0, a.Z)(
        [(0, o.Mo)("matter-add-device-existing")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
              ...
              },
              {
                ...
                value: function (e) {
                  if (
                    ...
                    return;
                  const t = e.currentTarget.step;
                  (0, n.B)(this, "step-selected", { step: t });
                },
              },
              {
                kind: "field",
                ...
                value() {
                  return [
                    ...
                    (0, s.iv)(
                      r ||
                        (r = c`.logo{width:48px;height:48px;border-radius:12px;border:1px solid var(--divider-color);padding:10px;box-sizing:border-box;display:flex;align-items:center;justify-content:center;object-fit:contain}.logo ha-svg-icon{--mdc-icon-size:36px}`),
                    ),
                  ];
                },
              },
    ...
    10559: function (e, t, i) {
      ...
      let l,
        r = (e) => e;
      (0, a.Z)(
        [(0, o.Mo)("matter-add-device-generic")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    45869: function (e, t, i) {
      ...
      let l,
        ...
        p = (e) => e;
      (0, a.Z)(
        [(0, o.Mo)("matter-add-device-google-home-fallback")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    `),
                    ...
                    this.hass.localize(
                      ...
                      {
                        linked_matter_apps_services: (0, s.dy)(
                          r || (r = p`<b>${0}</b>`),
                          this.hass.localize(
    ...
    5676: function (e, t, i) {
      ...
      let l,
        ...
        p = (e) => e;
      (0, a.Z)(
        [(0, o.Mo)("matter-add-device-google-home")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    `),
                    ...
                    this.hass.localize(
                      "ui.dialogs.matter-add-device.google_home.step_3",
                      {
                        ...
                        home_assistant: (0, s.dy)(h || (h = p`<b>ASCIA</b>`)),
                      },
                    ),
                    this._nextStep,
                    this._nextStep,
              ...
              },
              {
                ...
                key: "_nextStep",
                value: function () {
                  (0, n.B)(this, "step-selected", {
                    step: "google_home_fallback",
                  });
                },
              },
              {
    ...
    `),
                    this.hass.localize(
                      "ui.dialogs.matter-add-device.main.question",
                    ),
                    "new",
                    this._onItemClick,
                    this._onItemClick,
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    key: "firstUpdated",
                    value: function () {
                      (0, d.Ex)(this.hass) && (0, d.fC)(this.hass);
                    },
                  },
                  {
                    kind: "method",
    ...
    `),
                            this.hass.localize(
                              "ui.dialogs.matter-add-device.new.note",
                            ),
                            this.hass.localize(
                              "ui.dialogs.matter-add-device.new.download_app",
                            ),
                            this.hass.localize(
                  ...
                  },
                  {
                    ...
                    value() {
                      return [
                        ...
                        (0, s.iv)(
                          p ||
                            (p = m`.app-qr{margin:24px auto 0;display:flex;justify-content:space-between;padding:0 24px;box-sizing:border-box;gap:16px;width:100%;max-width:400px}.app-qr a,.app-qr img{flex:1}`),
                        ),
                      ];
                    },
                  },
        ...
        renderListItem(e) {
          ...
          switch (this.type) {
            case "link":
              ...
              break;
            case "button":
              i = (0, d.i0)(p || (p = y`button`));
              break;
            default:
              i = (0, d.i0)(m || (m = y`li`));
          }
          const a = "text" !== this.type,
            s = t && this.target ? this.target : o.Ld;
          return (0, d.dy)(
            u ||
              (u = y`
      <${0}
    ...
    `),
            i,
            this.isDisabled || !a ? -1 : 0,
            this.isDisabled,
            this.ariaSelected || o.Ld,
            this.ariaChecked || o.Ld,
            this.ariaExpanded || o.Ld,
            this.ariaHasPopup || o.Ld,
        ...
        renderRipple() {
          return "text" === this.type
            ...
            : (0, o.dy)(
                g ||
                  (g = y` <md-ripple part="ripple" for="item" ?disabled=${0}></md-ripple>`),
                this.isDisabled,
              );
        }
        renderFocusRing() {
          return "text" === this.type
            ...
            : (0, o.dy)(
                v ||
                  (v = y` <md-focus-ring @visibility-changed=${0} part="focus-ring" for="item" inward></md-focus-ring>`),
    ...
    `),
        ...
        onFocus() {
          -1 === this.tabIndex && this.dispatchEvent((0, r.oh)());
        }
        focus() {
          var e;
      ...
      (b.shadowRootOptions = Object.assign(
        Object.assign({}, o.oi.shadowRootOptions),
        {},
        { delegatesFocus: !0 },
      )),
        (0, a.__decorate)(
        ...
        (0, a.__decorate)([(0, s.Cb)()], b.prototype, "href", void 0),
        (0, a.__decorate)([(0, s.Cb)()], b.prototype, "target", void 0),
        (0, a.__decorate)(
          [(0, s.IO)(".list-item")],
          b.prototype,
          "listItemRoot",
    ...
    623: function (e, t, i) {
      ...
      let d,
        l = (e) => e;
      const r = new Set(Object.values(n.E));
    ...
    `),
      ...
      const p = (0, o.iv)(
        h ||
          (h = ((e) =>
            e)`:host{background:var(--md-list-container-color,var(--md-sys-color-surface,#fef7ff));color:unset;display:flex;flex-direction:column;outline:0;padding:8px 0;position:relative}`),
      );
      let m = class extends c {};
      (m.styles = [p]), (m = (0, a.__decorate)([(0, s.Mo)("md-list")], m));
    },
    79840: function (e, t, i) {
      i.d(t, { i0: () => n, dy: () => r });
      i(52247), i(71695), i(92745), i(52805), i(9359), i(48136), i(47021);
      var a = i(2841);
      const s = Symbol.for(""),
        o = (e) => {
          if ((null == e ? void 0 : e.r) === s)
        ...
        l =
          ...
          (t, ...i) => {
            ...
            let c,
              ...
              p = !1;
            for (; h < a; ) {
              for (c = t[h]; h < a && void 0 !== ((n = i[h]), (s = o(n))); )
                (c += s + t[++h]), (p = !0);
              h !== a && r.push(n), l.push(c), h++;
            }
            if ((h === a && l.push(t[a]), p)) {
              const e = l.join("$$lit$$");
              void 0 === (t = d.get(e)) && ((l.raw = l), d.set(e, (t = l))),
                (i = r);
            }
            return e(t, ...i);
          },
