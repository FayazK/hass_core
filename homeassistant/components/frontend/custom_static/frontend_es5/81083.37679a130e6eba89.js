                ...
                value() {
                  return [
                    ...
                    "rtl" === l.E.document.dir
                      ? (0, d.iv)(
                          h ||
                            (h = u`:host .mdc-fab--extended .mdc-fab__icon{direction:rtl}`),
                        )
                      : (0, d.iv)(p || (p = u``)),
                  ];
                },
        ...
        (0, o.w)(
          ...
          Object.assign({ startFlowHandler: t.entry_id, domain: t.domain }, i),
          {
            ...
            renderShowFormStepFieldLabel(e, i, a, s) {
              ...
              const o =
                null != s && null !== (n = s.path) && void 0 !== n && n[0]
                  ? `sections.${s.path[0]}.`
                  : "";
              return (
                e.localize(
                  `component.${t.domain}.options.step.${i.step_id}.${o}data.${a.name}`,
                ) || a.name
              );
            },
            ...
            renderShowFormStepFieldLocalizeValue(e, i, a) {
              return e.localize(`component.${t.domain}.selector.${a}`);
            },
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          const H =
            ...
            U = "M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",
            N =
                  ...
                  { kind: "field", key: "_restoreProgress", value: void 0 },
                  {
                    ...
                    value: async function () {
                      if (
                        ...
                        var e;
                        const t =
                          null === (e = this._network) || void 0 === e
                            ? void 0
                            : e.controller.inclusion_state;
                        t === h.TW.Including
                          ? this._addNodeClicked()
                          : t === h.TW.Excluding && this._removeNodeClicked();
                      }
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      const R =
                        null !==
                          (e =
                            null === (t = this._network) || void 0 === t
                              ? void 0
                              : t.controller.nodes.filter((e) => !e.ready)
                                  .length) && void 0 !== e
                          ? e
                          : 0;
                      return (0, n.dy)(
    ...
    `),
            ...
            `),
                        ...
                        `),
                              ...
                              null !== (i = this._provisioningEntries) &&
                                void 0 !== i &&
                                i.length
                                ? (0, n.dy)(
                                    E ||
                                      (E = Z`<a href=${0}><ha-button>
                          ${0}
                        </ha-button></a>`),
                                    `provisioned?config_entry=${this.configEntryId}`,
                                    this.hass.localize(
                              ...
                              null !==
                                (a =
                                  null === (s = this._statistics) ||
                                  void 0 === s
                                    ? void 0
                                    : s.messages_tx) && void 0 !== a
                                ? a
                                : 0,
                              this.hass.localize(
                              ...
                              null !==
                                (o =
                                  null === (d = this._statistics) ||
                                  void 0 === d
                                    ? void 0
                                    : d.messages_rx) && void 0 !== o
                                ? o
                                : 0,
                              this.hass.localize(
                              ...
                              null !==
                                (l =
                                  null === (p = this._statistics) ||
                                  void 0 === p
                                    ? void 0
                                    : p.messages_dropped_tx) && void 0 !== l
                                ? l
                                : 0,
                              this.hass.localize(
                              ...
                              null !==
                                (u =
                                  null === (_ = this._statistics) ||
                                  void 0 === _
                                    ? void 0
                                    : _.messages_dropped_rx) && void 0 !== u
                                ? u
                                : 0,
                              this.hass.localize(
                              ...
                              null !==
                                (b =
                                  null === (w = this._statistics) ||
                                  void 0 === w
                                    ? void 0
                                    : w.timeout_ack) && void 0 !== b
                                ? b
                                : 0,
                              this.hass.localize(
                              ...
                              null !==
                                (F =
                                  null === (A = this._statistics) ||
                                  void 0 === A
                                    ? void 0
                                    : A.timeout_callback) && void 0 !== F
                                ? F
                                : 0,
                              this._removeNodeClicked,
                              "connected" !== this._status ||
                                ((null === (M = this._network) || void 0 === M
                                  ? void 0
                                  : M.controller.inclusion_state) !==
                                  h.TW.Idle &&
                                  (null === (T = this._network) || void 0 === T
                                    ? void 0
                                    : T.controller.inclusion_state) !==
                                    h.TW.SmartStart),
                              this.hass.localize(
                      ...
                      `),
                                    ...
                                    this._dataCollectionToggled,
                                  )
                                : (0, n.dy)(
                                    I ||
                                      (I = Z` <ha-spinner size="small"></ha-spinner> `),
                                  ),
                              this.hass.localize(
                              ...
                              void 0 !== this._backupProgress
                                ? (0, n.dy)(
                                    P ||
                                      (P = Z`<ha-progress-ring size="small" .value=${0}></ha-progress-ring>
                        ${0}
                        ${0}%`),
                                ...
                                ? (0, n.dy)(
                                    L ||
                                      (L = Z`<ha-progress-ring size="small" .value=${0}></ha-progress-ring>
                          ${0}
                          ${0}%`),
                        ...
                        this._addNodeClicked,
                        "connected" !== this._status ||
                          ((null === (H = this._network) || void 0 === H
                            ? void 0
                            : H.controller.inclusion_state) !== h.TW.Idle &&
                            (null === (O = this._network) || void 0 === O
                              ? void 0
                              : O.controller.inclusion_state) !==
                              h.TW.SmartStart),
                        U,
                      );
                    },
                        ...
                        t.disabled_by
                          ? ((i = [
                              "ui.panel.config.integrations.config_entry.disable.disabled_cause",
                              {
                                cause:
                                  this.hass.localize(
                                    `ui.panel.config.integrations.config_entry.disable.disabled_by.${t.disabled_by}`,
                                  ) || t.disabled_by,
                              },
                            ]),
                            "failed_unload" === t.state &&
                              (a = (0, n.dy)(
                                B ||
                                  (B = Z`.
        ${0}.`),
                          ...
                          : c.LZ.includes(t.state) &&
                            ((i = [
                              `ui.panel.config.integrations.config_entry.state.${t.state}`,
                            ]),
                            t.reason
                              ? (this.hass.loadBackendTranslation(
                                ...
                                (a = (0, n.dy)(
                                  D || (D = Z` ${0}`),
                                  this.hass.localize(
                                    `component.${t.domain}.config.error.${t.reason}`,
                                  ) || t.reason,
                                )))
                              : (a = (0, n.dy)(
                                  F ||
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      ...
                      (this._provisioningEntries = a),
                        ...
                        "connected" === this._status && (this._icon = O),
                    ...
                    value: async function () {
                      ...
                      (0, f.W)(this, {
                        ...
                        skipConfirmation:
                          (null === (e = this._network) || void 0 === e
                            ? void 0
                            : e.controller.inclusion_state) === h.TW.Excluding,
                    ...
                    value: function () {
                      ...
                      const t =
                        null === (e = this.shadowRoot) || void 0 === e
                          ? void 0
                          : e.querySelector("#nvm-restore-file");
                      null == t || t.click();
                    },
                  },
                  {
                    ...
                    value() {
                      return (e) => {
                        if ("finished" === e.event) {
                          var t;
                          (this._backupProgress = void 0),
                            null === (t = this._unsubscribeBackup) ||
                              void 0 === t ||
                              t.call(this),
                  ...
                  },
                  {
                    ...
                    value() {
                      return (e) => {
                        ...
                        "finished" === e.event
                          ? ((this._restoreProgress = void 0),
                            null === (t = this._unsubscribeRestore) ||
                              void 0 === t ||
                              t.call(this),
...
//# sourceMappingURL=81083.37679a130e6eba89.js.map
