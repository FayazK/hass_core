  ...
  ["89943"],
  {
    ...
    34612: function (e, t, i) {
      ...
      const n = (e) =>
        ...
        s = (e, t, i, n) => {
          ...
          return d || c
            ? d && !c
              ? (e) => o.has(e) || s.has((0, a.M)(e))
              : !d && c
              ? (e) => !l.has(e) && !r.has((0, a.M)(e))
              : s.size
              ? (e) => (s.has((0, a.M)(e)) ? !l.has(e) : o.has(e))
              : r.size
              ? (e) => (r.has((0, a.M)(e)) ? o.has(e) : !l.has(e))
              : (e) => o.has(e)
            : () => !0;
        };
    },
    ...
    `),
                    ...
                    this.dismissable
                      ? (0, n.dy)(
                          c ||
                            (c = p`<ha-icon-button @click=${0} label="Dismiss alert" .path=${0}></ha-icon-button>`),
                ...
                value() {
                  return [
                    ...
                    "rtl" === d.E.document.dir
                      ? (0, r.iv)(
                          p ||
                            (p = g`.mdc-floating-label,.mdc-text-field--with-leading-icon,.mdc-text-field--with-leading-icon.mdc-text-field--filled .mdc-floating-label,.mdc-text-field__icon--leading,.mdc-text-field__input[type=number]{direction:rtl;--direction:rtl}`),
                        )
                      : (0, r.iv)(u || (u = g``)),
                  ];
                },
    ...
    38495: function (e, t, i) {
      ...
      const a = (e, t, i) =>
        ...
        g = (e) => e.callWS({ type: "assist_pipeline/language/list" }),
    ...
    `),
            ...
            ${0}
                ...
                `),
                        ...
                        this.message
                          ? (0, s.dy)(
                              g || (g = v`<div id="loading-text">${0}</div>`),
                              this.message,
                            )
                          : s.Ld,
                      );
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      this.hasUpdated ||
                        (0, c.Fk)(this.hass, "conversation").then((e) => {
                          this._exposeNew = e.expose_new;
                        });
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      (0, n.Z)(i, "firstUpdated", this, 3)([e]),
                        (0, d.SC)(this.hass).then((e) => {
                          (this._pipelines = e.pipelines),
                            (this._preferred = e.preferred_pipeline);
                        }),
                        (this._pipelineEntitiesCount = Object.values(
                          this.hass.entities,
                        ).filter(
                          (e) =>
                            "assist_satellite" === (0, m.M)(e.entity_id) &&
                            "unavailable" !==
                      ...
                      return (0, r.Z)(
                        (e) =>
                          Object.entries(e).filter(
                            ([e, t]) => t.conversation && e in this.hass.states,
                          ).length,
                      );
                    },
                  },
    ...
    `),
            ...
            `),
                            ...
                            this._editPipeline,
                            e.name,
                            this._preferred === e.id
                              ? (0, s.dy)(
                                  _ ||
                                    (_ = C`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                  L,
                                )
                              : "",
                        ...
                        this._exposeNew,
                        void 0 === this._exposeNew,
                        this._exposeNewToggleChanged,
                        this.hass.localize(
              ...
              `),
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      if (
                        void 0 !== this._exposeNew &&
                        this._exposeNew !== t.checked
                      )
                        try {
                          await (0, c.fL)(this.hass, "conversation", t.checked);
                        } catch (i) {
                          t.checked = !t.checked;
                        }
                    },
                  ...
                  {
                    kind: "method",
                    key: "_talkWithPipeline",
                    value: function (e) {
                      const t = e.currentTarget.id;
                      (0, f._)(this, this.hass, { pipeline_id: t });
                    },
                  },
                  {
                    kind: "method",
                    key: "_setPreferredPipeline",
                    value: async function (e) {
                      const t = e.currentTarget.id;
                      await (0, d.GV)(this.hass, t), (this._preferred = t);
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: async function (e) {
                      const t = e.currentTarget.id;
                      (0, x.c)(`/config/voice-assistants/debug/${t}`);
                    },
                  },
                  {
                    kind: "method",
                    ...
                    value: async function (e) {
                      const t = e.currentTarget.id;
                      if (this._preferred === t)
                        return void (0, h.showAlertDialog)(this, {
                          text: this.hass.localize(
                            "ui.panel.config.voice_assistants.assistants.pipeline.delete.error_preferred",
                          ),
                        });
                      const i = this._pipelines.find((e) => e.id === t);
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      const t = e.currentTarget.id,
                        i = this._pipelines.find((e) => e.id === t);
                      this._openDialog(i);
                    },
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      (0, g.t)(this, {
                        cloudActiveSubscription:
                          (null === (t = this.cloudStatus) || void 0 === t
                            ? void 0
                            : t.logged_in) &&
                          this.cloudStatus.active_subscription,
                        pipeline: e,
                        createPipeline: async (e) => {
                          const t = await (0, d.jZ)(this.hass, e);
                          this._pipelines = this._pipelines.concat(t);
                        },
                        updatePipeline: async (t) => {
                          const i = await (0, d.af)(this.hass, e.id, t);
                          this._pipelines = this._pipelines.map((t) =>
                            t === e ? i : t,
                          );
                        },
                      });
    ...
    58183: function (e, t, i) {
      var a = i(61701),
        n =
          (i(71695), i(9359), i(56475), i(40251), i(47021), i(31622), i(57243)),
        s = i(50778),
        o = i(27486),
        r = i(36522),
        l = i(34612),
        d = (i(99426), i(54977), i(30509), i(1888), i(94616)),
        c = i(38034),
        h = i(88238);
      let p,
        u,
          ...
          return {
            ...
            d: [
              ...
              },
              {
                ...
                value() {
                  return (0, o.Z)(
                    (e) =>
                      Object.entries(e).filter(
                        ([e, t]) => t["cloud.alexa"] && e in this.hass.states,
                      ).length,
                  );
                },
              },
              {
                ...
                value: function () {
                  this.hasUpdated ||
                    (0, c.Fk)(this.hass, "cloud.alexa").then((e) => {
                      this._exposeNew = e.expose_new;
                    });
                },
              },
              {
                ...
                value: function () {
                  var e;
                  if (!this.cloudStatus) return n.Ld;
                  const t = this.cloudStatus.alexa_registered,
                    { alexa_enabled: i, alexa_report_state: a } =
                      this.cloudStatus.prefs,
                    s = !(0, l.u)(this.cloudStatus.alexa_entities);
                  return (0, n.dy)(
                    p ||
                      (p = y`
      <ha-card outlined>
    ...
    `),
                    ...
                    s
                      ? (0, n.dy)(
                          u ||
                            (u = y`<ha-alert alert-type="warning">
                ${0}
              </ha-alert>`),
                          this.hass.localize(
                  ...
                  <ha-switch .checked=${0} .disabled=${0} @change=${0}></ha-switch> </ha-settings-row>${0}`),
                          t
                            ? ""
                            : (0, n.dy)(
                                f ||
                                  (f = y`<ha-alert .title=${0}>
                      ${0}
              ...
              },
              {
                ...
                value: async function (e) {
                  ...
                  if (
                    ...
                    try {
                      await (0, c.fL)(this.hass, "cloud.alexa", t.checked);
                    } catch (i) {
                      t.checked = !t.checked;
                    }
                },
              },
              {
                ...
                value: async function (e) {
                  const t = e.target;
                  try {
                    await (0, d.LV)(this.hass, { alexa_enabled: t.checked }),
    ...
    81950: function (e, t, i) {
      var a = i(61701),
        ...
        r = i(36522),
        l = i(34612),
        d = (i(99426), i(54977), i(30509), i(1888), i(83166), i(94616)),
        c = i(38034),
        h = i(88238),
        p = i(58885);
      let u,
          ...
          return {
            ...
            d: [
              ...
              },
              {
                ...
                value: function () {
                  this.hasUpdated ||
                    (0, c.Fk)(this.hass, "cloud.google_assistant").then((e) => {
                      this._exposeNew = e.expose_new;
                    });
                },
              },
                ...
                value() {
                  return (0, o.Z)(
                    (e) =>
                      Object.entries(e).filter(
                        ([e, t]) =>
                          t["cloud.google_assistant"] && e in this.hass.states,
                      ).length,
                  );
                },
              },
              {
                ...
                value: function () {
                  var e;
                  if (!this.cloudStatus) return n.Ld;
                  const t = this.cloudStatus.google_registered,
                    {
                      google_enabled: i,
                      google_report_state: a,
                      google_secure_devices_pin: s,
                    } = this.cloudStatus.prefs,
                    o = !(0, l.u)(this.cloudStatus.google_entities);
                  return (0, n.dy)(
                    u ||
                      (u = b`
      <ha-card outlined>
    ...
    `),
                    ...
                    o
                      ? (0, n.dy)(
                          g ||
                            (g = b`<ha-alert alert-type="warning">
                ${0}
              </ha-alert>`),
                          this.hass.localize(
              ...
              },
              {
                ...
                value: async function (e) {
                  const t = e.target;
                  try {
                    await (0, d.LV)(this.hass, { google_enabled: t.checked }),
                      (0, r.B)(this, "ha-refresh-cloud-status");
                  } catch (i) {
                    t.checked = !t.checked;
                  }
              ...
              },
              {
                ...
                value: async function (e) {
                  const t = e.target;
                  try {
                    await (0, d.LV)(this.hass, { [t.id]: t.value || null }),
                      (0, p.f)(this, this.hass),
                      (0, r.B)(this, "ha-refresh-cloud-status");
                  } catch (i) {
                    alert(
                      `${this.hass.localize(
                      ...
                      (t.value =
                        this.cloudStatus.prefs.google_secure_devices_pin || "");
                  }
                },
              },
              {
      ...
      customElements.define("cloud-google-pref", _);
    },
    90710: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          i.r(t), i.d(t, { HaConfigVoiceAssistantsAssistants: () => y });
          var n = i(61701),
            s = (i(71695), i(47021), i(57243)),
            o = i(50778),
            r = i(72344),
            l = i(75375),
            d = (i(97546), i(66320)),
            c = (i(58183), i(1715), i(81950), i(8878)),
            h = e([l, d]);
          ...
          let p,
            ...
            x = (e) => e,
            y = (0, n.Z)(
              [(0, o.Mo)("ha-config-voice-assistants-assistants")],
              function (e, t) {
                return {
                  F: class extends t {
                    constructor(...t) {
    ...
    `),
                              ...
                              this.narrow,
                              this.route,
                              c.voiceAssistantTabs,
                              (0, r.p)(this.hass, "assist_pipeline")
                                ? (0, s.dy)(
                                    g ||
                                      (g = x`
              ...
              `),
                                ...
                                : (0, s.dy)(
                                    v ||
                                      (v = x`<cloud-discover .hass=${0}></cloud-discover>`),
                                    this.hass,
                                  ),
                            )
                          : (0, s.dy)(
                              p ||
                                (p = x`<hass-loading-screen></hass-loading-screen>`),
                            );
                      },
                    },
                    {
                      ...
                      value() {
                        return (0, s.iv)(
                          m ||
                            (m = x`.content{padding:28px 20px 0;max-width:1040px;margin:0 auto}.content>*{display:block;margin:auto auto 24px;max-width:800px}a{text-decoration:none;color:inherit}`),
                        );
                      },
                    },
                  ],
    ...
    58885: function (e, t, i) {
      ...
      var a = i(72473);
      const n = (e, t) =>
        (0, a.C)(e, { message: t.localize("ui.common.successfully_saved") });
    },
  },
]);
//# sourceMappingURL=89943.1a0fd486b83d3871.js.map
