...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["80518"],
  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, n.iv)(
                          f ||
                            (f = g`.current,.current div{display:flex;text-align:center}.current,.current div,.current p{text-align:center}:host{color:var(--primary-text-color)}.current{flex-direction:row;align-items:center;justify-content:center;margin-bottom:40px}.current div{flex-direction:column;align-items:center;justify-content:center;flex:1}.current p{margin:0;color:var(--primary-text-color)}.current .label{opacity:.8;font-size:14px;line-height:16px;letter-spacing:.4px;margin-bottom:4px}.current .value{font-size:22px;font-weight:500;line-height:28px;direction:ltr}`),
                        ),
                      ];
                    },
                  },
    ...
    89555: function (t, e, a) {
      a.a(t, async function (t, e) {
        try {
          var i = a(61701),
            r = a(72621),
            n = (a(71695), a(11740), a(47021), a(57243)),
            s = a(50778),
            o = a(69634),
            l = a(73358),
            c = a(5839),
            ...
            m = a(22381),
            p = a(1703),
            v = (a(5906), a(75138), a(37583), a(96194)),
            b = a(6703),
            _ = a(3015),
            y = t([p, _]);
          [p, _] = y.then ? (await y)() : y;
          let f,
            g,
            $,
            k,
              ...
              return {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      var e;
                      const a = t.currentTarget.step;
                      let i =
                        null !== (e = this._targetTemperature) && void 0 !== e
                          ? e
                          : this._min;
                      (i += a),
                        (i = (0, d.u)(i, this._min, this._max)),
                  ...
                  },
                  {
                    ...
                    key: "_renderLabel",
                    value: function () {
                      return this.stateObj.state === v.nZ
                        ? (0, n.dy)(
                            f ||
                              (f = V`
      ...
      `),
                        ...
                        : (0, h.e)(this.stateObj, b.SN.TARGET_TEMPERATURE) &&
                          this._targetTemperature
                        ? (0, n.dy)(
                            $ ||
                              ($ = V`
    ...
    `),
                            this.hass.localize(
                              "ui.card.water_heater.currently",
                            ),
                            this.hass.formatEntityAttributeValue(
                              this.stateObj,
                              "current_temperature",
...
//# sourceMappingURL=80518.327f3b11ef74afa2.js.map
