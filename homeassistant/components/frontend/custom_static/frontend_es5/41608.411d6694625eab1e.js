  ...
  ["41608"],
  {
              ...
              },
              {
                ...
                value: async function () {
                  ...
                  this.draggableSelector &&
                    (s.draggable = this.draggableSelector),
                    this.handleSelector && (s.handle = this.handleSelector),
                    void 0 !== this.invertSwap &&
                      (s.invertSwap = this.invertSwap),
                    this.group && (s.group = this.group),
                    this.filter && (s.filter = this.filter),
                    (this._sortable = new t(e, s));
                },
              },
              {
                kind: "field",
    ...
    75101: function (e, t, i) {
      ...
      const s = (e, t) =>
        ...
        o = ["not_loaded", "loaded", "setup_error", "setup_retry"],
        r = (e, t, i) => {
    ...
    15681: function (e, t, i) {
      ...
      const o = [
        ...
        r = ["reauth"],
        c = { "HA-Frontend-Base": `${location.protocol}//${location.host}` },
        l = (e, t, i) => {
          var s;
          return e.callApi(
            "POST",
        ...
        d = (e, t) =>
          e.callApi("GET", `config/config_entries/flow/${t}`, void 0, c),
        h = (e, t, i) =>
          e.callApi("POST", `config/config_entries/flow/${t}`, i, c),
        u = (e, t, i) =>
          e.callWS({
        ...
        g = (e, t) => e.callApi("DELETE", `config/config_entries/flow/${t}`),
        p = (e, t) =>
          e.callApi(
            "GET",
        ...
        v = (e) => (0, s._)(e, "_configFlowProgress", f, y),
        _ = (e, t) => v(e.connection).subscribe(t),
        b = (e, t) =>
    ...
    38572: function (e, t, i) {
      ...
      const v = (e, t) =>
        (0, o.w)(e, t, {
          ...
          renderShowFormStepFieldLabel(e, t, i, s) {
            var a;
            ...
            const n =
              null != s && null !== (a = s.path) && void 0 !== a && a[0]
                ? `sections.${s.path[0]}.`
                : "";
            return (
              e.localize(
      ...
      `),
          ...
          renderLoadingDescription(e, t, i, s) {
            if ("loading_flow" !== t && "loading_step" !== t) return "";
            const a = (null == s ? void 0 : s.handler) || i;
            return e.localize(
      ...
      i.a(e, async function (e, t) {
        try {
          var s = i(61701),
            ...
            n = i(50778),
            o = i(36522),
            r = (i(54977), i(23334), i(30509), i(1118)),
            c = i(17705),
            l = i(76131),
            d = i(28008),
            h = i(73192),
          ...
          (0, s.Z)(
            [(0, n.Mo)("ha-energy-battery-settings")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      const e = [],
                        t = [];
                      return (
                        this.preferences.energy_sources.forEach((i, s) => {
                          "battery" === i.type &&
                            (e.push(i),
                            this.validationResult &&
                              t.push(this.validationResult.energy_sources[s]));
                        }),
                        (0, a.dy)(
                          f ||
                            (f = k`
    ...
    `),
                          w,
                          this.hass.localize(
                            "ui.panel.config.energy.battery.title",
                          ),
                          this.hass.localize(
                            "ui.panel.config.energy.battery.sub",
                          ),
                          (0, h.R)(this.hass, "/docs/energy/battery/"),
                          this.hass.localize(
                          ...
                          t.map((e) =>
                            (0, a.dy)(
                              y ||
                                (y = k`
              <ha-energy-validation-result .hass=${0} .issues=${0}></ha-energy-validation-result>
            `),
                              this.hass,
                              e,
                            ),
                          ...
                          e.map((e) => {
                            var t, i;
                            const s = this.hass.states[e.stat_energy_to];
                            return (0, a.dy)(
                              v ||
                                (v = k`
              <div class="row" .source=${0}>
                ${0}
                <div class="content">
            ...
            `),
                              e,
                              null != s && s.attributes.icon
                                ? (0, a.dy)(
                                    _ ||
                                      (_ = k`<ha-icon .icon=${0}></ha-icon>`),
                                    s.attributes.icon,
                                  )
                                : (0, a.dy)(
                                    b ||
                                      (b = k`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                    w,
                                  ),
                              (0, c.Kd)(
                                this.hass,
                                e.stat_energy_from,
                                null === (t = this.statsMetadata) ||
                                  void 0 === t
                                  ? void 0
                                  : t[e.stat_energy_from],
                              ),
                              (0, c.Kd)(
                                this.hass,
                                e.stat_energy_to,
                                null === (i = this.statsMetadata) ||
                                  void 0 === i
                                  ? void 0
                                  : i[e.stat_energy_to],
                              ),
                        ...
                        saveCallback: async (e) => {
                          await this._savePreferences(
                            Object.assign(
                              ...
                              {
                                energy_sources:
                                  this.preferences.energy_sources.concat(e),
                              },
                            ),
                          );
                        },
                  ...
                  },
                  {
                    ...
                    key: "_editSource",
                    value: function (e) {
                      const t = e.currentTarget.closest(".row").source;
                      (0, u.Q6)(this, {
                        source: Object.assign({}, t),
                        battery_sources: this.preferences.energy_sources.filter(
                          (e) => "battery" === e.type,
                        ),
                        saveCallback: async (e) => {
                          await this._savePreferences(
                            Object.assign(
                              ...
                              {
                                energy_sources:
                                  this.preferences.energy_sources.map((i) =>
                                    i === t ? e : i,
                                  ),
                              },
                            ),
                        ...
                        try {
                          await this._savePreferences(
                            Object.assign(
                              ...
                              {
                                energy_sources:
                                  this.preferences.energy_sources.filter(
                                    (e) => e !== t,
                                  ),
                              },
                            ),
                          ...
                          (0, l.showAlertDialog)(this, {
                            title: `Failed to save config: ${i.message}`,
                          });
                        }
                    },
                  },
                  {
                    ...
                    value: async function (e) {
                      const t = await (0, r._Z)(this.hass, e);
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, a.iv)(
                          m ||
                            (m = k`.row{height:58px}.content{display:flex;flex-direction:column}.label{overflow:hidden;text-overflow:ellipsis}`),
                        ),
                      ];
                    },
                  },
    ...
    98445: function (e, t, i) {
      i.a(e, async function (e, t) {
        try {
          var s = i(61701),
            ...
            o = i(50778),
            r = i(36522),
            c = (i(54977), i(23334), i(62801), i(37583), i(1118)),
            l = i(17705),
            d = i(76131),
            h = i(28008),
            u = i(73192),
          ...
          const k =
            ...
            C =
              "M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";
          (0, s.Z)(
            [(0, o.Mo)("ha-energy-device-settings")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
      ...
      <ha-card outlined>
        ...
        <div class="card-content">
          ...
          <ha-sortable handle-selector=".handle" @item-moved=${0}>
            <div class="devices">
              ${0}
            </div>
          </ha-sortable>
    ...
    `),
                        ...
                        (0, u.R)(this.hass, "/docs/energy/individual-devices/"),
                        this.hass.localize(
                          "ui.panel.config.energy.device_consumption.learn_more",
                        ),
                        null === (e = this.validationResult) || void 0 === e
                          ? void 0
                          : e.device_consumption.map((e) =>
                              (0, a.dy)(
                                v ||
                                  (v = m`
              <ha-energy-validation-result .hass=${0} .issues=${0}></ha-energy-validation-result>
            `),
                        ...
                        (0, n.r)(
                          ...
                          (e) => e.stat_consumption,
                          (e) => {
                            var t;
                            return (0, a.dy)(
                              _ ||
                                (_ = m`
                  <div class="row" .device=${0}>
                    <div class="handle">
                      <ha-svg-icon .path=${0}></ha-svg-icon>
                    </div>
                    <span class="content">${0}</span>
                    <ha-icon-button .label=${0} @click=${0} .path=${0}></ha-icon-button>
                    <ha-icon-button .label=${0} @click=${0} .device=${0} .path=${0}></ha-icon-button>
                  </div>
                `),
                              e,
                              $,
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      const { oldIndex: t, newIndex: i } = e.detail,
                        s = this.preferences.device_consumption.concat(),
                        a = s.splice(t, 1)[0];
                      s.splice(i, 0, a);
                      const n = Object.assign(
                        Object.assign({}, this.preferences),
                        {},
                        { device_consumption: s },
                      );
                      (0, r.B)(this, "value-changed", { value: n }),
                        this._savePreferences(n);
                    },
                  },
                  {
                    kind: "method",
                    key: "_editDevice",
                    value: function (e) {
                      const t = e.currentTarget.closest(".row").device;
                      (0, g.Qh)(this, {
                        statsMetadata: this.statsMetadata,
                        device: Object.assign({}, t),
                        device_consumptions:
                          this.preferences.device_consumption,
                        saveCallback: async (e) => {
                          await this._savePreferences(
                            Object.assign(
                              ...
                              {
                                device_consumption:
                                  this.preferences.device_consumption.map(
                                    (i) => (i === t ? e : i),
                                  ),
                              },
                            ),
                        ...
                        saveCallback: async (e) => {
                          await this._savePreferences(
                            Object.assign(
                              ...
                              {
                                device_consumption:
                                  this.preferences.device_consumption.concat(e),
                              },
                            ),
                          );
                        },
                  ...
                  },
                  {
                    ...
                    key: "_deleteDevice",
                    value: async function (e) {
                      const t = e.currentTarget.device;
                      if (
                        ...
                        try {
                          const e = Object.assign(
                            ...
                            {
                              device_consumption:
                                this.preferences.device_consumption.filter(
                                  (e) => e !== t,
                                ),
                            },
                          );
                          e.device_consumption.forEach((i, s) => {
                            i.included_in_stat === t.stat_consumption &&
                              ((e.device_consumption[s] = Object.assign(
                                {},
                                e.device_consumption[s],
                              )),
                              delete e.device_consumption[s].included_in_stat);
                          }),
                            await this._savePreferences(e);
                        } catch (i) {
                  ...
                  },
                  {
                    ...
                    key: "_savePreferences",
                    value: async function (e) {
                      const t = await (0, c._Z)(this.hass, e);
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        p.L,
                        (0, a.iv)(
                          b || (b = m`.handle{cursor:move;cursor:grab}`),
                        ),
                      ];
                    },
                  },
    ...
    `),
                          w,
                          this.hass.localize(
                            "ui.panel.config.energy.gas.title",
                          ),
                          this.hass.localize("ui.panel.config.energy.gas.sub"),
                          (0, h.R)(this.hass, "/docs/energy/gas/"),
                          this.hass.localize(
            ...
            `),
                          ...
                          this.hass.localize(
                            "ui.panel.config.energy.gas.gas_consumption",
                          ),
                          e.map((e) => {
                            var t;
                            const i = this.hass.states[e.stat_energy_from];
                            return (0, a.dy)(
                              v ||
                                (v = m`
              <div class="row" .source=${0}>
            ...
            `),
                              e,
                              null != i && i.attributes.icon
                                ? (0, a.dy)(
                                    _ ||
                                      (_ = m`<ha-icon .icon=${0}></ha-icon>`),
                                    i.attributes.icon,
                                  )
                                : (0, a.dy)(
                                    b ||
                                      (b = m`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                    w,
                                  ),
                              (0, c.Kd)(
                                this.hass,
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t;
                      const i = e.currentTarget.closest(".row").source;
                      (0, u.vp)(this, {
                        source: Object.assign({}, i),
                        allowedGasUnitClass: (0, r.G9)(
                          this.preferences,
                          i.stat_energy_from,
                          this.statsMetadata,
                        ...
                        metadata:
                          null === (t = this.statsMetadata) || void 0 === t
                            ? void 0
                            : t[i.stat_energy_from],
                        gas_sources: this.preferences.energy_sources.filter(
                          (e) => "gas" === e.type,
                        ),
                        saveCallback: async (e) => {
                          await this._savePreferences(
                            Object.assign(
                              ...
                              {
                                energy_sources:
                                  this.preferences.energy_sources.map((t) =>
                                    t === i ? e : t,
                                  ),
                              },
                            ),
      ...
      i.a(e, async function (e, t) {
        try {
          ...
          const S =
            ...
            V =
              "M15 13L11 17V14H2V12H11V9L15 13M5 20V16H7V18H17V10.19L12 5.69L7.21 10H4.22L12 3L22 12H19V20H5Z",
            O =
              "M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z",
            j =
          ...
          (0, s.Z)(
            [(0, n.Mo)("ha-energy-grid-settings")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e, t, i;
                      const s = this.preferences.energy_sources.findIndex(
                        (e) => "grid" === e.type,
                      );
                      let n, o;
                      return (
                        -1 === s
                          ? (n = (0, c.iK)())
                          : ((n = this.preferences.energy_sources[s]),
                            this.validationResult &&
                              (o = this.validationResult.energy_sources[s])),
                        (0, a.dy)(
                          _ ||
                            (_ = M`
      <ha-card outlined>
    ...
    `),
                          j,
                          this.hass.localize(
                            "ui.panel.config.energy.grid.title",
                          ),
                          this.hass.localize("ui.panel.config.energy.grid.sub"),
                          (0, p.R)(this.hass, "/docs/energy/electricity-grid/"),
                          this.hass.localize(
            ...
            `),
                              ...
                              null != i && i.attributes.icon
                                ? (0, a.dy)(
                                    k ||
                                      (k = M`<ha-icon .icon=${0}></ha-icon>`),
                                    null == i ? void 0 : i.attributes.icon,
                                  )
                                : (0, a.dy)(
                                    w ||
                                      (w = M`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                    V,
                                  ),
                              (0, l.Kd)(
                                this.hass,
                          ...
                          this.hass.localize(
                            "ui.panel.config.energy.grid.return_to_grid",
                          ),
                          n.flow_to.map((e) => {
                            var t;
                            const i = this.hass.states[e.stat_energy_to];
                            return (0, a.dy)(
                              $ ||
                                ($ = M`
              <div class="row" .source=${0}>
            ...
            `),
                              ...
                              null != i && i.attributes.icon
                                ? (0, a.dy)(
                                    C ||
                                      (C = M`<ha-icon .icon=${0}></ha-icon>`),
                                    i.attributes.icon,
                                  )
                                : (0, a.dy)(
                                    x ||
                                      (x = M`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                    z,
                                  ),
                              (0, l.Kd)(
                                this.hass,
                          ...
                          this._co2ConfigEntry
                            ? (0, a.dy)(
                                L ||
                                  (L = M`<div class="row" .entry=${0}>
                <img alt="" crossorigin="anonymous" referrerpolicy="no-referrer" src=${0}/>
                <span class="content">${0}</span>
                <a href=${0}>
              ...
              `),
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      const e = await (0, r.pB)(this.hass, {
                        domain: "co2signal",
                      });
                      this._co2ConfigEntry = e.length ? e[0] : void 0;
                    },
                  },
                  {
                    kind: "method",
                  ...
                  },
                  {
                    ...
                    key: "_addFromSource",
                    value: function () {
                      const e = this.preferences.energy_sources.find(
                        (e) => "grid" === e.type,
                      );
                      (0, f.a0)(this, {
                        grid_source: e,
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t;
                      const i = e.currentTarget.closest(".row").source,
                        s = this.preferences.energy_sources.find(
                          (e) => "grid" === e.type,
                        );
                      (0, f.a0)(this, {
                        source: Object.assign({}, i),
                        ...
                        metadata:
                          null === (t = this.statsMetadata) || void 0 === t
                            ...
                            : t[i.stat_energy_from],
                        saveCallback: async (e) => {
                          const t = (0, c.Jj)(this.preferences).grid[0]
                              .flow_from,
                            s = Object.assign(
                              Object.assign({}, this.preferences),
                              {},
                              {
                                energy_sources:
                                  this.preferences.energy_sources.map((s) =>
                                    "grid" === s.type
                                      ? Object.assign(
                                          Object.assign({}, s),
                                          {},
                      ...
                      (0, f.u_)(this, {
                        ...
                        metadata:
                          null === (t = this.statsMetadata) || void 0 === t
                            ...
                            : t[i.stat_energy_to],
                        saveCallback: async (e) => {
                          const t = (0, c.Jj)(this.preferences).grid[0].flow_to,
                            s = Object.assign(
                              Object.assign({}, this.preferences),
                              {},
                              {
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      ...
                      const i = (0, c.Jj)(
                          this.preferences,
                        ).grid[0].flow_from.filter((e) => e !== t),
                        s = Object.assign(
                          Object.assign({}, this.preferences),
                          {},
                          {
                            energy_sources: this.preferences.energy_sources.map(
                              (e) =>
                                "grid" === e.type
                                  ? Object.assign(
                                      Object.assign({}, e),
                        ...
                        a = this._removeEmptySources(s);
                      await this._savePreferences(a);
                    },
                  },
                  {
                    kind: "method",
                  ...
                  {
                    kind: "method",
                    key: "_removeEmptySources",
                    value: function (e) {
                      return (
                        (e.energy_sources = e.energy_sources.reduce(
                          (e, t) => (
                            ("grid" !== t.type ||
                              t.flow_from.length > 0 ||
                              t.flow_to.length > 0) &&
                              e.push(t),
                            e
                          ),
                    ...
                    value: async function (e) {
                      try {
                        ...
                        (0, h.showAlertDialog)(this, {
                          title: `Failed to save config: ${t.message}`,
                        });
                      }
                    },
                  },
    ...
    76539: function (e, t, i) {
      i.a(e, async function (e, t) {
        try {
          ...
          (0, s.Z)(
            [(0, n.Mo)("ha-energy-solar-settings")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
    ...
    `),
                          x,
                          this.hass.localize(
                            "ui.panel.config.energy.solar.title",
                          ),
                          this.hass.localize(
                            "ui.panel.config.energy.solar.sub",
                          ),
                          (0, h.R)(this.hass, "/docs/energy/solar-panels/"),
                          this.hass.localize(
            ...
            `),
                              ...
                              null != i && i.attributes.icon
                                ? (0, a.dy)(
                                    _ ||
                                      (_ = w`<ha-icon .icon=${0}></ha-icon>`),
                                    i.attributes.icon,
                                  )
                                : (0, a.dy)(
                                    b ||
                                      (b = w`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                                    x,
                                  ),
                              (0, c.Kd)(
                                this.hass,
    ...
    34234: function (e, t, i) {
      ...
      let o,
        ...
        h = (e) => e;
      (0, s.Z)(
        [(0, n.Mo)("ha-energy-validation-result")],
        function (e, t) {
          return {
            F: class extends t {
              constructor(...t) {
      ...
      `),
                          this.hass.localize(
                            `component.energy.issues.${e.type}.title`,
                          ) || e.type,
                          this.hass.localize(
                            `component.energy.issues.${e.type}.description`,
                            e.translation_placeholders,
                          ),
                          "recorder_untracked" === e.type
                            ? (0, a.dy)(
                                r ||
                                  (r = h`(<a href="https://www.home-assistant.io/integrations/recorder#configure-filter" target="_blank" rel="noopener noreferrer">${0}</a>)`),
                                this.hass.localize(
                                  "ui.panel.config.common.learn_more",
                                ),
                              )
                            : "",
                          e.affected_entities.map(([e, t]) =>
                            (0, a.dy)(
                              c || (c = h`<li>${0}${0}</li>`),
                              e,
                              t ? (0, a.dy)(l || (l = h` (${0})`), t) : "",
              ...
              },
              {
                ...
                value() {
                  return (0, a.iv)(
                    d ||
                      (d = h`ul{padding-left:24px;padding-inline-start:24px padding-inline-end: initial;margin:4px 0}a{color:var(--primary-color)}`),
                  );
                },
              },
            ],
        ...
        try {
          ...
          const k =
            ...
            $ =
              "M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";
          (0, s.Z)(
            [(0, n.Mo)("ha-energy-water-settings")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
    ...
    `),
                          w,
                          this.hass.localize(
                            "ui.panel.config.energy.water.title",
                          ),
                          this.hass.localize(
                            "ui.panel.config.energy.water.sub",
                          ),
                          (0, h.R)(this.hass, "/docs/energy/water/"),
                          this.hass.localize(
...
//# sourceMappingURL=41608.411d6694625eab1e.js.map
