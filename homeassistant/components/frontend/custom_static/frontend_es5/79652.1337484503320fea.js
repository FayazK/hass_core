...
(self.webpackChunkhome_assistant_frontend =
  ...
  ["79652"],
  {
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          const l = (e, t, i) => d(t, i.time_zone).format(e),
            ...
            u = (e, t, i) => f(t, i.time_zone).format(e),
            f = (0, o.Z)(
              (e, t) =>
                new Intl.DateTimeFormat(e.language, {
                  year: "numeric",
            ...
            h = (e, t, i) => {
              ...
              return {
                [r.t6.DMY]: `${u}${d}${f}${d}${h}${p}`,
                [r.t6.MDY]: `${f}${d}${u}${d}${h}${p}`,
                [r.t6.YMD]: `${h}${d}${f}${d}${u}${p}`,
              }[t.date_format];
            },
            m = (0, o.Z)((e, t) => {
            ...
            b = (e, t, i) => p(t, i.time_zone).format(e),
            p = (0, o.Z)(
              (e, t) =>
                new Intl.DateTimeFormat(e.language, {
                  day: "numeric",
            ...
            z = (e, t, i) => N(t, i.time_zone).format(e),
            N = (0, o.Z)(
              (e, t) =>
                new Intl.DateTimeFormat(e.language, {
                  weekday: "short",
    ...
    64214: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          ...
          const u = (e, t, i) => f(t, i.time_zone).format(e),
            f = (0, o.Z)(
              (e, t) =>
                new Intl.DateTimeFormat(e.language, {
                  year: "numeric",
            ...
            u = (e, t, i) => {
              ...
              return (
                ...
                Number.isNaN(Number(e))
                  ...
                  : new Intl.NumberFormat(a, h(e, i)).format(Number(e))
              );
            },
            f = (e, t) => {
              var i;
    ...
    `),
                ...
                },
                {
                  ...
                  value() {
                    return (0, n.iv)(
                      d ||
                        (d = u`:host{display:inline-block;outline:0}:host([disabled]){pointer-events:none}mwc-icon-button{--mdc-theme-on-primary:currentColor;--mdc-theme-text-disabled-on-light:var(--disabled-text-color)}`),
                    );
                  },
                },
              ],
              ...
              },
              {
                ...
                value: async function () {
                  ...
                  try {
                    n = await ((e) =>
                      new Promise((t, i) => {
                        if ((p.push([e, t, i]), p.length > 1)) return;
                        const a = m();
                        (0, f.n)(
                          1e3,
                          (async () => {
                            (await a)("readonly", (e) => {
                              for (const [t, i, a] of p)
                                (0, d.RV)(e.get(t))
                                  .then((e) => i(e))
                                  .catch((e) => a(e));
                              p = [];
    ...
    `),
                    ...
                    this._toggleMenu,
                    e ? (0, o.dy)(d || (d = f`<div class="dot"></div>`)) : "",
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value() {
                  return (0, o.iv)(
                    u ||
                      (u = f`:host{position:relative}.dot{pointer-events:none;position:absolute;background-color:var(--accent-color);width:12px;height:12px;top:9px;right:7px;inset-inline-end:7px;inset-inline-start:initial;border-radius:50%;border:2px solid var(--app-header-background-color)}`),
                  );
                },
              },
            ],
    ...
    51223: function (e, t, i) {
      i.a(e, async function (e, t) {
        ...
        `),
                        ...
                        return (0, n.dy)(p || (p = k`${0}`), (0, r.C)(e));
                      }
                      {
                        if (i)
                          return (0, n.dy)(
                            v || (v = k`<ha-icon .icon=${0}></ha-icon>`),
                            i,
                          );
                        if (!this.stateObj) return n.Ld;
                        ...
                        const e = (0, d.gD)(
                          ...
                          e
                            ? (0, n.dy)(
                                y || (y = k`<ha-icon .icon=${0}></ha-icon>`),
                                e,
                              )
                            : this._renderFallback(),
                        );
                        return (0, n.dy)(g || (g = k`${0}`), (0, r.C)(e));
                      }
                    },
                  },
                  {
    ...
    `),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (0, n.iv)(
                        w ||
                          (w = k`:host{display:inline-block;position:relative;width:40px;height:40px;background-color:#fff;border-radius:50%}.circle{padding-bottom:13px;display:flex;align-items:center;height:100%;justify-content:center}ha-icon,ha-svg-icon{transition:color 280ms ease-in-out}`),
                      );
                    },
                  },
                ],
      ...
      <g>
        ...
        ${0}
                      ...
                      this.path
                        ? (0, n.YP)(
                            s ||
                              (s = d`<path class="primary-path" d=${0}></path>`),
                            this.path,
                          )
                        : n.Ld,
                      this.secondaryPath
                        ? (0, n.YP)(
                            c ||
                              (c = d`<path class="secondary-path" d=${0}></path>`),
                            this.secondaryPath,
                          )
                        : n.Ld,
                    );
      ...
      i.a(e, async function (e, a) {
        try {
          ...
          const m = (e) =>
            ...
            k = (e, t = !1) => w(e).filter((e) => b(e, t)),
            x = async (e, t) => {
              const i = w(t.states, t.locale.language).map((e) => e.entity_id);
              if (!i.length)
    ...
    87611: function (e, t, i) {
      i.a(e, async function (e, a) {
        try {
          ...
          var n = i(61701),
            ...
            c = i(59847),
            l = i(83523),
            d = (i(23334), i(43344), i(85366), i(65986)),
            u = i(28008),
            f = e([d]);
      ...
      <ha-top-app-bar-fixed>
        ...
        ${0}
        <ha-map .hass=${0} .entities=${0} auto-fit interactive-zones></ha-map>
      </ha-top-app-bar-fixed>
    `),
                        this.hass,
                        this.narrow,
                        ...
                        null !== (e = this.hass.user) &&
                          ...
                          ? (0, r.dy)(
                              m ||
                                (m = p`<ha-icon-button slot="actionItems" .label=${0} .path=${0} @click=${0}></ha-icon-button>`),
                              this.hass.localize("ui.panel.map.edit_zones"),
                              v,
                              this._openZonesEditor,
                            )
                          : "",
                        this.hass,
                        this._entities,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      (0, l.c)("/config/zone?historyBack=1");
                    },
                  },
                  {
                    kind: "method",
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      const i = new Set(),
                        a = [];
                      Object.values(this.hass.states).forEach((n) => {
                        "home" !== n.state &&
                          "latitude" in n.attributes &&
                          "longitude" in n.attributes &&
                          (a.push(n.entity_id),
                          "person" === (0, c.N)(n) &&
                            n.attributes.source &&
                            i.add(n.attributes.source),
                          (null == e ? void 0 : e.states[n.entity_id]) !== n &&
                            (t = !0));
                      }),
                        t && (this._entities = a.filter((e) => !i.has(e)));
                    },
                  },
                  {
                    kind: "get",
                    ...
                    value: function () {
                      return [
                        ...
                        (0, r.iv)(
                          b ||
                            (b = p`ha-map{height:calc(100vh - var(--header-height))}`),
                        ),
                      ];
                    },
                  },
    ...
    28008: function (e, t, i) {
      ...
      (0, a.iv)(
        c ||
          (c = l`body{background-color:var(--primary-background-color);color:var(--primary-text-color);height:calc(100vh - 32px);width:100vw}`),
      );
    },
    79291: function (e, t, i) {
      i.d(t, { T: () => a });
      const a =
...
//# sourceMappingURL=79652.1337484503320fea.js.map
