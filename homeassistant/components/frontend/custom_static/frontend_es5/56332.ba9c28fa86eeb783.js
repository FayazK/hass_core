    ...
    68958: function (e, t, i) {
      ...
      const a = {},
        o = (e) => (t) => {
          ...
          let o;
          i && i in a ? (o = a[i]) : ((o = new n(window[i])), (a[i] = o));
          const r = String(t.key),
            l = e.key || String(t.key),
            s = t.initializer ? t.initializer() : void 0;
          o.addFromStorage(l);
          const d =
              !1 !== e.subscribe
                ? (e) =>
                    o.subscribeChanges(l, (i, n) => {
            ...
            descriptor: {
              set(i) {
                ((i, n) => {
                  let a;
                  e.state && (a = c()),
                    o.setValue(l, e.serializer ? e.serializer(n) : n),
                    e.state && i.requestUpdate(t.key, a);
                })(this, i);
              },
              get() {
                return c();
...
`),
    ...
    `),
                      ...
                      this.path
                        ? (0, a.dy)(
                            s ||
                              (s = p`<ha-svg-icon .path=${0}></ha-svg-icon>`),
                            this.path,
                          )
                        : (0, a.dy)(d || (d = p`<slot></slot>`)),
                    );
                  },
                },
                {
                  ...
                  value() {
                    return (0, a.iv)(
                      c ||
                        (c = p`:host{display:inline-block;outline:0}:host([disabled]){pointer-events:none}mwc-icon-button{--mdc-theme-on-primary:currentColor;--mdc-theme-text-disabled-on-light:var(--disabled-text-color)}`),
                    );
                  },
                },
              ],
      ...
      <g>
        ...
        ${0}
                      ...
                      this.path
                        ? (0, a.YP)(
                            l ||
                              (l = c`<path class="primary-path" d=${0}></path>`),
                            this.path,
                          )
                        : a.Ld,
                      this.secondaryPath
                        ? (0, a.YP)(
                            s ||
                              (s = c`<path class="secondary-path" d=${0}></path>`),
                            this.secondaryPath,
                          )
                        : a.Ld,
                    );
    ...
    55546: function (e, t, i) {
      "use strict";
      i.a(e, async function (e, n) {
        try {
          i.r(t), i.d(t, { HaVoiceCommandDialog: () => z });
          var a = i(61701),
            o =
              (i(19083),
              i(71695),
          ...
          let z = (0, a.Z)(
            [(0, r.Mo)("ha-voice-command-dialog")],
            function (e, t) {
              return {
                F: class extends t {
                  constructor(...t) {
                ...
                d: [
                  ...
                  },
                  {
                    ...
                    value: async function (e) {
                      "preferred" === e.pipeline_id ||
                      ("last_used" === e.pipeline_id && !this._pipelineId)
                        ? (await this._loadPipelines(),
                          (this._pipelineId = this._preferredPipeline))
                        : ["last_used", "preferred"].includes(e.pipeline_id) ||
                          (this._pipelineId = e.pipeline_id),
                        (this._startListening = e.start_listening),
                        (this._opened = !0);
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return this._opened
                        ? (0, o.dy)(
                            m ||
                              (m = L`
      <ha-dialog open @closed=${0} .heading=${0} flexContent hideactions>
        <ha-dialog-header slot="heading">
          <ha-icon-button slot="navigationIcon" dialogAction="cancel" .label=${0} .path=${0}></ha-icon-button>
          <div slot="title">
            ${0}
            <ha-button-menu @opened=${0} @closed=${0} activatable fixed>
    ...
    `),
                            this.closeDialog,
                            this.hass.localize(
                              "ui.dialogs.voice_command.title",
                            ),
                            ...
                            this._loadPipelines,
                            d.U,
                            null === (e = this._pipeline) || void 0 === e
                              ? void 0
                              : e.name,
                            C,
                            this._pipelines
                              ? null === (t = this._pipelines) || void 0 === t
                                ? void 0
                                : t.map((e) =>
                                    (0, o.dy)(
                                      g ||
                                        (g = L`<ha-list-item ?selected=${0} .pipeline=${0} @click=${0} .hasMeta=${0}>
                        ${0}${0}
                      </ha-list-item>`),
                                      e.id === this._pipelineId ||
                                        (!this._pipelineId &&
                                          e.id === this._preferredPipeline),
                                      e.id,
                            ...
                            `),
                              ...
                              : (0, o.dy)(
                                  v ||
                                    (v = L`<div class="pipelines-loading">
                    <ha-spinner size="small"></ha-spinner>
                            ...
                            null !== (i = this.hass.user) &&
                              ...
                              ? (0, o.dy)(
                                  b ||
                                    (b = L`<li divider role="separator"></li>
                    <a href="/config/voice-assistants/assistants"><ha-list-item>${0}</ha-list-item></a>`),
                                  this.hass.localize(
              ...
              ${0}
                              ...
                              ? (0, o.dy)(
                                  k ||
                                    (k = L`
                <ha-assist-chat .hass=${0} .pipeline=${0} .startListening=${0}>
                </ha-assist-chat>
              `),
                                  this.hass,
                                  this._pipeline,
                              ...
                              : (0, o.dy)(
                                  _ ||
                                    (_ = L`<div class="pipelines-loading">
                <ha-spinner size="large"></ha-spinner>
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      ...
                      p.SC)(this.hass);
                      (this._pipelines = e),
                        (this._preferredPipeline = t || void 0);
                    },
                  },
                  {
                    kind: "method",
                    key: "_selectPipeline",
                    value: async function (e) {
                      (this._pipelineId = e.currentTarget.pipeline),
                  ...
                  },
                  {
                    ...
                    value: async function () {
                      (this._pipeline = void 0),
                        (this._errorLoadAssist = void 0);
                      const e = this._pipelineId;
                      try {
                        const t = await (0, p.PA)(this.hass, e);
                        e === this._pipelineId && (this._pipeline = t);
                      } catch (t) {
                        if (e !== this._pipelineId) return;
                        "not_found" === t.code
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return [
                        ...
                        (0, o.iv)(
                          w ||
                            (w = L`ha-button-menu ha-button ha-svg-icon,ha-list-item ha-svg-icon{margin-left:4px;margin-inline-start:4px;margin-inline-end:initial;direction:var(--direction)}ha-dialog{--mdc-dialog-max-width:500px;--mdc-dialog-max-height:500px;--dialog-content-padding:0}ha-dialog-header a{color:var(--primary-text-color)}div[slot=title]{display:flex;flex-direction:column;margin:-4px 0}ha-button-menu{--mdc-theme-on-primary:var(--text-primary-color);--mdc-theme-primary:var(--primary-color);margin-inline-end:0;margin:-8px 0 0 -8px;margin-inline-start:-8px}ha-button-menu ha-button{--mdc-theme-primary:var(--secondary-text-color);--mdc-typography-button-text-transform:none;--mdc-typography-button-font-size:unset;--mdc-typography-button-font-weight:400;--mdc-typography-button-letter-spacing:var(
            --mdc-typography-headline6-letter-spacing,
            0.0125em
          );--mdc-typography-button-line-height:var(
            --mdc-typography-headline6-line-height,
            2rem
          );--button-height:auto}ha-button-menu ha-button ha-svg-icon{height:28px}ha-list-item{--mdc-list-item-meta-size:16px}ha-list-item ha-svg-icon{display:block}ha-button-menu a{text-decoration:none}.pipelines-loading{display:flex;justify-content:center}ha-assist-chat{margin:0 24px 16px;min-height:399px}`),
                        ),
                      ];
                    },
                  },
    ...
    28008: function (e, t, i) {
      ...
      const c = (0, n.iv)(
        ...
        u = (0, n.iv)(
          l ||
            (l = d`.ha-scrollbar::-webkit-scrollbar{width:.4rem;height:.4rem}.ha-scrollbar::-webkit-scrollbar-thumb{-webkit-border-radius:4px;border-radius:4px;background:var(--scrollbar-thumb-color)}.ha-scrollbar{overflow-y:auto;scrollbar-color:var(--scrollbar-thumb-color) transparent;scrollbar-width:thin}`),
        );
      (0, n.iv)(
        s ||
...
//# sourceMappingURL=56332.ba9c28fa86eeb783.js.map
